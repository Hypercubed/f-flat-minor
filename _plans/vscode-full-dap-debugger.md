...
This phase likely depends on some or all of `_plans/typescript-debug-source-maps.md`.
...
- `_plans/vscode-trace-viewer.md` — intended precursor for validating debugger UX and metadata needs
- `_plans/typescript-debug-source-maps.md` — required in full or in part for source-aware stepping and breakpoints
