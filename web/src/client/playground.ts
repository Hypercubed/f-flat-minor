    ...
    <section class="page-section">
      <section class="workspace">
        <div class="panel editor-panel">
          ...
          <div class="controls">
            <label class="field">
              <input id="stdin" type="text" placeholder="Optional input for getc" aria-label="stdin" />
            </label>
            <div class="actions">
              ...
              <button id="run" type="button" class="primary" aria-label="Run">Run</button>
            </div>
          </div>
        </div>
        ...
        <div class="panel details-panel-shell">
          ...
          <div class="detail-meta detail-footer" data-detail-footer="output preprocessed ir">
          ...
          <div id="bytecode-meta" class="detail-meta detail-footer" data-detail-footer="bytecode" hidden>
...
export function mountPlayground(root: HTMLElement) {
  ...
  const detailFooters = Array.from(root.querySelectorAll<HTMLElement>("[data-detail-footer]"));
  ...
  function setOutputWrap(enabled: boolean) {
    ...
    errorOutput.classList.toggle("is-wrapped", enabled);
  ...
  function setPlaygroundRunningState(isRunning: boolean) {
    ...
    run.textContent = isRunning ? "Cancel" : "Run";
    run.setAttribute("aria-label", isRunning ? "Cancel run" : "Run");
  ...
  function setDetailTab(name: string) {
    ...
    syncDetailFooterActiveState(detailFooters, name);
  }
  ...
  function setPlaygroundIdle() {
    ...
    render(html`(Click Run to execute.)`, output);
    errorOutput.textContent = "";
    preprocessedViewer.setValue("");
    irViewer.setValue("");
    setBytecodeDisplay("");
