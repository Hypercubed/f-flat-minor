(function(){"use strict";function nn(){var n,e,t,s,r;return!!(((t=(e=(n=globalThis.Deno)==null?void 0:n.stdout)==null?void 0:e.isTerminal)==null?void 0:t.call(e))??((r=(s=globalThis.process)==null?void 0:s.stdout)==null?void 0:r.isTTY)??!1)}function z(i,n){return nn()?`\x1B[${i}m${n}\x1B[0m`:n}function en(i){return z(34,i)}function tn(i){return z(32,i)}function x(i){return z(36,i)}const a={NOP:0,CALL:1,PUTC:2,GETC:3,PUTN:5,CLOCK:6,DROP:8,PUSHR:14,PULLR:15,SHIFTL:16,SHIFTR:17,CLR:24,RAND:26,EXIT:27,DUP:33,DEPTH:35,SWAP:36,MOD:37,AND:38,STASH:40,FETCH:41,MUL:42,ADD:43,CONS:44,SUB:45,PRN:46,DIV:47,MARK:58,DEF:59,LT:60,EQ:61,GT:62,IF:63,BRA:91,KET:93,POW:94,OR:124,NOT:126},k={nop:a.NOP,eval:a.CALL,";":a.DEF,":":a.MARK,clr:a.CLR,rand:a.RAND,exit:a.EXIT,".":a.PRN,putc:a.PUTC,getc:a.GETC,putn:a.PUTN,clock:a.CLOCK,drop:a.DROP,swap:a.SWAP,dup:a.DUP,"<<":a.SHIFTL,">>":a.SHIFTR,"+":a.ADD,"-":a.SUB,cons:a.CONS,"*":a.MUL,"/":a.DIV,"<":a.LT,"=":a.EQ,">":a.GT,"?":a.IF,"%":a.MOD,"&":a.AND,"(":a.STASH,")":a.FETCH,"q<":a.PUSHR,"q>":a.PULLR,depth:a.DEPTH,"^":a.POW,"[":a.BRA,"]":a.KET,"|":a.OR,"~":a.NOT},S=255,sn=i=>i,rn=i=>i,h={call:"call",push:"push"},an=6,O=10,on=new Map([[BigInt(a.MARK),":"],[BigInt(a.DEF),";"],[BigInt(a.BRA),"["],[BigInt(a.KET),"]"]]);function pn(i){return(""+i.value).padEnd(O," ")}function cn(i,n){var e;return n?n.padEnd(O," "):i.op===h.push&&((e=i.meta)!=null&&e.pointer)?`[${i.value}]`.padEnd(O," "):pn(i)}function ln(i){return i.trim()?`/* ${i} */`:""}function un(i){var c,p,l;const n=((c=hn(i))==null?void 0:c.toUpperCase())||"",e=i.op===h.call?on.get(i.value):void 0,t=e!==void 0,s=cn(i,e),r=((l=(p=i.meta)==null?void 0:p.comment)==null?void 0:l.trim())||(i.op===h.call&&!t?n:""),o=(i.op===h.call&&!e?"EVAL":"").padEnd(an," ");return[rn(s),sn(o),ln(r)].join(" ")}function dn(i){for(const n in k)if(k[n]===i)return n;return""}function hn(i){var n,e;if(i.op===h.call||i.op===h.push&&((n=i.meta)!=null&&n.pointer))return((e=i.meta)==null?void 0:e.name)||dn(Number(i.value))||""}function _n(i){return i.map(un).join(`
`)}function fn(i){return i=i.replace(/\\U([A-Fa-f0-9]{8})/g,(n,e)=>L(e)),i=i.replace(/\\u([A-Fa-f0-9]{4})/g,(n,e)=>L(e)),i.replace(/\\0/g,"\0").replace(/\\b/g,"\b").replace(/\\t/g,"	").replace(/\\n/g,`
`).replace(/\\v/g,"\v").replace(/\\f/g,"\f").replace(/\\r/g,"\r").replace(/\\'/g,"'").replace(/\\"/g,'"').replace(/\\s/g," ").replace(/\\\\/g,"\\")}function L(i){let n="",e=parseInt(i,16);return e<=65535?n+=String.fromCharCode(e):e<=1114111?(e-=65536,n+=String.fromCharCode(55296|e>>10)+String.fromCharCode(56320|e&1023)):n+=`hex2Char error: Code point out of range: ${mn(e)}`,n}function mn(i){return(i+0).toString(16).toUpperCase()}const F="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",U=new Map;F.split("").forEach(function(i,n){U.set(i,n)});const $=1n<<5n,j=Number($),W=$-1n;function gn(i){return i.map(yn).map(xn).join("")}function bn(i){return kn(qn(i)).map(Sn)}function vn(i){return i>=0n?i<<1n:(-i<<1n)+1n}function wn(i){return i&1n?-(i>>1n):i>>1n}function yn(i){if(i===0n)return[0];i=vn(i);const n=[];for(;i>0;){let e=Number(i&W);i>>=5n,i>0&&(e|=j),n.push(e)}return n}function xn(i){return i.map(n=>F[n]).join("")}function qn(i){return i.split("").map(n=>{const e=U.get(n);if(e===void 0)throw new Error(`${i} is not a valid base64 encoded VLQ`);return e})}function kn(i){const n=[];let e=[];if(i.forEach(t=>{e.push(t),(t&j)===0&&(n.push(e),e=[])}),e.length>0)throw new Error("Malformed VLQ sequence: The last VLQ never ended.");return n}function Sn(i){const n=i.reverse().reduce((e,t)=>(e<<=5n,e|=BigInt(t)&W,e),0n);return wn(n)}const En="/*",Tn="*/";function M(i){if(!(i==="-"||i==="+"))try{let n=1n;return i=i.replaceAll("_",""),i.startsWith("-0")&&(n=-1n,i=i.replace("-","")),i.includes("e")||i.includes("E")?n*BigInt(+i):n*BigInt(i)}catch{return}}class w{constructor(n={}){this.symbols=new Map,this._nextCode=-1,this.host=n;let e;for(e in k)this.symbols.set(e,BigInt(k[e]))}static tokenize(n){return n.split(/\s+/).filter(Boolean).map(e=>{const t=M(e);return t!==void 0?t:e})}static tokenizeWithSpans(n){const e=[],t=/\S+/g;let s=0,r=0,o=0;const c=l=>{for(;o<l;){const u=n[o];u==="\r"?(n[o+1]===`
`&&o++,s++,r=0):u===`
`?(s++,r=0):r++,o++}};let p;for(;(p=t.exec(n))!==null;){const l=p.index;c(l);const u=p[0]??"",f=M(u);e.push({raw:u,value:f!==void 0?f:u,line:s,character:r,length:u.length,offset:l}),c(l+u.length)}return e}static compileToBase64(n){const e=n.flatMap(t=>{if(t.op===h.call&&t.value===0n)return[];const s=t.value<<1n;return[t.op===h.push?s:s|1n]});return gn(e)}nextCode(){return BigInt(this._nextCode--)}getSymbol(n){n=n.toLowerCase();let e=this.symbols.get(n);return e===void 0&&(e=this.nextCode(),this.symbols.set(n,e)),e}compileToIR(n,e=""){var u,f,m;let t=0;const s=n.length;let r="";const o=[];let c;for(;t<s;)if(c=n[t++],r=this.unwrapTokenValue(c),typeof r=="bigint")p(r);else if(r.length>1&&r.startsWith(".")){const[d]=r.split(" ");switch(d){case".push":o[o.length-1].op=h.push;break;case".call":o[o.length-1].op=h.call;break;case".inline":(u=o[o.length-1]).meta||(u.meta={}),o[o.length-1].meta.inline=!0;break;case".unsafe":(f=o[o.length-1]).meta||(f.meta={}),o[o.length-1].meta.unsafe=!0;break;case".pointer":(m=o[o.length-1]).meta||(m.meta={}),o[o.length-1].meta.pointer=!0;break;case".exit":if(this.host.exit){this.host.exit();break}throw new Error("Compiler: .exit requires a host exit handler");case".symbols":this.symbols.forEach((g,v)=>{(this.host.log||console.log)(v,g)});break;case".words":{const g=Array.from(this.symbols,([v])=>v).join(" ");(this.host.log||console.log)(g);break}}}else if(r[0]==="'"&&r.length>1)fn(r).replace(/^'/,"").replace(/'$/,"").split("").forEach(d=>{p(d.charCodeAt(0),{comment:d})});else if(r.endsWith(":")&&r.length>1){const d=r.replace(/:$/,"");p(this.getSymbol(d),{name:`${d}`,pointer:!0}),l(a.MARK,{name:":"})}else if(r===En){const d=c,g=[];for(;t<n.length&&(c=n[t++],r=this.unwrapTokenValue(c),r!==Tn);)g.push(r);l(0n,{comment:g.join(" ")},d)}else if(r.startsWith("[")&&r.endsWith("]")){const d=r.replace(/^\[/,"").replace(/\]$/,""),g=M(d);g!==void 0?p(g,{name:d,pointer:!0}):p(this.getSymbol(d),{name:d,pointer:!0})}else l(this.getSymbol(r),{name:r});return o;function p(d,g={},v=c){o.push({value:BigInt(d),op:h.push,meta:{...g,...w.toInstructionMeta(v,e)}})}function l(d,g={},v=c){o.push({value:BigInt(d),op:h.call,meta:{...g,...w.toInstructionMeta(v,e)}})}}unwrapTokenValue(n){return typeof n=="string"||typeof n=="bigint"?n:n.value}static toInstructionMeta(n,e){return!n||typeof n=="string"||typeof n=="bigint"?{filename:e}:{filename:e,line:n.line,character:n.character,length:n.length,offset:n.offset}}validate(n){var r,o;const e=n.slice(),t=[];let s=0;for(;s<e.length;){const c=e[s];if(c.op===h.call&&c.value===BigInt(a.DEF)){let p=0;for(p=s;p>0&&!(e[p].op===h.call&&e[p].value===BigInt(a.MARK));p--);const l=e.splice(p-1,s-p+2);(o=(r=l.at(-1))==null?void 0:r.meta)!=null&&o.unsafe||t.push(...this.validateDef(l)),s=p-1}s++}return t.push(...this.validateDef(e,"main")),t}validateDef(n,e){var u,f,m;const t=[];let s=0,r=0,o=0,c=0;const p=[0];if(!n[0])return[];e=tn(e||((f=(u=n[0].meta)==null?void 0:u.name)==null?void 0:f.replace(/^&/,""))||"main");const l=en(((m=n[0].meta)==null?void 0:m.filename)||"-");for(;s<n.length;){const d=n[s];if(d.op===h.call){if(d.op===h.call&&d.value===BigInt(a.MARK)&&r++,d.op===h.call&&d.value===BigInt(a.DEF)&&r--,d.op===h.call&&d.value===BigInt(a.BRA)&&(o++,p.push(0)),d.op===h.call&&d.value===BigInt(a.KET)&&(o--,(p.length>1?p.pop():0)!==0&&t.push(`${l}: Unbalanced queue push ( ${x("q< q>")} ) in quote in ${e}`)),d.op===h.call&&(d.value===BigInt(a.PUSHR)||d.value===BigInt(a.STASH))&&(c++,p[p.length-1]++),d.op===h.call&&(d.value===BigInt(a.PULLR)||d.value===BigInt(a.FETCH))){if(p[p.length-1]===0){const v=d.value===BigInt(a.FETCH)?")":"q>";t.push(`${l}: Queue borrow ( ${x(v)} ) requires ${x(".unsafe")} in ${e} (including quotes)`)}c--,p[p.length-1]--}o<0&&t.push(`${l}: Bracket ( ${x("[ ]")} ) mismatch in ${e}`),r<0&&t.push(`${l}: Definition ( ${x(": ;")} ) mismatch in ${e}`)}s++}return o!==0&&t.push(`${l}: Unbalanced brackets ( ${x("[ ]")} ) in ${e}`),c!==0&&t.push(`${l}: Unbalanced queue push ( ${x("q< q> ( )")} ) in ${e}`),r!==0&&t.push(`${l}: Unbalanced definition ( ${x(": ;")} ) in ${e}`),t}}const An="FbAbbCb";var Pn={words:[{mnemonic:"NOP",syntax:"nop",stackEffect:"… nop == …",description:"No operation; does nothing.",opcode:0},{mnemonic:"EVAL",syntax:"eval",stackEffect:"[A] eval == a*",description:"Evaluates a quotation, executing its contents.",opcode:1},{mnemonic:"PUTC",syntax:"putc",stackEffect:"n putc == {prints char(n)}",description:"Prints a character given by its numeric code.",opcode:2},{mnemonic:"GETC",syntax:"getc",stackEffect:"getc == n {reads char}",description:"Reads a single character from input and pushes its code.",opcode:3},{mnemonic:"PUTN",syntax:"putn",stackEffect:"n putn == {prints n}",description:"Prints a number to output.",opcode:5},{mnemonic:"CLOCK",syntax:"clock",stackEffect:"clock == n {reads clock}",description:"Returns the current time as a Unix timestamp.",opcode:6},{mnemonic:"DROP",syntax:"drop",stackEffect:"a drop ==",description:"Removes the top value from the stack.",opcode:8},{mnemonic:"PUSHR",syntax:"q<",stackEffect:"a q< == | …a",description:"Pushes a value onto the return stack.",opcode:14},{mnemonic:"PULLR",syntax:"q>",stackEffect:"q> == a | a…",description:"Pops a value from the return stack onto the main stack.",opcode:15},{mnemonic:"SHIFTL",syntax:"<<",stackEffect:"a b << == n",description:"Left-shifts a by b bits.",opcode:16},{mnemonic:"SHIFTR",syntax:">>",stackEffect:"a b >> == n",description:"Right-shifts a by b bits.",opcode:17},{mnemonic:"CLR",syntax:"clr",stackEffect:"… clr ==",description:"Clears the entire stack.",opcode:24},{mnemonic:"RAND",syntax:"rand",stackEffect:"n rand == r {0 <= r < n}",description:"Generates a random number between 0 and n-1.",opcode:26},{mnemonic:"EXIT",syntax:"exit",stackEffect:"n exit == {exits with code n}",description:"Exits the program with the given exit code.",opcode:27},{mnemonic:"DUP",syntax:"dup",stackEffect:"a dup == a a",description:"Duplicates the top value on the stack.",opcode:33},{mnemonic:"DEPTH",syntax:"depth",stackEffect:"… depth == … n",description:"Pushes the current stack depth.",opcode:35},{mnemonic:"SWAP",syntax:"swap",stackEffect:"a b swap == b a",description:"Swaps the top two values on the stack.",opcode:36},{mnemonic:"MOD",syntax:"%",stackEffect:"a b % == n",description:"Computes the remainder of a divided by b.",opcode:37},{mnemonic:"AND",syntax:"&",stackEffect:"a b & == n",description:"Bitwise AND of a and b.",opcode:38},{mnemonic:"STASH",syntax:"(",stackEffect:"… ( == {moves stack to queue}",description:"Moves values from the stack to the queue.",opcode:40},{mnemonic:"FETCH",syntax:")",stackEffect:") == … {restores stack from queue}",description:"Moves values from the queue back to the stack.",opcode:41},{mnemonic:"MUL",syntax:"*",stackEffect:"a b * == n",description:"Multiplies a by b.",opcode:42},{mnemonic:"ADD",syntax:"+",stackEffect:"a b + == n",description:"Adds a and b together.",opcode:43},{mnemonic:"SUB",syntax:"-",stackEffect:"a b - == n",description:"Subtracts b from a.",opcode:45},{mnemonic:"DUMP",syntax:".",stackEffect:"… . == … {prints stack}",description:"Prints the entire stack to output.",opcode:46},{mnemonic:"DIV",syntax:"/",stackEffect:"a b / == n",description:"Divides a by b (integer division).",opcode:47},{mnemonic:"MARK",syntax:":",stackEffect:"n : == {begin definition(n)}",description:"Begins a new word definition with name n.",opcode:58},{mnemonic:"DEF",syntax:";",stackEffect:"; == {end definition}",description:"Ends the current word definition.",opcode:59},{mnemonic:"LT",syntax:"<",stackEffect:"a b < == flag",description:"Pushes true if a is less than b.",opcode:60},{mnemonic:"EQ",syntax:"=",stackEffect:"a b = == flag",description:"Pushes true if a equals b.",opcode:61},{mnemonic:"GT",syntax:">",stackEffect:"a b > == flag",description:"Pushes true if a is greater than b.",opcode:62},{mnemonic:"WHEN",syntax:"?",stackEffect:"flag [A] ? == a*",description:"Executes the quotation if flag is true.",opcode:63},{mnemonic:"BRA",syntax:"[",stackEffect:"[ == {begin quotation}",description:"Begins a quotation (anonymous code block).",opcode:91},{mnemonic:"KET",syntax:"]",stackEffect:"] == [A] {end quotation}",description:"Ends a quotation and pushes it to the stack.",opcode:93},{mnemonic:"POW",syntax:"^",stackEffect:"a b ^ == n",description:"Computes a raised to the power of b.",opcode:94},{mnemonic:"OR",syntax:"|",stackEffect:"a b | == n",description:"Bitwise OR of a and b.",opcode:124},{mnemonic:"NOT",syntax:"~",stackEffect:"a ~ == n'",description:"Bitwise NOT of a.",opcode:126}]};const H=new Map;for(const i of Pn.words)H.set(i.opcode,i);function In(i){return H.get(i)}const Cn=[BigInt(a.DEF),BigInt(a.KET),BigInt(a.MARK),BigInt(a.BRA)],E=0n,T=1n;class V{constructor(n){this.stack=[],this.queue=[],this.defs=new Map,this.symbols=new Map,this.depth=0,this.nextAnonOp=S+1,this.traceOn=!1,this.traceFormat="human",this.traceVerbose=!1,this.traceQueueMax=8,this.traceStackMax=32,this.base=10,this.statsOn=!1,this.profileOn=!1,this.stats={system_instructions_called:0,user_instructions_called:0,max_stack_depth:0,max_queue_depth:0},this.profile={},this.platform=n,this.setup()}static fromBase64(n){return bn(n).flatMap(e=>{const t=e&1n,s=e>>1n;return[t,s]})}getStack(){return this.stack.slice()}peek(){const n=this.stack.length;if(n>0)return this.stack[n-1];throw new Error("Peek: stack underflow")}pop(){if(this.stack.length>0)return this.stack.pop();throw new Error("Pop: stack underflow")}push(n){this.stack.push(n)}poke(n){const e=this.stack.length;if(e>0){this.stack[e-1]=n;return}throw new Error("Poke: stack underflow")}clear(){this.stack.splice(0,this.stack.length)}queuePush(n,e){this.queue.push(n,e)}queueUnshift(n,e){this.queue.unshift(n,e)}queueShift(){return[this.queue.shift()??0n,this.queue.shift()??0n]}queuePop(){const n=this.queue.pop()??0n;return[this.queue.pop()??0n,n]}defineSystem(n,e){const t=BigInt(e),s=this.getName(t);if(this.defs.has(t))throw new Error(`Define: cannot redefine system word "${s}"`);this.defs.set(t,n)}defineUser(n,e){const t=this.getName(e);if(e>-1&&e<S)throw new Error(`Define: cannot define system op "${t}"`);if(this.defs.has(e))throw e>S?new Error(`Define: cannot redefine anon op "${t}"`):new Error(`Define: cannot redefine user op "${t}"`);this.defs.set(e,n)}callSystem(n){var s;const e=this.defs.get(n);if(typeof e=="function"){if(this.statsOn&&this.stats.system_instructions_called++,this.profileOn){const r=performance.now();e();const o=performance.now(),c=this.getName(n)||Number(n);(s=this.profile)[c]||(s[c]=[0,0]),this.profile[c][0]++,this.profile[c][1]!=0,this.profile[c][1]+=o-r;return}return e()}const t=this.getName(n)||n;throw new Error(`Call: undefined system op "${t}"`)}callUser(n){var s;const e=this.defs.get(n);if(Array.isArray(e)){if(this.statsOn&&this.stats.user_instructions_called++,this.queue.unshift(...e),this.profileOn){const r=this.getName(n,`&${n}`);(s=this.profile)[r]||(s[r]=[0,void 0]),this.profile[r][0]++}return}const t=this.getName(n)||n;throw new Error(`Call: undefined user op "${t}"`)}callOp(n){return n>-1n&&n<S?this.callSystem(n):this.callUser(n)}loadBigIntCode(n){this.queue.push(...n)}loadIR(n){var t,s;let e=0;for(;e<n.length;){const r=n[e++];if(r.op===h.call){if(r.value===0n)continue;(t=r.meta)!=null&&t.name&&!this.symbols.has(r.value)&&this.symbols.set(r.value,(s=r.meta)==null?void 0:s.name),this.queuePush(T,r.value)}else this.queuePush(E,r.value)}return this.stack}runChunk(n,e){const t=this.queue;let s=!1,r=e,o=0;for(;t.length>0&&o<n;){const[c,p]=this.queueShift(),l=c===T,u=this.stack.slice();s=!this.depth||l&&Cn.includes(p),l?s?this.callOp(p):(this.push(c),this.push(p)):(s||this.push(c),this.push(p)),this.statsOn&&(this.stats.max_stack_depth=Math.max(this.stats.max_stack_depth,this.stack.length),this.stats.max_queue_depth=Math.max(this.stats.max_queue_depth,t.length/2));const f=r++;this.traceOn&&this.trace({step:f,immediate:s,tag:c,value:p,stackBefore:u,stackAfter:this.traceVerbose||this.traceFormat==="jsonl"?this.stack.slice():void 0}),o++}return r}run(){return this.runChunk(Number.POSITIVE_INFINITY,0),this.stack}async runAsync(n={}){var l;const e=n.yieldIntervalMs??160,t=n.yieldSliceMax??n.yieldEvery??655360;if(!Number.isFinite(e)||e<0)throw new Error(`runAsync: yieldIntervalMs must be a non-negative finite number (received ${e})`);if(!Number.isFinite(t)||t<1)throw new Error(`runAsync: yieldSliceMax / yieldEvery must be a positive finite number (received ${t})`);const s=n.scheduler??(()=>new Promise(u=>{globalThis.setTimeout(u,0)})),r=typeof globalThis.performance<"u"&&typeof globalThis.performance.now=="function"?()=>globalThis.performance.now():()=>globalThis.Date.now();let o=0,c=0,p=!1;for(;this.queue.length>0&&!p;){const u=r(),f=e>0?u+e:u;for(;this.queue.length>0&&!p&&!(e>0&&r()>=f);){const m=o;if(o=this.runChunk(t,o),c+=o-m,(l=n.onChunk)==null||l.call(n,{vmCyclesExecuted:c}),n.shouldContinue&&!n.shouldContinue()){p=!0;break}if(e===0)break}this.queue.length>0&&!p&&await s()}return{stack:this.stack.slice(),cancelled:p,vmCyclesExecuted:c}}trace({step:n,immediate:e,tag:t,value:s,stackBefore:r,stackAfter:o}){const c=this.createTraceEvent(n,e,t,s,r,o);if(this.traceFormat==="jsonl"){this.writeTraceLine(JSON.stringify(c));return}this.writeTraceLine(this.formatHumanTrace(c))}createTraceEvent(n,e,t,s,r,o){const c=t===T,p=c?this.getName(s,String(s)):String(s),l=this.getQueuePreview();return{step:n,immediate:e,tag:c?"call":"literal",value:String(s),action:p,stack_before:this.limitStack(r).map(String),stack_after:o?this.limitStack(o).map(String):void 0,queue_preview:l,queue_depth:this.queue.length/2}}limitStack(n){return n.length>this.traceStackMax?n.slice(-this.traceStackMax):n}getQueuePreview(){const n=[],e=Math.max(this.traceQueueMax,0);for(let t=0;t<this.queue.length&&n.length<e;t+=2){const s=this.queue[t]??0n,r=this.queue[t+1]??0n,o=s===T;n.push({tag:o?"call":"literal",value:String(r),action:o?this.getName(r,String(r)):String(r)})}return n}formatHumanTrace(n){const e=this.padHumanAction(n.action),t=this.formatHumanStack(n.stack_before),s=this.formatHumanQueue(n.queue_preview,n.queue_depth),r=this.layoutHumanTraceLine(n.step,t,e,s);if(this.traceVerbose){const o=this.formatHumanStack(n.stack_after??[]);return`${r}
${" ".repeat(String(n.step).length+1)}${o} | immediate=${n.immediate} tag=${n.tag} value=${n.value} stack_depth=${this.stack.length} queue_depth=${n.queue_depth}`}return r}padHumanAction(n){return n.length>=7?n:n.padStart(Math.floor((7+n.length)/2)," ").padEnd(7," ")}layoutHumanTraceLine(n,e,t,s){const r=this.getTraceTerminalWidth(),o=`${n} `;if(o.length>=r)return o.slice(0,r);const c=1,p=Math.min(t.length,Math.max(r-o.length-c*2,1)),l=Math.max(o.length+c,Math.floor((r-p)/2)),u=Math.min(l,Math.max(o.length+c,r-p-c)),f=u+p,m=o.length,d=Math.max(m,u-c),g=Math.min(r,f+c),v=r,Z=Math.max(d-m,0),J=Math.max(v-g,0),C=Array.from({length:r},()=>" ");if(this.writeSegment(C,0,o,o.length),this.writeSegment(C,u,t,p),Z>0){const I=this.truncateLeft(e,Z);this.writeSegment(C,d-I.length,I,I.length)}if(J>0){const I=this.truncateRight(s,J);this.writeSegment(C,g,I,I.length)}return C.join("").replace(/\s+$/,"")}formatHumanStack(n){return n.length===0?"[ ]":`[ ${n.join(" ")} ]`}formatHumanQueue(n,e){const t=n.map(r=>r.tag==="call"?`&${r.action}`:r.value),s=Math.max(e-n.length,0);return s>0&&t.push(`…(+${s})`),t.length===0?"[ ]":`[ ${t.join(" ")} ]`}getTraceTerminalWidth(){var o,c,p,l,u,f,m;const e=globalThis.Deno,t=(c=(o=e==null?void 0:e.stderr)==null?void 0:o.isTerminal)!=null&&c.call(o)&&typeof e.stderr.rid=="number"?e.stderr.rid:(l=(p=e==null?void 0:e.stdout)==null?void 0:p.isTerminal)!=null&&l.call(p)&&typeof e.stdout.rid=="number"?e.stdout.rid:void 0;if(typeof t=="number")try{const d=(u=e==null?void 0:e.consoleSize)==null?void 0:u.call(e,t).columns;if(typeof d=="number"&&d>0)return d}catch{}const s=globalThis.process,r=(f=s==null?void 0:s.stderr)!=null&&f.isTTY&&typeof s.stderr.columns=="number"?s.stderr.columns:(m=s==null?void 0:s.stdout)!=null&&m.isTTY&&typeof s.stdout.columns=="number"?s.stdout.columns:void 0;return typeof r=="number"&&r>0?r:120}truncateLeft(n,e){return e<=0?"":n.length<=e?n:e===1?"…":`…${n.slice(-(e-1))}`}truncateRight(n,e){return e<=0?"":n.length<=e?n:e===1?"…":`${n.slice(0,e-1)}…`}writeSegment(n,e,t,s){if(!(s<=0))for(let r=0;r<s&&r<t.length&&e+r<n.length;r++)n[e+r]=t[r]}writeTraceLine(n){const e=new TextEncoder().encode(`${n}
`);if(this.platform.io.writeError){this.platform.io.writeError(e);return}this.platform.io.write(e)}getName(n,e=String(n)){return this.symbols.has(n)?this.symbols.get(n):String(e)}inspectValue(n){const e=this.symbols.get(n),t=n>=0n&&n<=BigInt(S),s=this.defs.get(n),r=s!==void 0;let o;Array.isArray(s)&&(o=this.parseDefinitionTokens(s));let c,p;if(t){const l=In(Number(n));l&&(c=l.stackEffect,p=l.description)}return{value:n,name:e,isSystem:t,isDefined:r,definition:o,stackEffect:c,description:p}}parseDefinitionTokens(n){const e=[];for(let t=0;t<n.length;t+=2){const s=n[t]??0n,r=n[t+1]??0n,o=s===T,c=o?this.symbols.get(r):void 0,p=this.defs.has(r);e.push({value:r,tag:s,name:c,isCall:o,isDefined:p})}return e}print(){const n=this.stack.map(e=>e.toString(this.base)).join(" ");this.platform.io.write(new TextEncoder().encode(`[ ${n} ]
`))}loadSourceMap(n){Object.keys(n.symbols).forEach(e=>{this.symbols.set(BigInt(e),n.symbols[e])})}getNextAnonOp(){let n=this.nextAnonOp++;for(;this.defs.has(BigInt(n));)n=this.nextAnonOp++;return BigInt(n)}setup(){const n=new TextEncoder;let e;for(e in k)this.symbols.set(BigInt(k[e]),e);this.defineSystem(()=>{},a.NOP),this.defineSystem(()=>{const t=this.pop();this.callOp(t)},a.CALL),this.defineSystem(()=>{this.depth--;const[,t]=this.queuePop(),s=this.stack.splice(Number(t||0))||[];this.defineUser(s,this.pop())},a.DEF),this.defineSystem(()=>{this.depth--;const[,t]=this.queuePop(),s=this.stack.splice(Number(t||0))||[],r=this.getNextAnonOp();this.defineUser(s,r),this.depth>0&&this.push(0n),this.push(r)},a.KET),this.defineSystem(()=>{this.depth++;const t=this.stack.length;this.queuePush(E,BigInt(t))},a.BRA),this.defineSystem(()=>{this.depth++;const t=this.stack.length;this.queuePush(E,BigInt(t))},a.MARK),this.defineSystem(()=>this.clear(),a.CLR),this.defineSystem(()=>{const t=this.pop();this.platform.exit(Number(t))},a.EXIT),this.defineSystem(()=>{const t=this.pop();this.push(Rn(t))},a.RAND),this.defineSystem(()=>{this.print()},a.PRN),this.defineSystem(()=>{this.push(BigInt(this.platform.now()))},a.CLOCK),this.defineSystem(()=>{const t=n.encode(String.fromCharCode(Number(this.pop())));this.platform.io.write(t)},a.PUTC),this.defineSystem(()=>{this.platform.io.setRaw&&this.platform.io.setRaw(!0);const t=this.platform.io.readByte();this.platform.io.setRaw&&this.platform.io.setRaw(!1),this.push(BigInt(t??0))},a.GETC),this.defineSystem(()=>{const t=n.encode(this.pop().toString(this.base));this.platform.io.write(t)},a.PUTN),this.defineSystem(()=>{this.pop()},a.DROP),this.defineSystem(()=>{const t=this.peek(),s=this.stack[this.stack.length-2];this.stack[this.stack.length-2]=t,this.poke(s)},a.SWAP),this.defineSystem(()=>{this.push(this.peek())},a.DUP),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]+=t},a.ADD),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]-=t},a.SUB),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]*=t},a.MUL),this.defineSystem(()=>{const t=this.pop();if(t===0n)throw new Error("DIV: Division by zero");this.stack[this.stack.length-1]/=t},a.DIV),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]%=t},a.MOD),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]<<=t},a.SHIFTL),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]>>=t},a.SHIFTR),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]&=t},a.AND),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]**=t},a.POW),this.defineSystem(()=>{this.push(this.pop()>this.pop()?1n:0n)},a.LT),this.defineSystem(()=>{this.push(this.pop()===this.pop()?1n:0n)},a.EQ),this.defineSystem(()=>{this.push(this.pop()<this.pop()?1n:0n)},a.GT),this.defineSystem(()=>{const t=this.pop();this.pop()!==0n&&this.queueUnshift(T,t)},a.IF),this.defineSystem(()=>{this.queuePush(E,this.pop())},a.PUSHR),this.defineSystem(()=>{const[,t]=this.queuePop();this.push(t)},a.PULLR),this.defineSystem(()=>{this.push(BigInt(this.stack.length))},a.DEPTH),this.defineSystem(()=>{const t=this.stack.length;this.stack.splice(0,t).forEach(r=>this.queuePush(E,r)),this.queuePush(E,BigInt(t))},a.STASH),this.defineSystem(()=>{const[,t]=this.queuePop(),s=Number(t),r=[];for(let o=0;o<s;o++){const[,c]=this.queuePop();r.unshift(c)}this.stack.unshift(...r)},a.FETCH),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]|=t},a.OR),this.defineSystem(()=>{const t=this.pop();this.push(~t)},a.NOT),this.defineSystem(()=>{const t=this.pop(),r=[0n,this.pop(),1n,t],o=this.getNextAnonOp();this.defineUser(r,o),this.depth>0&&this.push(0n),this.push(o)},a.CONS)}printProfile(){console.log(),console.log("Profile:");const n=Object.keys(this.profile).map(s=>{const r=this.profile[s][0],o=this.profile[s][1];return{name:s,calls:r,time:o,system:typeof o<"u","ops/ms":o?Math.round(r/o):""}}).sort((s,r)=>r.calls-s.calls),e=n.filter(s=>s.system),t=n.filter(s=>!s.system);console.table(e,["name","calls","ops/ms"]),console.table(t,["name","calls"]),console.log()}printStats(){console.log(),console.log("Interpreter stats:"),console.log(this.stats),console.log()}}function Rn(i){const n=i,e=n.toString().length;let t="";for(;t.length<e;)t+=Math.random().toString().split(".")[1];t=t.slice(0,e);const s="1"+"0".repeat(e);return n*BigInt(t)/BigInt(s)}const R=BigInt(a.DEF),K=BigInt(a.KET),B=BigInt(a.MARK),Q=BigInt(a.BRA),_=i=>(i=BigInt(i),n=>n.op===h.call&&n.value===i),A=i=>(i=BigInt(i),n=>n.op===h.push&&n.value===i),b=i=>i.op===h.push,G=i=>i.op===h.push&&i.value!==0n,Bn=[{name:"No operation",pattern:[_(a.NOP)],replacement:()=>[]},{name:"Null Sequence - SWAP SWAP",pattern:[_(a.SWAP),_(a.SWAP)],replacement:()=>[]},{name:"Null Sequence - DUP DROP",pattern:[_(a.DUP),_(a.DROP)],replacement:()=>[]},{name:"Null Sequence - PUSHR PULLR",pattern:[_(a.PUSHR),_(a.PULLR)],replacement:()=>[]},{name:"Null Sequence - CLOCK DROP",pattern:[_(a.CLOCK),_(a.DROP)],replacement:()=>[]},{name:"Null Sequence - RAND DROP",pattern:[_(a.RAND),_(a.DROP)],replacement:()=>[]},{name:"Null Sequence - DEPTH DROP",pattern:[_(a.DEPTH),_(a.DROP)],replacement:()=>[]},{name:"Null Sequence - NOT NOT",pattern:[_(a.NOT),_(a.NOT)],replacement:()=>[]},{name:"Indirect calls - n EVAL",pattern:[b,_(a.CALL)],replacement:i=>{var n,e;return[{op:h.call,value:i.value,meta:{name:(e=(n=i.meta)==null?void 0:n.name)==null?void 0:e.replace(/^&/,"")}}]}},{name:"Null Sequence - n DROP",pattern:[b,_(a.DROP)],replacement:()=>[]},{name:"Constant Folding - a b ADD",pattern:[b,b,_(a.ADD)],replacement:(i,n)=>[{op:h.push,value:i.value+n.value}]},{name:"Algebraic Simplification - 0 ADD",pattern:[A(0),_(a.ADD)],replacement:()=>[]},{name:"Algebraic Simplification - swap ADD",pattern:[_(a.SWAP),_(a.ADD)],replacement:(i,n)=>[n]},{name:"Constant Folding - a b SUB",pattern:[b,b,_(a.SUB)],replacement:(i,n)=>[{op:h.push,value:i.value-n.value}]},{name:"Algebraic Simplification - 0 SUB",pattern:[A(0),_(a.SUB)],replacement:()=>[]},{name:"Constant Folding - a b MUL",pattern:[b,b,_(a.MUL)],replacement:(i,n)=>[{op:h.push,value:i.value*n.value}]},{name:"Algebraic Simplification - 1 MUL",pattern:[A(1),_(a.MUL)],replacement:()=>[]},{name:"Algebraic Simplification - swap MUL",pattern:[_(a.SWAP),_(a.MUL)],replacement:(i,n)=>[n]},{name:"Constant Folding - a b DIV",pattern:[b,G,_(a.DIV)],replacement:(i,n)=>[{op:h.push,value:i.value/n.value}]},{name:"Algebraic Simplification - 1 DIV",pattern:[A(1),_(a.DIV)],replacement:()=>[]},{name:"Constant propagation - a DUP",pattern:[b,_(a.DUP)],replacement:i=>[i,i]},{name:"Unreachable Code - 0 &b IF",pattern:[A(0),b,_(a.IF)],replacement:()=>[]},{name:"Flows-Of-Control Optimizations - !0 &b IF",pattern:[G,b,_(a.IF)],replacement:(i,n,e)=>{var t,s;return[{op:h.call,value:n.value,meta:{name:(s=(t=n.meta)==null?void 0:t.name)==null?void 0:s.replace(/^&/,"")}}]}},{name:"Null Sequence - 0 eval",pattern:[A(0),_(a.CALL)],replacement:()=>[]},{name:"Empty List - [ ]",pattern:[_(a.BRA),_(a.KET)],replacement:()=>[{op:h.push,value:0n,meta:{pointer:!0,name:"0"}}]},{name:"a q< b a> - b a",pattern:[b,_(a.PUSHR),b,_(a.PULLR)],replacement:(i,n,e)=>[e,i]}];class Dn{constructor(){this.stats={pre_optimization_ir_size:0,post_optimization_ir_size:0,user_defined_anon_defs:0,user_defined_named_defs:0,post_optimization_user_defs:0,inlined_calls:0,peephole_optimizations:0,optimization_passes:0},this.minOptPasses=2,this.maxOptPasses=20,this.defs=new Map,this.calledWords=new Set,this.optimized=[],this.nextAnonOp=S+1}optimize(n){this.reset(),this.stats.pre_optimization_ir_size=n.length,this.optimized=n;let e;do e=this.optimized.length,this.optLoop();while((this.optimized.length<e||this.stats.optimization_passes<this.minOptPasses)&&this.stats.optimization_passes<this.maxOptPasses);return this.optimized=this.pullDefs(this.optimized),this.optimized=this.addReferencedWords(this.optimized),this.stats.post_optimization_ir_size=this.optimized.length,this.optimized}optLoop(){this.optimized=this.peepholeOptimization(this.optimized),this.optimized=this.getDefs(this.optimized),this.optimized=this.inlineWords(this.optimized,4),this.stats.optimization_passes++}reset(){this.optimized=[],this.defs=new Map,this.calledWords=new Set,this.stats={pre_optimization_ir_size:0,post_optimization_ir_size:0,user_defined_anon_defs:0,user_defined_named_defs:0,post_optimization_user_defs:0,inlined_calls:0,peephole_optimizations:0,optimization_passes:0}}getDefs(n){var t;let e=0;for(;e<n.length;){const s=n[e];if(s.op===h.call){if(s.value===K){this.stats.optimization_passes===0&&this.stats.user_defined_anon_defs++,s.meta??(s.meta={}),(t=s.meta).uid??(t.uid=this.nextAnonOp++);let r=e;for(;r-- >0;){const l=n[r];if(l.op===h.call&&l.value===Q)break}const o=BigInt(s.meta.uid),c={op:h.push,value:o,meta:{pointer:!0}},p=n.slice(r,e+1);p.unshift(c),p[1]={...p[1],value:B,meta:{...p[1].meta,name:":"}},p[p.length-1]={...p[p.length-1],value:R,meta:{...p[p.length-1].meta,name:";"}},this.defs.set(o,p)}else if(s.value===R){this.stats.optimization_passes===0&&this.stats.user_defined_named_defs++;let r=e;for(;r-- >0;){const p=n[r];if(p.op===h.call&&p.value===B)break}const o=n[r-1];o.meta||(o.meta={}),o.meta.pointer=!0;const c=n.slice(r-1,e+1);this.defs.set(o.value,c)}}e++}return n}pullDefs(n,e=!1){var r;const t=n.slice();let s=0;for(;s<t.length;){const o=t[s];if(o.op===h.call){if(o.value===K){o.meta??(o.meta={}),(r=o.meta).uid??(r.uid=this.nextAnonOp++);const c=s;for(;s-- >0;){const f=t[s];if(f.op===h.call&&f.value===Q)break}const p=BigInt(o.meta.uid),l={op:h.push,value:p,meta:{pointer:!0}},u=t.splice(s,c-s+1,l);u.unshift(l),u[1]={...u[1],value:B,meta:{...u[1].meta,name:":"}},u[u.length-1]={...u[u.length-1],value:R,meta:{...u[u.length-1].meta,name:";"}},this.defs.set(p,u)}else if(o.value===R&&!e){const c=s;for(;s-- >0;){const u=t[s];if(u.op===h.call&&u.value===B)break}const p=t[s-1];p.meta||(p.meta={}),p.meta.pointer=!0;const l=t.splice(s-1,c-s+2);s=s-2,this.defs.set(l[0].value,l)}}s++}return t}peepholeOptimization(n){const e=n.slice();for(;;){const t=this.stats.peephole_optimizations;let s=0;for(;s<e.length;){for(const r of Bn){const{pattern:o,replacement:c}=r;if(s+o.length>e.length)continue;if(o.every((l,u)=>l(e[s+u]))){this.stats.peephole_optimizations++;const l=e.slice(s,s+o.length);e.splice(s,o.length,...c(...l)),s=Math.max(0,s-o.length-1);break}}s++}if(this.stats.peephole_optimizations===t)break}return e}inlineWords(n,e=1,t=[]){return n.flatMap(s=>{var r,o,c,p;if((r=s.meta)!=null&&r.unsafe)return s;if(s.op===h.call&&this.defs.has(s.value)){if(t.includes(s.value))return s;const l=this.defs.get(s.value);if(!l)return s;const u=l[l.length-1];if((o=u.meta)!=null&&o.unsafe)return s;if((c=u.meta)!=null&&c.inline||(p=s.meta)!=null&&p.inline)return this.stats.inlined_calls++,this.inlineWords(l.slice(2,-1),1/0,t.concat(s.value));if(l.length<=e+3)return this.stats.inlined_calls++,this.inlineWords(l.slice(2,-1),e,t.concat(s.value))}return s})}addReferencedWords(n){return n.slice().forEach(e=>{var t;e.op===h.push&&((t=e.meta)!=null&&t.pointer)?this.addDef(e.value):e.op===h.call&&this.addDef(e.value)}),n}addDef(n){if(!this.calledWords.has(n)){const e=this.defs.get(n);if(e)return this.stats.post_optimization_user_defs++,this.calledWords.add(n),this.optimized.unshift(...e),this.addReferencedWords(e)}}}class q{constructor(n,e,t){this.imported=new Set,this.importPrefixes=new Map,this.macroPreludeReady=!1,this.rootFilename=null,this.host=n,this.engine=e.engine,this.compiler=e.compiler||new w,t!=null&&t.macroEngineBootstrapFile&&this.bootstrapMacroEngine(t.macroEngineBootstrapFile)}static tokenize(n){return n.split(/[\r\n]+/)}preprocess(n,e="-"){const t=this.rootFilename===null;t&&e!=="-"&&(this.rootFilename=e);try{return this.preprocessLines(n,e)}finally{t&&(this.rootFilename=null)}}preprocessLines(n,e,t){return n.map(s=>{if(s.length>1&&s[0]==="."){const[r,...o]=s.split(" ");if(r[0]==="."&&r.length>1){switch(r){case".exit":if(this.host.exit){this.host.exit();break}throw new Error("Preprocessor: .exit requires a host exit handler");case".load":{const c=this.findFile(o.join(" "),e),p=this.host.readTextFile(c);return this.preprocessLines(q.tokenize(p),c)}case".import":{const c=this.findFile(o.join(" "),e);if(!this.imported.has(c)){this.imported.add(c);const p=this.host.readTextFile(c);return this.preprocessLines(q.tokenize(p),c,c)}return""}case".m":return this.runMacro(o.join(" "),s);case".ff":return this.runMacro(o.join(" "),s);case".ffp":{if(!this.macroPreludeReady)throw new Error("Preprocessor: .ffp requires prelude-enabled macro context");return this.runMacro(o.join(" "),s)}}return""}}return t?this.mangleImportedLine(s,t):s}).join(`
`)}findFile(n,e="-"){if(e&&e!=="-"&&!this.host.path.isAbsolute(n)){const t=this.host.path.dirname(e),s=this.host.path.resolve(t,n);if(this.host.fileExists(s))return s}if(this.host.fileExists(n))return n;throw'File not found: "'+n+'"'}bootstrapMacroEngine(n){const e=this.findFile(n),t=this.host.readTextFile(e),r=new q(this.host,{engine:this.engine,compiler:this.compiler}).preprocess(q.tokenize(t),e),o=this.compiler.compileToIR(w.tokenize(r),e);this.engine.loadIR(o),this.engine.run(),this.engine.clear(),this.macroPreludeReady=!0}runMacro(n,e){const t=this.compiler.compileToIR(w.tokenize(n));this.engine.loadIR(t),this.engine.run();const s=this.engine.getStack();return this.engine.clear(),s.map(String).join(" ")+` /* ${e} */`}mangleImportedLine(n,e){const t=this.getImportPrefix(e);return n.split(/(\s+)/).map(s=>!s||/\s+/.test(s)?s:this.mangleImportedToken(s,t)).join("")}mangleImportedToken(n,e){return n.startsWith("[__")?`[${e}${n.slice(3)}`:n.startsWith("__")?`${e}${n.slice(2)}`:n}getImportPrefix(n){const e=this.importPrefixes.get(n);if(e)return e;const s=this.getNormalizedImportPath(n).replace(/[^A-Za-z0-9]+/g,"_").replace(/^_+|_+$/g,"").replace(/_+/g,"_")||"module",r=this.hashPath(n),o=`__${s}_${r}__`;return this.importPrefixes.set(n,o),o}getNormalizedImportPath(n){if(this.rootFilename&&this.rootFilename!=="-"){const e=this.host.path.dirname(this.rootFilename),t=this.host.path.relative(e,n);if(t)return t.replace(/\\/g,"/")}return n.replace(/\\/g,"/")}hashPath(n){let e=2166136261;for(let t=0;t<n.length;t++)e^=n.charCodeAt(t),e=Math.imul(e,16777619)>>>0;return e.toString(36)}}var zn=`.import ../lib/prelude.ffp
...
over ++
step
drop drop . /* 837799 */`,Ln=`.import ../lib/prelude.ffp
...
/* Omitted: 1_000_000_000_000 ! … (expected [ 16576 ]) — factorial(10^12) is not practical here. */`,Un=`.import ../lib/prelude.ffp
...
0 1 1 r drop drop ++ . /* 4782 */`,Wn=`.import ../lib/prelude.ffp
...
600851475143 factors last! . /* 6857 */`,Hn=`.import ../lib/prelude.ffp
...
/* 9110846700 */`,Qn=`.import ../lib/prelude.ffp
...
/* 25164150 */`,Xn=`.import ../lib/prelude.ffp
...
half_pi:
  npi 1 >>
; /* n half_pi == floor(10ⁿ*π/2) */`,_e=`.import ../core/core.ff
.import ./arith.ffp
...
nsqrt:
  ...
  swap n->S2 * isqrt
;
`,ve=`/* Trigonometric words live here. Pi-derived constants are defined in pi.ffp. */
`,we=`.import ./core/core.ff
.import ./math/math.ffp
.import ./string/string.ffp
.import ./seq/seq.ffp
.import ./time/time.ffp`,ye=`.import ../core/core.ff
...
`,ke=`.import char.ffp
.import str.ffp`,Se=`.import ./core/core.ff
.import ./string/string.ffp
...
/* 93326215443944152681699238856266700490715968264381621468592963895217599993229915608941463976156518286253697920827223758251185210916864000000000000000000000000 */`,Ie=`.import ./lib/math/cbrt.ffp
...
50 pi-digits .
`;const ze=new Set(["../../ff/euler/euler4.ffp","../../ff/euler/euler10.ffp","../../ff/euler/euler14.ffp","../../ff/euler/euler46.ffp"]);function Oe(i){const n="../../ff/lib/";if(!i.startsWith(n))throw new Error(`Unexpected library source path: ${i}`);return`/lib/${i.slice(n.length)}`}const Me=Object.assign({"../../ff/euler/euler1.ffp":zn,"../../ff/euler/euler10.ffp":On,"../../ff/euler/euler13.ffp":Mn,"../../ff/euler/euler14.ffp":Nn,"../../ff/euler/euler16.ffp":Ln,"../../ff/euler/euler160.ffp":Fn,"../../ff/euler/euler2.ffp":Un,"../../ff/euler/euler20.ffp":$n,"../../ff/euler/euler25.ffp":jn,"../../ff/euler/euler3.ffp":Wn,"../../ff/euler/euler4.ffp":Hn,"../../ff/euler/euler46.ffp":Vn,"../../ff/euler/euler48.ffp":Kn,"../../ff/euler/euler5.ffp":Qn,"../../ff/euler/euler6.ffp":Gn,"../../ff/euler/euler7.ffp":Xn,"../../ff/euler/euler8.ffp":Yn,"../../ff/euler/euler9.ffp":Zn});function X(i){const n=i.split("/").pop()??i,e=/^euler(\d+)\.ffp$/.exec(n);return e?[Number(e[1]),n]:[Number.POSITIVE_INFINITY,n]}const Ne=Object.entries(Me).filter(([i])=>!ze.has(i)).sort((i,n)=>{const e=X(i[0]),t=X(n[0]);return e[0]!==t[0]?e[0]-t[0]:e[1].localeCompare(t[1])}).map(([i,n])=>({path:Le(i),label:Fe(i),source:n}));function Le(i){const n=i.lastIndexOf("/");return`/examples/${n>=0?i.slice(n+1):i}`}function Fe(i){const n=i.indexOf("../../ff/");return n>=0?i.slice(n+9):i}const Ue=[{path:"/examples/fact.ffp",label:"fact.ffp",source:Pe},{path:"/examples/cbrt.ffp",label:"cbrt.ffp",source:Ie},{path:"/examples/sqrt.ffp",label:"sqrt.ffp",source:Ce},{path:"/examples/gcd.ffp",label:"gcd.ffp",source:Re},{path:"/examples/ack.ffp",label:"ack.ffp",source:Be},{path:"/examples/pi.ffp",label:"pi.ffp",source:De},...Ne],$e=Object.fromEntries(Object.entries(Object.assign({"../../ff/lib/core/core.ff":Jn,"../../ff/lib/math/ack.ffp":ne,"../../ff/lib/math/arith.ffp":ee,"../../ff/lib/math/atan-core.ffp":te,"../../ff/lib/math/atan-shared.ffp":se,"../../ff/lib/math/atan.ffp":ie,"../../ff/lib/math/atanh-core.ffp":re,"../../ff/lib/math/atanh.ffp":ae,"../../ff/lib/math/cbrt.ffp":oe,"../../ff/lib/math/exp.ffp":pe,"../../ff/lib/math/gcd.ffp":ce,"../../ff/lib/math/log.ffp":le,"../../ff/lib/math/math.ffp":ue,"../../ff/lib/math/num.ffp":de,"../../ff/lib/math/pi.ffp":he,"../../ff/lib/math/precision.ffp":_e,"../../ff/lib/math/pred.ffp":fe,"../../ff/lib/math/primes.ffp":me,"../../ff/lib/math/prn.ffp":ge,"../../ff/lib/math/sqrt.ffp":be,"../../ff/lib/math/trig.ffp":ve,"../../ff/lib/prelude.ffp":we,"../../ff/lib/seq/seq.ffp":ye,"../../ff/lib/string/char.ffp":xe,"../../ff/lib/string/str.ffp":qe,"../../ff/lib/string/string.ffp":ke,"../../ff/lib/tap.ffp":Se,"../../ff/lib/testing.ffp":Ee,"../../ff/lib/time/time.ffp":Te,"../../ff/lib/time/utc.ffp":Ae})).map(([i,n])=>[Oe(i),n])),je=Object.fromEntries(Ue.map(({path:i,source:n})=>[i,n]));function We(i,n="/main.ffp"){return{[n]:i,...$e,...je}}function P(i){const n=i.startsWith("/"),e=i.split("/").filter(Boolean),t=[];for(const s of e)if(s!=="."){if(s===".."){t.pop();continue}t.push(s)}return`${n?"/":""}${t.join("/")}`||(n?"/":".")}function He(i){const n=P(i),e=n.lastIndexOf("/");return e<=0?n.startsWith("/")?"/":".":n.slice(0,e)}function Ve(...i){const n=i.filter(Boolean).join("/").replaceAll(/\/+/g,"/");return P(n)}function Ke(i,n){const e=P(i).split("/").filter(Boolean),t=P(n).split("/").filter(Boolean);let s=0;for(;s<e.length&&s<t.length&&e[s]===t[s];)s++;const r=e.length-s,o=t.slice(s);return Array(r).fill("..").concat(o).join("/")||"."}function Qe(i){return{readTextFile(n){const e=P(n),t=i[e];if(typeof t!="string")throw new Error(`Virtual file not found: ${e}`);return t},fileExists(n){return typeof i[P(n)]=="string"},path:{isAbsolute(n){return n.startsWith("/")},dirname:He,relative:Ke,resolve:Ve}}}function Ge(i={}){const n=new TextDecoder,e=new TextEncoder,t=Array.from(e.encode(i.stdin??""));return{io:{write(s){var r;(r=i.onWrite)==null||r.call(i,n.decode(s))},readByte(){return t.shift()??null}},exit(s){var r;(r=i.onExit)==null||r.call(i,s)},now(){return Date.now()}}}const Xe="/lib/prelude.ffp",Ye="/main.ffp";function Ze(i){return An.length+i.length}function Y(i,n){const e=console.log;console.log=(...t)=>{i(t.map(String).join(" "))};try{return n()}finally{console.log=e}}async function Je(i,n){const e=console.log;console.log=(...t)=>{i(t.map(String).join(" "))};try{return await n()}finally{console.log=e}}function nt(i,n,e={}){let t="";const s=[];let r=0;const o=e.filename??Ye,c=Ge({stdin:n,onWrite(g){t+=g},onExit(g){r=g}}),p=new w,l=new V(c),u=new w,f=new V(c),m=We(i,o),d=new q(Qe(m),{engine:f,compiler:u},{macroEngineBootstrapFile:Xe});return{compiler:p,engine:l,preprocessor:d,filename:o,logs:s,getOutput(){return t},getExitCode(){return r}}}function et(i,n,e,t={}){const s=nt(i,n,t),r=performance.now(),o=Y(p=>s.logs.push(p),()=>{const p=s.preprocessor.preprocess(q.tokenize(i),s.filename);let l=s.compiler.compileToIR(w.tokenize(p),s.filename);const u=s.compiler.validate(l);e&&(l=new Dn().optimize(l));const f=_n(l),m=w.compileToBase64(l),d=Ze(m);return s.engine.loadIR(l),{preprocessed:p,formattedIr:f,bytecode:m,compiledBytes:d,issues:u}}),c=performance.now();return{preprocessed:o.preprocessed,ir:o.formattedIr,bytecode:o.bytecode,compiledBytes:o.compiledBytes,issues:o.issues,compileMs:c-r,execute(){const p=performance.now();Y(u=>s.logs.push(u),()=>{s.engine.run()});const l=performance.now();return{output:s.getOutput(),stack:s.engine.getStack().map(String),logs:[...s.logs],exitCode:s.getExitCode(),executeMs:l-p,cancelled:!1,vmCyclesExecuted:0}},async executeAsync(p={}){const l=performance.now(),u=await Je(m=>s.logs.push(m),async()=>await s.engine.runAsync(p)),f=performance.now();return{output:s.getOutput(),stack:s.engine.getStack().map(String),logs:[...s.logs],exitCode:s.getExitCode(),executeMs:f-l,cancelled:u.cancelled,vmCyclesExecuted:u.vmCyclesExecuted}}}}function D(i){self.postMessage(i)}let N=!1,y=null;function tt(i,n){const e=n.cancelled?"cancelled":"done";return{output:n.output,preprocessed:i.preprocessed,ir:i.ir,bytecode:i.bytecode,compiledBytes:i.compiledBytes,issues:i.issues,stack:n.stack,logs:n.logs,exitCode:n.exitCode,compileMs:i.compileMs,executeMs:n.executeMs,terminal:e,vmCyclesExecuted:n.vmCyclesExecuted}}self.onmessage=i=>{const n=i.data;if(n.type==="CANCEL"){y===n.runId&&(N=!0);return}if(n.type!=="RUN")return;const{runId:e,source:t,stdin:s,optimize:r,filename:o,yieldIntervalMs:c,yieldSliceMax:p}=n;(async()=>{N=!1,y=e;try{const l=et(t,s,r,{filename:o});if(y!==e)return;D({type:"COMPILED",runId:e,compileMs:l.compileMs,preprocessed:l.preprocessed,ir:l.ir,bytecode:l.bytecode,compiledBytes:l.compiledBytes});const u=performance.now(),f=await l.executeAsync({yieldIntervalMs:c,yieldSliceMax:p,shouldContinue:()=>!N&&y===e,onChunk:({vmCyclesExecuted:d})=>{y===e&&D({type:"PROGRESS",runId:e,vmCyclesExecuted:d,executeElapsedMs:performance.now()-u})},scheduler:()=>new Promise(d=>{globalThis.setTimeout(d,0)})});if(y!==e)return;const m=tt(l,f);D({type:"RESULT",runId:e,result:m})}catch(l){if(y!==e)return;const u=l instanceof Error?l.message:String(l);D({type:"ERROR",runId:e,message:u})}finally{y===e&&(y=null)}})()}})();
