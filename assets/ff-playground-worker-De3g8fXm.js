...
half_pi:
  npi 1 >>
; /* n half_pi == floor(10ⁿ*π/2) */`,fe=`.import ../core/core.ff
.import ./arith.ffp
...
nfrac: [ abs ] dip n->S % ; /* x n nfrac == (x - floor(x/10^n))*10^n */`,me=`.import ../core/core.ff
...
nsqrt:
  ...
  swap n->S2 * isqrt
;
`,we=`/* Trigonometric words live here. Pi-derived constants are defined in pi.ffp. */
`,ye=`.import ./core/core.ff
.import ./math/math.ffp
.import ./string/string.ffp
.import ./seq/seq.ffp
.import ./time/time.ffp`,xe=`.import ../core/core.ff
...
`,Se=`.import char.ffp
.import str.ffp`,Ee=`.import ./core/core.ff
.import ./string/string.ffp
...
/* 93326215443944152681699238856266700490715968264381621468592963895217599993229915608941463976156518286253697920827223758251185210916864000000000000000000000000 */`,Ce=`.import ./lib/math/cbrt.ffp
...
50 pi-digits .
`;const Oe=new Set(["../../ff/euler/euler4.ffp","../../ff/euler/euler10.ffp","../../ff/euler/euler14.ffp","../../ff/euler/euler46.ffp"]);function Me(i){const n="../../ff/lib/";if(!i.startsWith(n))throw new Error(`Unexpected library source path: ${i}`);return`/lib/${i.slice(n.length)}`}const Le=Object.assign({"../../ff/euler/euler1.ffp":On,"../../ff/euler/euler10.ffp":Mn,"../../ff/euler/euler13.ffp":Ln,"../../ff/euler/euler14.ffp":Nn,"../../ff/euler/euler16.ffp":Fn,"../../ff/euler/euler160.ffp":Un,"../../ff/euler/euler2.ffp":$n,"../../ff/euler/euler20.ffp":jn,"../../ff/euler/euler25.ffp":Wn,"../../ff/euler/euler3.ffp":Hn,"../../ff/euler/euler4.ffp":Vn,"../../ff/euler/euler46.ffp":Kn,"../../ff/euler/euler48.ffp":Qn,"../../ff/euler/euler5.ffp":Xn,"../../ff/euler/euler6.ffp":Gn,"../../ff/euler/euler7.ffp":Yn,"../../ff/euler/euler8.ffp":Zn,"../../ff/euler/euler9.ffp":Jn});function G(i){const n=i.split("/").pop()??i,e=/^euler(\d+)\.ffp$/.exec(n);return e?[Number(e[1]),n]:[Number.POSITIVE_INFINITY,n]}const Ne=Object.entries(Le).filter(([i])=>!Oe.has(i)).sort((i,n)=>{const e=G(i[0]),t=G(n[0]);return e[0]!==t[0]?e[0]-t[0]:e[1].localeCompare(t[1])}).map(([i,n])=>({path:Fe(i),label:Ue(i),source:n}));function Fe(i){const n=i.lastIndexOf("/");return`/examples/${n>=0?i.slice(n+1):i}`}function Ue(i){const n=i.indexOf("../../ff/");return n>=0?i.slice(n+9):i}const Y=[{path:"/examples/fact.ffp",label:"fact.ffp",source:Ie},{path:"/examples/cbrt.ffp",label:"cbrt.ffp",source:Ce},{path:"/examples/sqrt.ffp",label:"sqrt.ffp",source:Re},{path:"/examples/gcd.ffp",label:"gcd.ffp",source:Be},{path:"/examples/ack.ffp",label:"ack.ffp",source:De},{path:"/examples/pi.ffp",label:"pi.ffp",source:ze},...Ne],$e=Object.fromEntries(Object.entries(Object.assign({"../../ff/lib/core/core.ff":ne,"../../ff/lib/math/ack.ffp":ee,"../../ff/lib/math/arith.ffp":te,"../../ff/lib/math/atan-core.ffp":se,"../../ff/lib/math/atan-shared.ffp":ie,"../../ff/lib/math/atan.ffp":re,"../../ff/lib/math/atanh-core.ffp":ae,"../../ff/lib/math/atanh.ffp":oe,"../../ff/lib/math/cbrt.ffp":pe,"../../ff/lib/math/exp.ffp":ce,"../../ff/lib/math/gcd.ffp":le,"../../ff/lib/math/log.ffp":ue,"../../ff/lib/math/math.ffp":de,"../../ff/lib/math/num.ffp":he,"../../ff/lib/math/pi.ffp":_e,"../../ff/lib/math/precision.ffp":fe,"../../ff/lib/math/pred.ffp":me,"../../ff/lib/math/primes.ffp":ge,"../../ff/lib/math/prn.ffp":be,"../../ff/lib/math/sqrt.ffp":ve,"../../ff/lib/math/trig.ffp":we,"../../ff/lib/prelude.ffp":ye,"../../ff/lib/seq/seq.ffp":xe,"../../ff/lib/string/char.ffp":qe,"../../ff/lib/string/str.ffp":ke,"../../ff/lib/string/string.ffp":Se,"../../ff/lib/tap.ffp":Ee,"../../ff/lib/testing.ffp":Te,"../../ff/lib/time/time.ffp":Ae,"../../ff/lib/time/utc.ffp":Pe})).map(([i,n])=>[Me(i),n])),je=Object.fromEntries(Y.map(({path:i,source:n})=>[i,n]));[...Y.map(({path:i,label:n})=>`<option value="${i}">${n}</option>`),'<option value="__custom__">Custom</option>'].join(`
`);function We(i,n="/main.ffp"){return{[n]:i,...$e,...je}}function P(i){const n=i.startsWith("/"),e=i.split("/").filter(Boolean),t=[];for(const s of e)if(s!=="."){if(s===".."){t.pop();continue}t.push(s)}return`${n?"/":""}${t.join("/")}`||(n?"/":".")}function He(i){const n=P(i),e=n.lastIndexOf("/");return e<=0?n.startsWith("/")?"/":".":n.slice(0,e)}function Ve(...i){const n=i.filter(Boolean).join("/").replaceAll(/\/+/g,"/");return P(n)}function Ke(i,n){const e=P(i).split("/").filter(Boolean),t=P(n).split("/").filter(Boolean);let s=0;for(;s<e.length&&s<t.length&&e[s]===t[s];)s++;const r=e.length-s,o=t.slice(s);return Array(r).fill("..").concat(o).join("/")||"."}function Qe(i){return{readTextFile(n){const e=P(n),t=i[e];if(typeof t!="string")throw new Error(`Virtual file not found: ${e}`);return t},fileExists(n){return typeof i[P(n)]=="string"},path:{isAbsolute(n){return n.startsWith("/")},dirname:He,relative:Ke,resolve:Ve}}}function Xe(i={}){const n=new TextDecoder,e=new TextEncoder,t=Array.from(e.encode(i.stdin??""));return{io:{write(s){var r;(r=i.onWrite)==null||r.call(i,n.decode(s))},readByte(){return t.shift()??null}},exit(s){var r;(r=i.onExit)==null||r.call(i,s)},now(){return Date.now()}}}const Ge="/lib/prelude.ffp",Ye="/main.ffp";function Ze(i){return Pn.length+i.length}function Z(i,n){const e=console.log;console.log=(...t)=>{i(t.map(String).join(" "))};try{return n()}finally{console.log=e}}async function Je(i,n){const e=console.log;console.log=(...t)=>{i(t.map(String).join(" "))};try{return await n()}finally{console.log=e}}function nt(i,n,e={}){let t="";const s=[];let r=0;const o=e.filename??Ye,c=Xe({stdin:n,onWrite(g){t+=g},onExit(g){r=g}}),p=new w,l=new V(c),u=new w,f=new V(c),m=We(i,o),d=new q(Qe(m),{engine:f,compiler:u},{macroEngineBootstrapFile:Ge});return{compiler:p,engine:l,preprocessor:d,filename:o,logs:s,getOutput(){return t},getExitCode(){return r}}}function et(i,n,e,t={}){const s=nt(i,n,t),r=performance.now(),o=Z(p=>s.logs.push(p),()=>{const p=s.preprocessor.preprocess(q.tokenize(i),s.filename);let l=s.compiler.compileToIR(w.tokenize(p),s.filename);const u=s.compiler.validate(l);e&&(l=new zn().optimize(l));const f=fn(l),m=w.compileToBase64(l),d=Ze(m);return s.engine.loadIR(l),{preprocessed:p,formattedIr:f,bytecode:m,compiledBytes:d,issues:u}}),c=performance.now();return{preprocessed:o.preprocessed,ir:o.formattedIr,bytecode:o.bytecode,compiledBytes:o.compiledBytes,issues:o.issues,compileMs:c-r,execute(){const p=performance.now();Z(u=>s.logs.push(u),()=>{s.engine.run()});const l=performance.now();return{output:s.getOutput(),stack:s.engine.getStack().map(String),logs:[...s.logs],exitCode:s.getExitCode(),executeMs:l-p,cancelled:!1,vmCyclesExecuted:0}},async executeAsync(p={}){const l=performance.now(),u=await Je(m=>s.logs.push(m),async()=>await s.engine.runAsync(p)),f=performance.now();return{output:s.getOutput(),stack:s.engine.getStack().map(String),logs:[...s.logs],exitCode:s.getExitCode(),executeMs:f-l,cancelled:u.cancelled,vmCyclesExecuted:u.vmCyclesExecuted}}}}function D(i){self.postMessage(i)}let L=!1,y=null;function tt(i,n){const e=n.cancelled?"cancelled":"done";return{output:n.output,preprocessed:i.preprocessed,ir:i.ir,bytecode:i.bytecode,compiledBytes:i.compiledBytes,issues:i.issues,stack:n.stack,logs:n.logs,exitCode:n.exitCode,compileMs:i.compileMs,executeMs:n.executeMs,terminal:e,vmCyclesExecuted:n.vmCyclesExecuted}}self.onmessage=i=>{const n=i.data;if(n.type==="CANCEL"){y===n.runId&&(L=!0);return}if(n.type!=="RUN")return;const{runId:e,source:t,stdin:s,optimize:r,filename:o,yieldIntervalMs:c,yieldSliceMax:p}=n;(async()=>{L=!1,y=e;try{const l=et(t,s,r,{filename:o});if(y!==e)return;D({type:"COMPILED",runId:e,compileMs:l.compileMs,preprocessed:l.preprocessed,ir:l.ir,bytecode:l.bytecode,compiledBytes:l.compiledBytes});const u=performance.now(),f=await l.executeAsync({yieldIntervalMs:c,yieldSliceMax:p,shouldContinue:()=>!L&&y===e,onChunk:({vmCyclesExecuted:d})=>{y===e&&D({type:"PROGRESS",runId:e,vmCyclesExecuted:d,executeElapsedMs:performance.now()-u})},scheduler:()=>new Promise(d=>{globalThis.setTimeout(d,0)})});if(y!==e)return;const m=tt(l,f);D({type:"RESULT",runId:e,result:m})}catch(l){if(y!==e)return;const u=l instanceof Error?l.message:String(l);D({type:"ERROR",runId:e,message:u})}finally{y===e&&(y=null)}})()}})();
