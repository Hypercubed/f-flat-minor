(function(){"use strict";function nn(){var n,e,t,s,r;return!!(((t=(e=(n=globalThis.Deno)==null?void 0:n.stdout)==null?void 0:e.isTerminal)==null?void 0:t.call(e))??((r=(s=globalThis.process)==null?void 0:s.stdout)==null?void 0:r.isTTY)??!1)}function D(i,n){return nn()?`\x1B[${i}m${n}\x1B[0m`:n}function en(i){return D(34,i)}function tn(i){return D(32,i)}function y(i){return D(36,i)}const o={NOP:0,CALL:1,PUTC:2,GETC:3,PUTN:5,CLOCK:6,DROP:8,PUSHR:14,PULLR:15,SHIFTL:16,SHIFTR:17,CLR:24,RAND:26,EXIT:27,DUP:33,DEPTH:35,SWAP:36,MOD:37,AND:38,STASH:40,FETCH:41,MUL:42,ADD:43,CONS:44,SUB:45,PRN:46,DIV:47,MARK:58,DEF:59,LT:60,EQ:61,GT:62,IF:63,BRA:91,KET:93,POW:94,OR:124,NOT:126},k={nop:o.NOP,eval:o.CALL,";":o.DEF,":":o.MARK,clr:o.CLR,rand:o.RAND,exit:o.EXIT,".":o.PRN,putc:o.PUTC,getc:o.GETC,putn:o.PUTN,clock:o.CLOCK,drop:o.DROP,swap:o.SWAP,dup:o.DUP,"<<":o.SHIFTL,">>":o.SHIFTR,"+":o.ADD,"-":o.SUB,cons:o.CONS,"*":o.MUL,"/":o.DIV,"<":o.LT,"=":o.EQ,">":o.GT,"?":o.IF,"%":o.MOD,"&":o.AND,"(":o.STASH,")":o.FETCH,"q<":o.PUSHR,"q>":o.PULLR,depth:o.DEPTH,"^":o.POW,"[":o.BRA,"]":o.KET,"|":o.OR,"~":o.NOT},S=255,sn=i=>i,rn=i=>i,d={call:"call",push:"push"},on=6,O=10,an=new Map([[BigInt(o.MARK),":"],[BigInt(o.DEF),";"],[BigInt(o.BRA),"["],[BigInt(o.KET),"]"]]);function pn(i){return(""+i.value).padEnd(O," ")}function cn(i,n){var e;return n?n.padEnd(O," "):i.op===d.push&&((e=i.meta)!=null&&e.pointer)?`[${i.value}]`.padEnd(O," "):pn(i)}function ln(i){return i.trim()?`/* ${i} */`:""}function un(i){var c,p,l;const n=((c=fn(i))==null?void 0:c.toUpperCase())||"",e=i.op===d.call?an.get(i.value):void 0,t=e!==void 0,s=cn(i,e),r=((l=(p=i.meta)==null?void 0:p.comment)==null?void 0:l.trim())||(i.op===d.call&&!t?n:""),a=(i.op===d.call&&!e?"EVAL":"").padEnd(on," ");return[rn(s),sn(a),ln(r)].join(" ")}function dn(i){for(const n in k)if(k[n]===i)return n;return""}function fn(i){var n,e;if(i.op===d.call||i.op===d.push&&((n=i.meta)!=null&&n.pointer))return((e=i.meta)==null?void 0:e.name)||dn(Number(i.value))||""}function hn(i){return i.map(un).join(`
...
`;function we(i){const n="../../ff/lib/";if(!i.startsWith(n))throw new Error(`Unexpected library source path: ${i}`);return`/lib/${i.slice(n.length)}`}const G=[{path:"/examples/fact.ffp",label:"fact.ffp",source:re},{path:"/examples/fizzbuzz.ffp",label:"fizzbuzz.ffp",source:oe},{path:"/examples/99bottles.ffp",label:"99bottles.ffp",source:ae},{path:"/examples/pascal.ffp",label:"pascal.ffp",source:pe},{path:"/examples/cbrt.ffp",label:"cbrt.ffp",source:ce},{path:"/examples/sqrt.ffp",label:"sqrt.ffp",source:le},{path:"/examples/gcd.ffp",label:"gcd.ffp",source:ue},{path:"/examples/ack.ffp",label:"ack.ffp",source:de},{path:"/examples/pi.ffp",label:"pi.ffp",source:fe},{path:"/examples/fib.ffp",label:"fib.ffp",source:he},{path:"/examples/catalan.ffp",label:"catalan.ffp",source:_e},{path:"/examples/collatz.ffp",label:"collatz.ffp",source:me},{path:"/examples/hanoi.ffp",label:"hanoi.ffp",source:ge},{path:"/examples/euler1.ffp",label:"euler1.ffp",source:be},{path:"/examples/euler7.ffp",label:"euler7.ffp",source:ve}],xe=Object.fromEntries(Object.entries(Object.assign({"../../ff/lib/core/core.ff":Rn,"../../ff/lib/math/ack.ffp":Dn,"../../ff/lib/math/arith.ffp":On,"../../ff/lib/math/atan-core.ffp":Ln,"../../ff/lib/math/atan.ffp":Mn,"../../ff/lib/math/cbrt.ffp":Nn,"../../ff/lib/math/exp.ffp":Fn,"../../ff/lib/math/gcd.ffp":Un,"../../ff/lib/math/log.ffp":$n,"../../ff/lib/math/math.ffp":Wn,"../../ff/lib/math/num.ffp":jn,"../../ff/lib/math/pi.ffp":Hn,"../../ff/lib/math/precision.ffp":Kn,"../../ff/lib/math/pred.ffp":Vn,"../../ff/lib/math/primes.ffp":Qn,"../../ff/lib/math/prn.ffp":Xn,"../../ff/lib/math/sqrt.ffp":Gn,"../../ff/lib/math/trig.ffp":Yn,"../../ff/lib/prelude.ffp":Jn,"../../ff/lib/seq/seq.ffp":Zn,"../../ff/lib/string/char.ffp":ne,"../../ff/lib/string/str.ffp":ee,"../../ff/lib/string/string.ffp":te,"../../ff/lib/tap.ffp":se,"../../ff/lib/testing.ffp":ie})).map(([i,n])=>[we(i),n])),ye=Object.fromEntries(G.map(({path:i,source:n})=>[i,n]));[...G.map(({path:i,label:n})=>`<option value="${i}">${n}</option>`),'<option value="__custom__">Custom</option>'].join(`
`);function qe(i,n="/main.ffp"){return{[n]:i,...xe,...ye}}function P(i){const n=i.startsWith("/"),e=i.split("/").filter(Boolean),t=[];for(const s of e)if(s!=="."){if(s===".."){t.pop();continue}t.push(s)}return`${n?"/":""}${t.join("/")}`||(n?"/":".")}function ke(i){const n=P(i),e=n.lastIndexOf("/");return e<=0?n.startsWith("/")?"/":".":n.slice(0,e)}function Se(...i){const n=i.filter(Boolean).join("/").replaceAll(/\/+/g,"/");return P(n)}function Ee(i,n){const e=P(i).split("/").filter(Boolean),t=P(n).split("/").filter(Boolean);let s=0;for(;s<e.length&&s<t.length&&e[s]===t[s];)s++;const r=e.length-s,a=t.slice(s);return Array(r).fill("..").concat(a).join("/")||"."}function Ae(i){return{readTextFile(n){const e=P(n),t=i[e];if(typeof t!="string")throw new Error(`Virtual file not found: ${e}`);return t},fileExists(n){return typeof i[P(n)]=="string"},path:{isAbsolute(n){return n.startsWith("/")},dirname:ke,relative:Ee,resolve:Se}}}function Te(i={}){const n=new TextDecoder,e=new TextEncoder,t=Array.from(e.encode(i.stdin??""));return{io:{write(s){var r;(r=i.onWrite)==null||r.call(i,n.decode(s))},readByte(){return t.shift()??null}},exit(s){var r;(r=i.onExit)==null||r.call(i,s)},now(){return Date.now()}}}const Pe="/lib/prelude.ffp";function Y(i,n){const e=console.log;console.log=(...t)=>{i(t.map(String).join(" "))};try{return n()}finally{console.log=e}}async function Ce(i,n){const e=console.log;console.log=(...t)=>{i(t.map(String).join(" "))};try{return await n()}finally{console.log=e}}function Ie(i,n){let e="";const t=[];let s=0;const r=Te({stdin:n,onWrite(m){e+=m},onExit(m){s=m}}),a=new w,c=new K(r),p=new w,l=new K(r),u=qe(i),_=new q(Ae(u),{engine:l,compiler:p},{macroEngineBootstrapFile:Pe});return{compiler:a,engine:c,preprocessor:_,logs:t,getOutput(){return e},getExitCode(){return s}}}function ze(i,n,e){const t=Ie(i,n),s=performance.now(),r=Y(c=>t.logs.push(c),()=>{const c=t.preprocessor.preprocess(q.tokenize(i),"/main.ffp");let p=t.compiler.compileToIR(w.tokenize(c),"/main.ffp");const l=t.compiler.validate(p);e&&(p=new Bn().optimize(p));const u=hn(p),_=w.compileToBase64(p);return t.engine.loadIR(p),{preprocessed:c,formattedIr:u,bytecode:_,issues:l}}),a=performance.now();return{preprocessed:r.preprocessed,ir:r.formattedIr,bytecode:r.bytecode,issues:r.issues,compileMs:a-s,execute(){const c=performance.now();Y(l=>t.logs.push(l),()=>{t.engine.run()});const p=performance.now();return{output:t.getOutput(),stack:t.engine.getStack().map(String),logs:[...t.logs],exitCode:t.getExitCode(),executeMs:p-c,cancelled:!1,vmCyclesExecuted:0}},async executeAsync(c={}){const p=performance.now(),l=await Ce(_=>t.logs.push(_),async()=>await t.engine.runAsync(c)),u=performance.now();return{output:t.getOutput(),stack:t.engine.getStack().map(String),logs:[...t.logs],exitCode:t.getExitCode(),executeMs:u-p,cancelled:l.cancelled,vmCyclesExecuted:l.vmCyclesExecuted}}}}function R(i){self.postMessage(i)}let M=!1,x=null;function Be(i,n){const e=n.cancelled?"cancelled":"done";return{output:n.output,preprocessed:i.preprocessed,ir:i.ir,bytecode:i.bytecode,issues:i.issues,stack:n.stack,logs:n.logs,exitCode:n.exitCode,compileMs:i.compileMs,executeMs:n.executeMs,terminal:e,vmCyclesExecuted:n.vmCyclesExecuted}}self.onmessage=i=>{const n=i.data;if(n.type==="CANCEL"){x===n.runId&&(M=!0);return}if(n.type!=="RUN")return;const{runId:e,source:t,stdin:s,optimize:r,yieldIntervalMs:a,yieldSliceMax:c}=n;(async()=>{M=!1,x=e;try{const p=ze(t,s,r);if(x!==e)return;R({type:"COMPILED",runId:e,compileMs:p.compileMs,preprocessed:p.preprocessed,ir:p.ir,bytecode:p.bytecode});const l=performance.now(),u=await p.executeAsync({yieldIntervalMs:a,yieldSliceMax:c,shouldContinue:()=>!M&&x===e,onChunk:({vmCyclesExecuted:m})=>{x===e&&R({type:"PROGRESS",runId:e,vmCyclesExecuted:m,executeElapsedMs:performance.now()-l})},scheduler:()=>new Promise(m=>{globalThis.setTimeout(m,0)})});if(x!==e)return;const _=Be(p,u);R({type:"RESULT",runId:e,result:_})}catch(p){if(x!==e)return;const l=p instanceof Error?p.message:String(p);R({type:"ERROR",runId:e,message:l})}finally{x===e&&(x=null)}})()}})();
