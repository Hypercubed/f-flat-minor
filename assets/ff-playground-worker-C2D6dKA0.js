(function(){"use strict";function nn(){var n,e,t,s,r;return!!(((t=(e=(n=globalThis.Deno)==null?void 0:n.stdout)==null?void 0:e.isTerminal)==null?void 0:t.call(e))??((r=(s=globalThis.process)==null?void 0:s.stdout)==null?void 0:r.isTTY)??!1)}function R(i,n){return nn()?`\x1B[${i}m${n}\x1B[0m`:n}function en(i){return R(34,i)}function tn(i){return R(32,i)}function v(i){return R(36,i)}const o={NOP:0,CALL:1,PUTC:2,GETC:3,PUTN:5,CLOCK:6,DROP:8,PUSHR:14,PULLR:15,SHIFTL:16,SHIFTR:17,CLR:24,RAND:26,EXIT:27,DUP:33,DEPTH:35,SWAP:36,MOD:37,AND:38,STASH:40,FETCH:41,MUL:42,ADD:43,CONS:44,SUB:45,PRN:46,DIV:47,MARK:58,DEF:59,LT:60,EQ:61,GT:62,IF:63,BRA:91,KET:93,POW:94,OR:124,NOT:126},q={nop:o.NOP,eval:o.CALL,";":o.DEF,":":o.MARK,clr:o.CLR,rand:o.RAND,exit:o.EXIT,".":o.PRN,putc:o.PUTC,getc:o.GETC,putn:o.PUTN,clock:o.CLOCK,drop:o.DROP,swap:o.SWAP,dup:o.DUP,"<<":o.SHIFTL,">>":o.SHIFTR,"+":o.ADD,"-":o.SUB,cons:o.CONS,"*":o.MUL,"/":o.DIV,"<":o.LT,"=":o.EQ,">":o.GT,"?":o.IF,"%":o.MOD,"&":o.AND,"(":o.STASH,")":o.FETCH,"q<":o.PUSHR,"q>":o.PULLR,depth:o.DEPTH,"^":o.POW,"[":o.BRA,"]":o.KET,"|":o.OR,"~":o.NOT},k=255,sn=i=>i,rn=i=>i,u={call:"call",push:"push"},on=6,D=10,an=new Map([[BigInt(o.MARK),":"],[BigInt(o.DEF),";"],[BigInt(o.BRA),"["],[BigInt(o.KET),"]"]]);function pn(i){return(""+i.value).padEnd(D," ")}function cn(i,n){var e;return n?n.padEnd(D," "):i.op===u.push&&((e=i.meta)!=null&&e.pointer)?`[${i.value}]`.padEnd(D," "):pn(i)}function ln(i){return i.trim()?`/* ${i} */`:""}function un(i){var c,p,l;const n=((c=fn(i))==null?void 0:c.toUpperCase())||"",e=i.op===u.call?an.get(i.value):void 0,t=e!==void 0,s=cn(i,e),r=((l=(p=i.meta)==null?void 0:p.comment)==null?void 0:l.trim())||(i.op===u.call&&!t?n:""),a=(i.op===u.call&&!e?"EVAL":"").padEnd(on," ");return[rn(s),sn(a),ln(r)].join(" ")}function dn(i){for(const n in q)if(q[n]===i)return n;return""}function fn(i){var n,e;if(i.op===u.call||i.op===u.push&&((n=i.meta)!=null&&n.pointer))return((e=i.meta)==null?void 0:e.name)||dn(Number(i.value))||""}function hn(i){return i.map(un).join(`
...
`).replace(/\\v/g,"\v").replace(/\\f/g,"\f").replace(/\\r/g,"\r").replace(/\\'/g,"'").replace(/\\"/g,'"').replace(/\\s/g," ").replace(/\\\\/g,"\\")}function L(i){let n="",e=parseInt(i,16);return e<=65535?n+=String.fromCharCode(e):e<=1114111?(e-=65536,n+=String.fromCharCode(55296|e>>10)+String.fromCharCode(56320|e&1023)):n+=`hex2Char error: Code point out of range: ${mn(e)}`,n}function mn(i){return(i+0).toString(16).toUpperCase()}const M="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",U=new Map;M.split("").forEach(function(i,n){U.set(i,n)});const F=1n<<5n,$=Number(F),W=F-1n;function gn(i){return i.map(xn).map(yn).join("")}function bn(i){return kn(qn(i)).map(En)}function vn(i){return i>=0n?i<<1n:(-i<<1n)+1n}function wn(i){return i&1n?-(i>>1n):i>>1n}function xn(i){if(i===0n)return[0];i=vn(i);const n=[];for(;i>0;){let e=Number(i&W);i>>=5n,i>0&&(e|=$),n.push(e)}return n}function yn(i){return i.map(n=>M[n]).join("")}function qn(i){return i.split("").map(n=>{const e=U.get(n);if(e===void 0)throw new Error(`${i} is not a valid base64 encoded VLQ`);return e})}function kn(i){const n=[];let e=[];if(i.forEach(t=>{e.push(t),(t&$)===0&&(n.push(e),e=[])}),e.length>0)throw new Error("Malformed VLQ sequence: The last VLQ never ended.");return n}function En(i){const n=i.reverse().reduce((e,t)=>(e<<=5n,e|=BigInt(t)&W,e),0n);return wn(n)}const Sn="/*",An="*/";function j(i){if(!(i==="-"||i==="+"))try{let n=1n;return i=i.replaceAll("_",""),i.startsWith("-0")&&(n=-1n,i=i.replace("-","")),i.includes("e")||i.includes("E")?n*BigInt(+i):n*BigInt(i)}catch{return}}class x{constructor(n={}){this.symbols=new Map,this._nextCode=-1,this.host=n;let e;for(e in q)this.symbols.set(e,BigInt(q[e]))}static tokenize(n){return n.split(/\s+/).filter(Boolean).map(e=>{const t=j(e);return t!==void 0?t:e})}static compileToBase64(n){const e=n.flatMap(t=>{if(t.op===u.call&&t.value===0n)return[];const s=t.value<<1n;return[t.op===u.push?s:s|1n]});return gn(e)}nextCode(){return BigInt(this._nextCode--)}getSymbol(n){n=n.toLowerCase();let e=this.symbols.get(n);return e===void 0&&(e=this.nextCode(),this.symbols.set(n,e)),e}compileToIR(n,e=""){var l,d,m;let t=0;const s=n.length;let r="";const a=[];for(;t<s;)if(r=n[t++],typeof r=="bigint")c(r);else if(r.length>1&&r.startsWith(".")){const[_]=r.split(" ");switch(_){case".push":a[a.length-1].op=u.push;break;case".call":a[a.length-1].op=u.call;break;case".inline":(l=a[a.length-1]).meta||(l.meta={}),a[a.length-1].meta.inline=!0;break;case".unsafe":(d=a[a.length-1]).meta||(d.meta={}),a[a.length-1].meta.unsafe=!0;break;case".pointer":(m=a[a.length-1]).meta||(m.meta={}),a[a.length-1].meta.pointer=!0;break;case".exit":if(this.host.exit){this.host.exit();break}throw new Error("Compiler: .exit requires a host exit handler");case".symbols":this.symbols.forEach((h,w)=>{(this.host.log||console.log)(w,h)});break;case".words":{const h=Array.from(this.symbols,([w])=>w).join(" ");(this.host.log||console.log)(h);break}}}else if(r[0]==="'"&&r.length>1)_n(r).replace(/^'/,"").replace(/'$/,"").split("").forEach(_=>{c(_.charCodeAt(0),{comment:_})});else if(r.endsWith(":")&&r.length>1){const _=r.replace(/:$/,"");c(this.getSymbol(_),{name:`${_}`,pointer:!0}),p(o.MARK,{name:":"})}else if(r===Sn){const _=[];for(;t<n.length&&(r=n[t++],r!==An);)_.push(r);p(0n,{comment:_.join(" ")})}else if(r.startsWith("[")&&r.endsWith("]")){const _=r.replace(/^\[/,"").replace(/\]$/,""),h=j(_);h!==void 0?c(h,{name:_,pointer:!0}):c(this.getSymbol(_),{name:_,pointer:!0})}else p(this.getSymbol(r),{name:r});return a;function c(_,h={}){a.push({value:BigInt(_),op:u.push,meta:{...h,filename:e}})}function p(_,h={}){a.push({value:BigInt(_),op:u.call,meta:{...h,filename:e}})}}validate(n){var r,a;const e=n.slice(),t=[];let s=0;for(;s<e.length;){const c=e[s];if(c.op===u.call&&c.value===BigInt(o.DEF)){let p=0;for(p=s;p>0&&!(e[p].op===u.call&&e[p].value===BigInt(o.MARK));p--);const l=e.splice(p-1,s-p+2);(a=(r=l.at(-1))==null?void 0:r.meta)!=null&&a.unsafe||t.push(...this.validateDef(l)),s=p-1}s++}return t.push(...this.validateDef(e,"main")),t}validateDef(n,e){var d,m,_;const t=[];let s=0,r=0,a=0,c=0;const p=[0];if(!n[0])return[];e=tn(e||((m=(d=n[0].meta)==null?void 0:d.name)==null?void 0:m.replace(/^&/,""))||"main");const l=en(((_=n[0].meta)==null?void 0:_.filename)||"-");for(;s<n.length;){const h=n[s];if(h.op===u.call){if(h.op===u.call&&h.value===BigInt(o.MARK)&&r++,h.op===u.call&&h.value===BigInt(o.DEF)&&r--,h.op===u.call&&h.value===BigInt(o.BRA)&&(a++,p.push(0)),h.op===u.call&&h.value===BigInt(o.KET)&&(a--,(p.length>1?p.pop():0)!==0&&t.push(`${l}: Unbalanced queue push ( ${v("q< q>")} ) in quote in ${e}`)),h.op===u.call&&(h.value===BigInt(o.PUSHR)||h.value===BigInt(o.STASH))&&(c++,p[p.length-1]++),h.op===u.call&&(h.value===BigInt(o.PULLR)||h.value===BigInt(o.FETCH))){if(p[p.length-1]===0){const N=h.value===BigInt(o.FETCH)?")":"q>";t.push(`${l}: Queue borrow ( ${v(N)} ) requires ${v(".unsafe")} in ${e} (including quotes)`)}c--,p[p.length-1]--}a<0&&t.push(`${l}: Bracket ( ${v("[ ]")} ) mismatch in ${e}`),r<0&&t.push(`${l}: Definition ( ${v(": ;")} ) mismatch in ${e}`)}s++}return a!==0&&t.push(`${l}: Unbalanced brackets ( ${v("[ ]")} ) in ${e}`),c!==0&&t.push(`${l}: Unbalanced queue push ( ${v("q< q> ( )")} ) in ${e}`),r!==0&&t.push(`${l}: Unbalanced definition ( ${v(": ;")} ) in ${e}`),t}}var Tn={words:[{mnemonic:"NOP",syntax:"nop",stackEffect:"… nop == …",description:"No operation; does nothing.",opcode:0},{mnemonic:"EVAL",syntax:"eval",stackEffect:"[A] eval == a*",description:"Evaluates a quotation, executing its contents.",opcode:1},{mnemonic:"PUTC",syntax:"putc",stackEffect:"n putc == {prints char(n)}",description:"Prints a character given by its numeric code.",opcode:2},{mnemonic:"GETC",syntax:"getc",stackEffect:"getc == n {reads char}",description:"Reads a single character from input and pushes its code.",opcode:3},{mnemonic:"PUTN",syntax:"putn",stackEffect:"n putn == {prints n}",description:"Prints a number to output.",opcode:5},{mnemonic:"CLOCK",syntax:"clock",stackEffect:"clock == n {reads clock}",description:"Returns the current time as a Unix timestamp.",opcode:6},{mnemonic:"DROP",syntax:"drop",stackEffect:"a drop ==",description:"Removes the top value from the stack.",opcode:8},{mnemonic:"PUSHR",syntax:"q<",stackEffect:"a q< == | …a",description:"Pushes a value onto the return stack.",opcode:14},{mnemonic:"PULLR",syntax:"q>",stackEffect:"q> == a | a…",description:"Pops a value from the return stack onto the main stack.",opcode:15},{mnemonic:"SHIFTL",syntax:"<<",stackEffect:"a b << == n",description:"Left-shifts a by b bits.",opcode:16},{mnemonic:"SHIFTR",syntax:">>",stackEffect:"a b >> == n",description:"Right-shifts a by b bits.",opcode:17},{mnemonic:"CLR",syntax:"clr",stackEffect:"… clr ==",description:"Clears the entire stack.",opcode:24},{mnemonic:"RAND",syntax:"rand",stackEffect:"n rand == r {0 <= r < n}",description:"Generates a random number between 0 and n-1.",opcode:26},{mnemonic:"EXIT",syntax:"exit",stackEffect:"n exit == {exits with code n}",description:"Exits the program with the given exit code.",opcode:27},{mnemonic:"DUP",syntax:"dup",stackEffect:"a dup == a a",description:"Duplicates the top value on the stack.",opcode:33},{mnemonic:"DEPTH",syntax:"depth",stackEffect:"… depth == … n",description:"Pushes the current stack depth.",opcode:35},{mnemonic:"SWAP",syntax:"swap",stackEffect:"a b swap == b a",description:"Swaps the top two values on the stack.",opcode:36},{mnemonic:"MOD",syntax:"%",stackEffect:"a b % == n",description:"Computes the remainder of a divided by b.",opcode:37},{mnemonic:"AND",syntax:"&",stackEffect:"a b & == n",description:"Bitwise AND of a and b.",opcode:38},{mnemonic:"STASH",syntax:"(",stackEffect:"… ( == {moves stack to queue}",description:"Moves values from the stack to the queue.",opcode:40},{mnemonic:"FETCH",syntax:")",stackEffect:") == … {restores stack from queue}",description:"Moves values from the queue back to the stack.",opcode:41},{mnemonic:"MUL",syntax:"*",stackEffect:"a b * == n",description:"Multiplies a by b.",opcode:42},{mnemonic:"ADD",syntax:"+",stackEffect:"a b + == n",description:"Adds a and b together.",opcode:43},{mnemonic:"SUB",syntax:"-",stackEffect:"a b - == n",description:"Subtracts b from a.",opcode:45},{mnemonic:"DUMP",syntax:".",stackEffect:"… . == … {prints stack}",description:"Prints the entire stack to output.",opcode:46},{mnemonic:"DIV",syntax:"/",stackEffect:"a b / == n",description:"Divides a by b (integer division).",opcode:47},{mnemonic:"MARK",syntax:":",stackEffect:"n : == {begin definition(n)}",description:"Begins a new word definition with name n.",opcode:58},{mnemonic:"DEF",syntax:";",stackEffect:"; == {end definition}",description:"Ends the current word definition.",opcode:59},{mnemonic:"LT",syntax:"<",stackEffect:"a b < == flag",description:"Pushes true if a is less than b.",opcode:60},{mnemonic:"EQ",syntax:"=",stackEffect:"a b = == flag",description:"Pushes true if a equals b.",opcode:61},{mnemonic:"GT",syntax:">",stackEffect:"a b > == flag",description:"Pushes true if a is greater than b.",opcode:62},{mnemonic:"WHEN",syntax:"?",stackEffect:"flag [A] ? == a*",description:"Executes the quotation if flag is true.",opcode:63},{mnemonic:"BRA",syntax:"[",stackEffect:"[ == {begin quotation}",description:"Begins a quotation (anonymous code block).",opcode:91},{mnemonic:"KET",syntax:"]",stackEffect:"] == [A] {end quotation}",description:"Ends a quotation and pushes it to the stack.",opcode:93},{mnemonic:"POW",syntax:"^",stackEffect:"a b ^ == n",description:"Computes a raised to the power of b.",opcode:94},{mnemonic:"OR",syntax:"|",stackEffect:"a b | == n",description:"Bitwise OR of a and b.",opcode:124},{mnemonic:"NOT",syntax:"~",stackEffect:"a ~ == n'",description:"Bitwise NOT of a.",opcode:126}]};const H=new Map;for(const i of Tn.words)H.set(i.opcode,i);function Pn(i){return H.get(i)}const Cn=[BigInt(o.DEF),BigInt(o.KET),BigInt(o.MARK),BigInt(o.BRA)],E=0n,S=1n;class K{constructor(n){this.stack=[],this.queue=[],this.defs=new Map,this.symbols=new Map,this.depth=0,this.nextAnonOp=k+1,this.traceOn=!1,this.traceFormat="human",this.traceVerbose=!1,this.traceQueueMax=8,this.traceStackMax=32,this.base=10,this.statsOn=!1,this.profileOn=!1,this.stats={system_instructions_called:0,user_instructions_called:0,max_stack_depth:0,max_queue_depth:0},this.profile={},this.platform=n,this.setup()}static fromBase64(n){return bn(n).flatMap(e=>{const t=e&1n,s=e>>1n;return[t,s]})}getStack(){return this.stack.slice()}peek(){const n=this.stack.length;if(n>0)return this.stack[n-1];throw new Error("Peek: stack underflow")}pop(){if(this.stack.length>0)return this.stack.pop();throw new Error("Pop: stack underflow")}push(n){this.stack.push(n)}poke(n){const e=this.stack.length;if(e>0){this.stack[e-1]=n;return}throw new Error("Poke: stack underflow")}clear(){this.stack.splice(0,this.stack.length)}queuePush(n,e){this.queue.push(n,e)}queueUnshift(n,e){this.queue.unshift(n,e)}queueShift(){return[this.queue.shift()??0n,this.queue.shift()??0n]}queuePop(){const n=this.queue.pop()??0n;return[this.queue.pop()??0n,n]}defineSystem(n,e){const t=BigInt(e),s=this.getName(t);if(this.defs.has(t))throw new Error(`Define: cannot redefine system word "${s}"`);this.defs.set(t,n)}defineUser(n,e){const t=this.getName(e);if(e>-1&&e<k)throw new Error(`Define: cannot define system op "${t}"`);if(this.defs.has(e))throw e>k?new Error(`Define: cannot redefine anon op "${t}"`):new Error(`Define: cannot redefine user op "${t}"`);this.defs.set(e,n)}callSystem(n){var s;const e=this.defs.get(n);if(typeof e=="function"){if(this.statsOn&&this.stats.system_instructions_called++,this.profileOn){const r=performance.now();e();const a=performance.now(),c=this.getName(n)||Number(n);(s=this.profile)[c]||(s[c]=[0,0]),this.profile[c][0]++,this.profile[c][1]!=0,this.profile[c][1]+=a-r;return}return e()}const t=this.getName(n)||n;throw new Error(`Call: undefined system op "${t}"`)}callUser(n){var s;const e=this.defs.get(n);if(Array.isArray(e)){if(this.statsOn&&this.stats.user_instructions_called++,this.queue.unshift(...e),this.profileOn){const r=this.getName(n,`&${n}`);(s=this.profile)[r]||(s[r]=[0,void 0]),this.profile[r][0]++}return}const t=this.getName(n)||n;throw new Error(`Call: undefined user op "${t}"`)}callOp(n){return n>-1n&&n<k?this.callSystem(n):this.callUser(n)}loadBigIntCode(n){this.queue.push(...n)}loadIR(n){var t,s;let e=0;for(;e<n.length;){const r=n[e++];if(r.op===u.call){if(r.value===0n)continue;(t=r.meta)!=null&&t.name&&!this.symbols.has(r.value)&&this.symbols.set(r.value,(s=r.meta)==null?void 0:s.name),this.queuePush(S,r.value)}else this.queuePush(E,r.value)}return this.stack}runChunk(n,e){const t=this.queue;let s=!1,r=e,a=0;for(;t.length>0&&a<n;){const[c,p]=this.queueShift(),l=c===S,d=this.stack.slice();s=!this.depth||l&&Cn.includes(p),l?s?this.callOp(p):(this.push(c),this.push(p)):(s||this.push(c),this.push(p)),this.statsOn&&(this.stats.max_stack_depth=Math.max(this.stats.max_stack_depth,this.stack.length),this.stats.max_queue_depth=Math.max(this.stats.max_queue_depth,t.length/2));const m=r++;this.traceOn&&this.trace({step:m,immediate:s,tag:c,value:p,stackBefore:d,stackAfter:this.traceVerbose||this.traceFormat==="jsonl"?this.stack.slice():void 0}),a++}return r}run(){return this.runChunk(Number.POSITIVE_INFINITY,0),this.stack}async runAsync(n={}){var c;const e=n.yieldEvery??2048;if(!Number.isFinite(e)||e<1)throw new Error(`runAsync: yieldEvery must be a positive finite number (received ${e})`);const t=n.scheduler??(()=>new Promise(p=>{globalThis.setTimeout(p,0)}));let s=0,r=0,a=!1;for(;this.queue.length>0;){const p=s;if(s=this.runChunk(e,s),r+=s-p,this.queue.length>0){if((c=n.onChunk)==null||c.call(n,{vmCyclesExecuted:r}),n.shouldContinue&&!n.shouldContinue()){a=!0;break}await t()}}return{stack:this.stack.slice(),cancelled:a,vmCyclesExecuted:r}}trace({step:n,immediate:e,tag:t,value:s,stackBefore:r,stackAfter:a}){const c=this.createTraceEvent(n,e,t,s,r,a);if(this.traceFormat==="jsonl"){this.writeTraceLine(JSON.stringify(c));return}this.writeTraceLine(this.formatHumanTrace(c))}createTraceEvent(n,e,t,s,r,a){const c=t===S,p=c?this.getName(s,String(s)):String(s),l=this.getQueuePreview();return{step:n,immediate:e,tag:c?"call":"literal",value:String(s),action:p,stack_before:this.limitStack(r).map(String),stack_after:a?this.limitStack(a).map(String):void 0,queue_preview:l,queue_depth:this.queue.length/2}}limitStack(n){return n.length>this.traceStackMax?n.slice(-this.traceStackMax):n}getQueuePreview(){const n=[],e=Math.max(this.traceQueueMax,0);for(let t=0;t<this.queue.length&&n.length<e;t+=2){const s=this.queue[t]??0n,r=this.queue[t+1]??0n,a=s===S;n.push({tag:a?"call":"literal",value:String(r),action:a?this.getName(r,String(r)):String(r)})}return n}formatHumanTrace(n){const e=this.padHumanAction(n.action),t=this.formatHumanStack(n.stack_before),s=this.formatHumanQueue(n.queue_preview,n.queue_depth),r=this.layoutHumanTraceLine(n.step,t,e,s);if(this.traceVerbose){const a=this.formatHumanStack(n.stack_after??[]);return`${r}
${" ".repeat(String(n.step).length+1)}${a} | immediate=${n.immediate} tag=${n.tag} value=${n.value} stack_depth=${this.stack.length} queue_depth=${n.queue_depth}`}return r}padHumanAction(n){return n.length>=7?n:n.padStart(Math.floor((7+n.length)/2)," ").padEnd(7," ")}layoutHumanTraceLine(n,e,t,s){const r=this.getTraceTerminalWidth(),a=`${n} `;if(a.length>=r)return a.slice(0,r);const c=1,p=Math.min(t.length,Math.max(r-a.length-c*2,1)),l=Math.max(a.length+c,Math.floor((r-p)/2)),d=Math.min(l,Math.max(a.length+c,r-p-c)),m=d+p,_=a.length,h=Math.max(_,d-c),w=Math.min(r,m+c),N=r,J=Math.max(h-_,0),Z=Math.max(N-w,0),C=Array.from({length:r},()=>" ");if(this.writeSegment(C,0,a,a.length),this.writeSegment(C,d,t,p),J>0){const P=this.truncateLeft(e,J);this.writeSegment(C,h-P.length,P,P.length)}if(Z>0){const P=this.truncateRight(s,Z);this.writeSegment(C,w,P,P.length)}return C.join("").replace(/\s+$/,"")}formatHumanStack(n){return n.length===0?"[ ]":`[ ${n.join(" ")} ]`}formatHumanQueue(n,e){const t=n.map(r=>r.tag==="call"?`&${r.action}`:r.value),s=Math.max(e-n.length,0);return s>0&&t.push(`…(+${s})`),t.length===0?"[ ]":`[ ${t.join(" ")} ]`}getTraceTerminalWidth(){var a,c,p,l,d,m,_;const e=globalThis.Deno,t=(c=(a=e==null?void 0:e.stderr)==null?void 0:a.isTerminal)!=null&&c.call(a)&&typeof e.stderr.rid=="number"?e.stderr.rid:(l=(p=e==null?void 0:e.stdout)==null?void 0:p.isTerminal)!=null&&l.call(p)&&typeof e.stdout.rid=="number"?e.stdout.rid:void 0;if(typeof t=="number")try{const h=(d=e==null?void 0:e.consoleSize)==null?void 0:d.call(e,t).columns;if(typeof h=="number"&&h>0)return h}catch{}const s=globalThis.process,r=(m=s==null?void 0:s.stderr)!=null&&m.isTTY&&typeof s.stderr.columns=="number"?s.stderr.columns:(_=s==null?void 0:s.stdout)!=null&&_.isTTY&&typeof s.stdout.columns=="number"?s.stdout.columns:void 0;return typeof r=="number"&&r>0?r:120}truncateLeft(n,e){return e<=0?"":n.length<=e?n:e===1?"…":`…${n.slice(-(e-1))}`}truncateRight(n,e){return e<=0?"":n.length<=e?n:e===1?"…":`${n.slice(0,e-1)}…`}writeSegment(n,e,t,s){if(!(s<=0))for(let r=0;r<s&&r<t.length&&e+r<n.length;r++)n[e+r]=t[r]}writeTraceLine(n){const e=new TextEncoder().encode(`${n}
`);if(this.platform.io.writeError){this.platform.io.writeError(e);return}this.platform.io.write(e)}getName(n,e=String(n)){return this.symbols.has(n)?this.symbols.get(n):String(e)}inspectValue(n){const e=this.symbols.get(n),t=n>=0n&&n<=BigInt(k),s=this.defs.get(n),r=s!==void 0;let a;Array.isArray(s)&&(a=this.parseDefinitionTokens(s));let c,p;if(t){const l=Pn(Number(n));l&&(c=l.stackEffect,p=l.description)}return{value:n,name:e,isSystem:t,isDefined:r,definition:a,stackEffect:c,description:p}}parseDefinitionTokens(n){const e=[];for(let t=0;t<n.length;t+=2){const s=n[t]??0n,r=n[t+1]??0n,a=s===S,c=a?this.symbols.get(r):void 0,p=this.defs.has(r);e.push({value:r,tag:s,name:c,isCall:a,isDefined:p})}return e}print(){const n=this.stack.map(e=>e.toString(this.base)).join(" ");this.platform.io.write(new TextEncoder().encode(`[ ${n} ]
`))}loadSourceMap(n){Object.keys(n.symbols).forEach(e=>{this.symbols.set(BigInt(e),n.symbols[e])})}getNextAnonOp(){let n=this.nextAnonOp++;for(;this.defs.has(BigInt(n));)n=this.nextAnonOp++;return BigInt(n)}setup(){const n=new TextEncoder;let e;for(e in q)this.symbols.set(BigInt(q[e]),e);this.defineSystem(()=>{},o.NOP),this.defineSystem(()=>{const t=this.pop();this.callOp(t)},o.CALL),this.defineSystem(()=>{this.depth--;const[,t]=this.queuePop(),s=this.stack.splice(Number(t||0))||[];this.defineUser(s,this.pop())},o.DEF),this.defineSystem(()=>{this.depth--;const[,t]=this.queuePop(),s=this.stack.splice(Number(t||0))||[],r=this.getNextAnonOp();this.defineUser(s,r),this.depth>0&&this.push(0n),this.push(r)},o.KET),this.defineSystem(()=>{this.depth++;const t=this.stack.length;this.queuePush(E,BigInt(t))},o.BRA),this.defineSystem(()=>{this.depth++;const t=this.stack.length;this.queuePush(E,BigInt(t))},o.MARK),this.defineSystem(()=>this.clear(),o.CLR),this.defineSystem(()=>{const t=this.pop();this.platform.exit(Number(t))},o.EXIT),this.defineSystem(()=>{const t=this.pop();this.push(zn(t))},o.RAND),this.defineSystem(()=>{this.print()},o.PRN),this.defineSystem(()=>{this.push(BigInt(this.platform.now()))},o.CLOCK),this.defineSystem(()=>{const t=n.encode(String.fromCharCode(Number(this.pop())));this.platform.io.write(t)},o.PUTC),this.defineSystem(()=>{this.platform.io.setRaw&&this.platform.io.setRaw(!0);const t=this.platform.io.readByte();this.platform.io.setRaw&&this.platform.io.setRaw(!1),this.push(BigInt(t??0))},o.GETC),this.defineSystem(()=>{const t=n.encode(this.pop().toString(this.base));this.platform.io.write(t)},o.PUTN),this.defineSystem(()=>{this.pop()},o.DROP),this.defineSystem(()=>{const t=this.peek(),s=this.stack[this.stack.length-2];this.stack[this.stack.length-2]=t,this.poke(s)},o.SWAP),this.defineSystem(()=>{this.push(this.peek())},o.DUP),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]+=t},o.ADD),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]-=t},o.SUB),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]*=t},o.MUL),this.defineSystem(()=>{const t=this.pop();if(t===0n)throw new Error("DIV: Division by zero");this.stack[this.stack.length-1]/=t},o.DIV),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]%=t},o.MOD),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]<<=t},o.SHIFTL),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]>>=t},o.SHIFTR),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]&=t},o.AND),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]**=t},o.POW),this.defineSystem(()=>{this.push(this.pop()>this.pop()?1n:0n)},o.LT),this.defineSystem(()=>{this.push(this.pop()===this.pop()?1n:0n)},o.EQ),this.defineSystem(()=>{this.push(this.pop()<this.pop()?1n:0n)},o.GT),this.defineSystem(()=>{const t=this.pop();this.pop()!==0n&&this.queueUnshift(S,t)},o.IF),this.defineSystem(()=>{this.queuePush(E,this.pop())},o.PUSHR),this.defineSystem(()=>{const[,t]=this.queuePop();this.push(t)},o.PULLR),this.defineSystem(()=>{this.push(BigInt(this.stack.length))},o.DEPTH),this.defineSystem(()=>{const t=this.stack.length;this.stack.splice(0,t).forEach(r=>this.queuePush(E,r)),this.queuePush(E,BigInt(t))},o.STASH),this.defineSystem(()=>{const[,t]=this.queuePop(),s=Number(t),r=[];for(let a=0;a<s;a++){const[,c]=this.queuePop();r.unshift(c)}this.stack.unshift(...r)},o.FETCH),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]|=t},o.OR),this.defineSystem(()=>{const t=this.pop();this.push(~t)},o.NOT),this.defineSystem(()=>{const t=this.pop(),r=[0n,this.pop(),1n,t],a=this.getNextAnonOp();this.defineUser(r,a),this.depth>0&&this.push(0n),this.push(a)},o.CONS)}printProfile(){console.log(),console.log("Profile:");const n=Object.keys(this.profile).map(s=>{const r=this.profile[s][0],a=this.profile[s][1];return{name:s,calls:r,time:a,system:typeof a<"u","ops/ms":a?Math.round(r/a):""}}).sort((s,r)=>r.calls-s.calls),e=n.filter(s=>s.system),t=n.filter(s=>!s.system);console.table(e,["name","calls","ops/ms"]),console.table(t,["name","calls"]),console.log()}printStats(){console.log(),console.log("Interpreter stats:"),console.log(this.stats),console.log()}}function zn(i){const n=i,e=n.toString().length;let t="";for(;t.length<e;)t+=Math.random().toString().split(".")[1];t=t.slice(0,e);const s="1"+"0".repeat(e);return n*BigInt(t)/BigInt(s)}const z=BigInt(o.DEF),V=BigInt(o.KET),I=BigInt(o.MARK),Q=BigInt(o.BRA),f=i=>(i=BigInt(i),n=>n.op===u.call&&n.value===i),A=i=>(i=BigInt(i),n=>n.op===u.push&&n.value===i),g=i=>i.op===u.push,G=i=>i.op===u.push&&i.value!==0n,In=[{name:"No operation",pattern:[f(o.NOP)],replacement:()=>[]},{name:"Null Sequence - SWAP SWAP",pattern:[f(o.SWAP),f(o.SWAP)],replacement:()=>[]},{name:"Null Sequence - DUP DROP",pattern:[f(o.DUP),f(o.DROP)],replacement:()=>[]},{name:"Null Sequence - PUSHR PULLR",pattern:[f(o.PUSHR),f(o.PULLR)],replacement:()=>[]},{name:"Null Sequence - CLOCK DROP",pattern:[f(o.CLOCK),f(o.DROP)],replacement:()=>[]},{name:"Null Sequence - RAND DROP",pattern:[f(o.RAND),f(o.DROP)],replacement:()=>[]},{name:"Null Sequence - DEPTH DROP",pattern:[f(o.DEPTH),f(o.DROP)],replacement:()=>[]},{name:"Null Sequence - NOT NOT",pattern:[f(o.NOT),f(o.NOT)],replacement:()=>[]},{name:"Indirect calls - n EVAL",pattern:[g,f(o.CALL)],replacement:i=>{var n,e;return[{op:u.call,value:i.value,meta:{name:(e=(n=i.meta)==null?void 0:n.name)==null?void 0:e.replace(/^&/,"")}}]}},{name:"Null Sequence - n DROP",pattern:[g,f(o.DROP)],replacement:()=>[]},{name:"Constant Folding - a b ADD",pattern:[g,g,f(o.ADD)],replacement:(i,n)=>[{op:u.push,value:i.value+n.value}]},{name:"Algebraic Simplification - 0 ADD",pattern:[A(0),f(o.ADD)],replacement:()=>[]},{name:"Algebraic Simplification - swap ADD",pattern:[f(o.SWAP),f(o.ADD)],replacement:(i,n)=>[n]},{name:"Constant Folding - a b SUB",pattern:[g,g,f(o.SUB)],replacement:(i,n)=>[{op:u.push,value:i.value-n.value}]},{name:"Algebraic Simplification - 0 SUB",pattern:[A(0),f(o.SUB)],replacement:()=>[]},{name:"Constant Folding - a b MUL",pattern:[g,g,f(o.MUL)],replacement:(i,n)=>[{op:u.push,value:i.value*n.value}]},{name:"Algebraic Simplification - 1 MUL",pattern:[A(1),f(o.MUL)],replacement:()=>[]},{name:"Algebraic Simplification - swap MUL",pattern:[f(o.SWAP),f(o.MUL)],replacement:(i,n)=>[n]},{name:"Constant Folding - a b DIV",pattern:[g,G,f(o.DIV)],replacement:(i,n)=>[{op:u.push,value:i.value/n.value}]},{name:"Algebraic Simplification - 1 DIV",pattern:[A(1),f(o.DIV)],replacement:()=>[]},{name:"Constant propagation - a DUP",pattern:[g,f(o.DUP)],replacement:i=>[i,i]},{name:"Unreachable Code - 0 &b IF",pattern:[A(0),g,f(o.IF)],replacement:()=>[]},{name:"Flows-Of-Control Optimizations - !0 &b IF",pattern:[G,g,f(o.IF)],replacement:(i,n,e)=>{var t,s;return[{op:u.call,value:n.value,meta:{name:(s=(t=n.meta)==null?void 0:t.name)==null?void 0:s.replace(/^&/,"")}}]}},{name:"Null Sequence - 0 eval",pattern:[A(0),f(o.CALL)],replacement:()=>[]},{name:"Empty List - [ ]",pattern:[f(o.BRA),f(o.KET)],replacement:()=>[{op:u.push,value:0n,meta:{pointer:!0,name:"0"}}]},{name:"a q< b a> - b a",pattern:[g,f(o.PUSHR),g,f(o.PULLR)],replacement:(i,n,e)=>[e,i]}];class Bn{constructor(){this.stats={pre_optimization_ir_size:0,post_optimization_ir_size:0,user_defined_anon_defs:0,user_defined_named_defs:0,post_optimization_user_defs:0,inlined_calls:0,peephole_optimizations:0,optimization_passes:0},this.minOptPasses=2,this.maxOptPasses=20,this.defs=new Map,this.calledWords=new Set,this.optimized=[],this.nextAnonOp=k+1}optimize(n){this.reset(),this.stats.pre_optimization_ir_size=n.length,this.optimized=n;let e;do e=this.optimized.length,this.optLoop();while((this.optimized.length<e||this.stats.optimization_passes<this.minOptPasses)&&this.stats.optimization_passes<this.maxOptPasses);return this.optimized=this.pullDefs(this.optimized),this.optimized=this.addReferencedWords(this.optimized),this.stats.post_optimization_ir_size=this.optimized.length,this.optimized}optLoop(){this.optimized=this.peepholeOptimization(this.optimized),this.optimized=this.getDefs(this.optimized),this.optimized=this.inlineWords(this.optimized,4),this.stats.optimization_passes++}reset(){this.optimized=[],this.defs=new Map,this.calledWords=new Set,this.stats={pre_optimization_ir_size:0,post_optimization_ir_size:0,user_defined_anon_defs:0,user_defined_named_defs:0,post_optimization_user_defs:0,inlined_calls:0,peephole_optimizations:0,optimization_passes:0}}getDefs(n){var t;let e=0;for(;e<n.length;){const s=n[e];if(s.op===u.call){if(s.value===V){this.stats.optimization_passes===0&&this.stats.user_defined_anon_defs++,s.meta??(s.meta={}),(t=s.meta).uid??(t.uid=this.nextAnonOp++);let r=e;for(;r-- >0;){const l=n[r];if(l.op===u.call&&l.value===Q)break}const a=BigInt(s.meta.uid),c={op:u.push,value:a,meta:{pointer:!0}},p=n.slice(r,e+1);p.unshift(c),p[1]={...p[1],value:I,meta:{...p[1].meta,name:":"}},p[p.length-1]={...p[p.length-1],value:z,meta:{...p[p.length-1].meta,name:";"}},this.defs.set(a,p)}else if(s.value===z){this.stats.optimization_passes===0&&this.stats.user_defined_named_defs++;let r=e;for(;r-- >0;){const p=n[r];if(p.op===u.call&&p.value===I)break}const a=n[r-1];a.meta||(a.meta={}),a.meta.pointer=!0;const c=n.slice(r-1,e+1);this.defs.set(a.value,c)}}e++}return n}pullDefs(n,e=!1){var r;const t=n.slice();let s=0;for(;s<t.length;){const a=t[s];if(a.op===u.call){if(a.value===V){a.meta??(a.meta={}),(r=a.meta).uid??(r.uid=this.nextAnonOp++);const c=s;for(;s-- >0;){const m=t[s];if(m.op===u.call&&m.value===Q)break}const p=BigInt(a.meta.uid),l={op:u.push,value:p,meta:{pointer:!0}},d=t.splice(s,c-s+1,l);d.unshift(l),d[1]={...d[1],value:I,meta:{...d[1].meta,name:":"}},d[d.length-1]={...d[d.length-1],value:z,meta:{...d[d.length-1].meta,name:";"}},this.defs.set(p,d)}else if(a.value===z&&!e){const c=s;for(;s-- >0;){const d=t[s];if(d.op===u.call&&d.value===I)break}const p=t[s-1];p.meta||(p.meta={}),p.meta.pointer=!0;const l=t.splice(s-1,c-s+2);s=s-2,this.defs.set(l[0].value,l)}}s++}return t}peepholeOptimization(n){const e=n.slice();for(;;){const t=this.stats.peephole_optimizations;let s=0;for(;s<e.length;){for(const r of In){const{pattern:a,replacement:c}=r;if(s+a.length>e.length)continue;if(a.every((l,d)=>l(e[s+d]))){this.stats.peephole_optimizations++;const l=e.slice(s,s+a.length);e.splice(s,a.length,...c(...l)),s=Math.max(0,s-a.length-1);break}}s++}if(this.stats.peephole_optimizations===t)break}return e}inlineWords(n,e=1,t=[]){return n.flatMap(s=>{var r,a,c,p;if((r=s.meta)!=null&&r.unsafe)return s;if(s.op===u.call&&this.defs.has(s.value)){if(t.includes(s.value))return s;const l=this.defs.get(s.value);if(!l)return s;const d=l[l.length-1];if((a=d.meta)!=null&&a.unsafe)return s;if((c=d.meta)!=null&&c.inline||(p=s.meta)!=null&&p.inline)return this.stats.inlined_calls++,this.inlineWords(l.slice(2,-1),1/0,t.concat(s.value));if(l.length<=e+3)return this.stats.inlined_calls++,this.inlineWords(l.slice(2,-1),e,t.concat(s.value))}return s})}addReferencedWords(n){return n.slice().forEach(e=>{var t;e.op===u.push&&((t=e.meta)!=null&&t.pointer)?this.addDef(e.value):e.op===u.call&&this.addDef(e.value)}),n}addDef(n){if(!this.calledWords.has(n)){const e=this.defs.get(n);if(e)return this.stats.post_optimization_user_defs++,this.calledWords.add(n),this.optimized.unshift(...e),this.addReferencedWords(e)}}}class y{constructor(n,e,t){this.imported=new Set,this.importPrefixes=new Map,this.macroPreludeReady=!1,this.rootFilename=null,this.host=n,this.engine=e.engine,this.compiler=e.compiler||new x,t!=null&&t.macroEngineBootstrapFile&&this.bootstrapMacroEngine(t.macroEngineBootstrapFile)}static tokenize(n){return n.split(/[\r\n]+/)}preprocess(n,e="-"){const t=this.rootFilename===null;t&&e!=="-"&&(this.rootFilename=e);try{return this.preprocessLines(n,e)}finally{t&&(this.rootFilename=null)}}preprocessLines(n,e,t){return n.map(s=>{if(s.length>1&&s[0]==="."){const[r,...a]=s.split(" ");if(r[0]==="."&&r.length>1){switch(r){case".exit":if(this.host.exit){this.host.exit();break}throw new Error("Preprocessor: .exit requires a host exit handler");case".load":{const c=this.findFile(a.join(" "),e),p=this.host.readTextFile(c);return this.preprocessLines(y.tokenize(p),c)}case".import":{const c=this.findFile(a.join(" "),e);if(!this.imported.has(c)){this.imported.add(c);const p=this.host.readTextFile(c);return this.preprocessLines(y.tokenize(p),c,c)}return""}case".m":return this.runMacro(a.join(" "),s);case".ff":return this.runMacro(a.join(" "),s);case".ffp":{if(!this.macroPreludeReady)throw new Error("Preprocessor: .ffp requires prelude-enabled macro context");return this.runMacro(a.join(" "),s)}}return""}}return t?this.mangleImportedLine(s,t):s}).join(`
`)}findFile(n,e="-"){if(e&&e!=="-"&&!this.host.path.isAbsolute(n)){const t=this.host.path.dirname(e),s=this.host.path.resolve(t,n);if(this.host.fileExists(s))return s}if(this.host.fileExists(n))return n;throw'File not found: "'+n+'"'}bootstrapMacroEngine(n){const e=this.findFile(n),t=this.host.readTextFile(e),r=new y(this.host,{engine:this.engine,compiler:this.compiler}).preprocess(y.tokenize(t),e),a=this.compiler.compileToIR(x.tokenize(r),e);this.engine.loadIR(a),this.engine.run(),this.engine.clear(),this.macroPreludeReady=!0}runMacro(n,e){const t=this.compiler.compileToIR(x.tokenize(n));this.engine.loadIR(t),this.engine.run();const s=this.engine.getStack();return this.engine.clear(),s.map(String).join(" ")+` /* ${e} */`}mangleImportedLine(n,e){const t=this.getImportPrefix(e);return n.split(/(\s+)/).map(s=>!s||/\s+/.test(s)?s:this.mangleImportedToken(s,t)).join("")}mangleImportedToken(n,e){return n.startsWith("[__")?`[${e}${n.slice(3)}`:n.startsWith("__")?`${e}${n.slice(2)}`:n}getImportPrefix(n){const e=this.importPrefixes.get(n);if(e)return e;const s=this.getNormalizedImportPath(n).replace(/[^A-Za-z0-9]+/g,"_").replace(/^_+|_+$/g,"").replace(/_+/g,"_")||"module",r=this.hashPath(n),a=`__${s}_${r}__`;return this.importPrefixes.set(n,a),a}getNormalizedImportPath(n){if(this.rootFilename&&this.rootFilename!=="-"){const e=this.host.path.dirname(this.rootFilename),t=this.host.path.relative(e,n);if(t)return t.replace(/\\/g,"/")}return n.replace(/\\/g,"/")}hashPath(n){let e=2166136261;for(let t=0;t<n.length;t++)e^=n.charCodeAt(t),e=Math.imul(e,16777619)>>>0;return e.toString(36)}}var Rn=`/* constants 1 2 3 */
true: 1 ; /* true == 1 */
false: 0 ; /* false == 0 */
...
iln: ilb __ln2 * __s / ; /* n iln == floor(ln(n)) */`,Wn=`.import ./pred.ffp
.import ./arith.ffp
.import ./num.ffp
.import ./atan.ffp
.import ./sqrt.ffp
...
half_pi:
  npi 1 >>
; /* n half_pi == floor(10ⁿ*π/2) */`,Kn=`.import ../core/core.ff
.import ./arith.ffp
...
nfrac: [ abs ] dip n->S % ; /* x n nfrac == (x - floor(x/10^n))*10^n */`,Vn=`.import ../core/core.ff
...
nsqrt:
  ...
  swap n->S2 * isqrt
;
`,Yn=`/* Trigonometric words live here. Pi-derived constants are defined in pi.ffp. */
`,Jn=`.import ./core/core.ff
.import ./math/math.ffp
.import ./string/string.ffp
.import ./seq/seq.ffp`,Zn=`.import ../core/core.ff
...
¶: clr 999 ;`,re=`.import ./lib/prelude.ffp
...
/* 93326215443944152681699238856266700490715968264381621468592963895217599993229915608941463976156518286253697920827223758251185210916864000000000000000000000000 */`,oe=`.import ./lib/prelude.ffp
...
1 fb100 drop`,ae=`.import ./lib/prelude.ffp
...
/* 233168 */
`,ve=`.import ../lib/prelude.ffp

/* Project Euler #7: find the 10001st prime. */
/* http://projecteuler.net/index.php?section=problems&id=7 */

10001 th-prime . /* 104743 */
`;function we(i){const n="../../ff/lib/";if(!i.startsWith(n))throw new Error(`Unexpected library source path: ${i}`);return`/lib/${i.slice(n.length)}`}const X=[{path:"/examples/fact.ffp",label:"fact.ffp",source:re},{path:"/examples/fizzbuzz.ffp",label:"fizzbuzz.ffp",source:oe},{path:"/examples/99bottles.ffp",label:"99bottles.ffp",source:ae},{path:"/examples/pascal.ffp",label:"pascal.ffp",source:pe},{path:"/examples/cbrt.ffp",label:"cbrt.ffp",source:ce},{path:"/examples/sqrt.ffp",label:"sqrt.ffp",source:le},{path:"/examples/gcd.ffp",label:"gcd.ffp",source:ue},{path:"/examples/ack.ffp",label:"ack.ffp",source:de},{path:"/examples/pi.ffp",label:"pi.ffp",source:fe},{path:"/examples/fib.ffp",label:"fib.ffp",source:he},{path:"/examples/catalan.ffp",label:"catalan.ffp",source:_e},{path:"/examples/collatz.ffp",label:"collatz.ffp",source:me},{path:"/examples/hanoi.ffp",label:"hanoi.ffp",source:ge},{path:"/examples/euler1.ffp",label:"euler1.ffp",source:be},{path:"/examples/euler7.ffp",label:"euler7.ffp",source:ve}],xe=Object.fromEntries(Object.entries(Object.assign({"../../ff/lib/core/core.ff":Rn,"../../ff/lib/math/ack.ffp":Dn,"../../ff/lib/math/arith.ffp":On,"../../ff/lib/math/atan-core.ffp":Nn,"../../ff/lib/math/atan.ffp":Ln,"../../ff/lib/math/cbrt.ffp":Mn,"../../ff/lib/math/exp.ffp":Un,"../../ff/lib/math/gcd.ffp":Fn,"../../ff/lib/math/log.ffp":$n,"../../ff/lib/math/math.ffp":Wn,"../../ff/lib/math/num.ffp":jn,"../../ff/lib/math/pi.ffp":Hn,"../../ff/lib/math/precision.ffp":Kn,"../../ff/lib/math/pred.ffp":Vn,"../../ff/lib/math/primes.ffp":Qn,"../../ff/lib/math/prn.ffp":Gn,"../../ff/lib/math/sqrt.ffp":Xn,"../../ff/lib/math/trig.ffp":Yn,"../../ff/lib/prelude.ffp":Jn,"../../ff/lib/seq/seq.ffp":Zn,"../../ff/lib/string/char.ffp":ne,"../../ff/lib/string/str.ffp":ee,"../../ff/lib/string/string.ffp":te,"../../ff/lib/tap.ffp":se,"../../ff/lib/testing.ffp":ie})).map(([i,n])=>[we(i),n])),ye=Object.fromEntries(X.map(({path:i,source:n})=>[i,n]));X.map(({path:i,label:n})=>`<option value="${i}">${n}</option>`).join(`
`);function qe(i,n="/main.ffp"){return{[n]:i,...xe,...ye}}function T(i){const n=i.startsWith("/"),e=i.split("/").filter(Boolean),t=[];for(const s of e)if(s!=="."){if(s===".."){t.pop();continue}t.push(s)}return`${n?"/":""}${t.join("/")}`||(n?"/":".")}function ke(i){const n=T(i),e=n.lastIndexOf("/");return e<=0?n.startsWith("/")?"/":".":n.slice(0,e)}function Ee(...i){const n=i.filter(Boolean).join("/").replaceAll(/\/+/g,"/");return T(n)}function Se(i,n){const e=T(i).split("/").filter(Boolean),t=T(n).split("/").filter(Boolean);let s=0;for(;s<e.length&&s<t.length&&e[s]===t[s];)s++;const r=e.length-s,a=t.slice(s);return Array(r).fill("..").concat(a).join("/")||"."}function Ae(i){return{readTextFile(n){const e=T(n),t=i[e];if(typeof t!="string")throw new Error(`Virtual file not found: ${e}`);return t},fileExists(n){return typeof i[T(n)]=="string"},path:{isAbsolute(n){return n.startsWith("/")},dirname:ke,relative:Se,resolve:Ee}}}function Te(i={}){const n=new TextDecoder,e=new TextEncoder,t=Array.from(e.encode(i.stdin??""));return{io:{write(s){var r;(r=i.onWrite)==null||r.call(i,n.decode(s))},readByte(){return t.shift()??null}},exit(s){var r;(r=i.onExit)==null||r.call(i,s)},now(){return Date.now()}}}const Pe="/lib/prelude.ffp";function Y(i,n){const e=console.log;console.log=(...t)=>{i(t.map(String).join(" "))};try{return n()}finally{console.log=e}}async function Ce(i,n){const e=console.log;console.log=(...t)=>{i(t.map(String).join(" "))};try{return await n()}finally{console.log=e}}function ze(i,n){let e="";const t=[];let s=0;const r=Te({stdin:n,onWrite(_){e+=_},onExit(_){s=_}}),a=new x,c=new K(r),p=new x,l=new K(r),d=qe(i),m=new y(Ae(d),{engine:l,compiler:p},{macroEngineBootstrapFile:Pe});return{compiler:a,engine:c,preprocessor:m,logs:t,getOutput(){return e},getExitCode(){return s}}}function Ie(i,n,e){const t=ze(i,n),s=performance.now(),r=Y(c=>t.logs.push(c),()=>{const c=t.preprocessor.preprocess(y.tokenize(i),"/main.ffp");let p=t.compiler.compileToIR(x.tokenize(c),"/main.ffp");const l=t.compiler.validate(p);e&&(p=new Bn().optimize(p));const d=hn(p),m=x.compileToBase64(p);return t.engine.loadIR(p),{preprocessed:c,formattedIr:d,bytecode:m,issues:l}}),a=performance.now();return{preprocessed:r.preprocessed,ir:r.formattedIr,bytecode:r.bytecode,issues:r.issues,compileMs:a-s,execute(){const c=performance.now();Y(l=>t.logs.push(l),()=>{t.engine.run()});const p=performance.now();return{output:t.getOutput(),stack:t.engine.getStack().map(String),logs:[...t.logs],exitCode:t.getExitCode(),executeMs:p-c,cancelled:!1,vmCyclesExecuted:0}},async executeAsync(c={}){const p=performance.now(),l=await Ce(m=>t.logs.push(m),async()=>await t.engine.runAsync(c)),d=performance.now();return{output:t.getOutput(),stack:t.engine.getStack().map(String),logs:[...t.logs],exitCode:t.getExitCode(),executeMs:d-p,cancelled:l.cancelled,vmCyclesExecuted:l.vmCyclesExecuted}}}}function B(i){self.postMessage(i)}let O=!1,b=null;function Be(i,n){const e=n.cancelled?"cancelled":"done";return{output:n.output,preprocessed:i.preprocessed,ir:i.ir,bytecode:i.bytecode,issues:i.issues,stack:n.stack,logs:n.logs,exitCode:n.exitCode,compileMs:i.compileMs,executeMs:n.executeMs,terminal:e,vmCyclesExecuted:n.vmCyclesExecuted}}self.onmessage=i=>{const n=i.data;if(n.type==="CANCEL"){b===n.runId&&(O=!0);return}if(n.type!=="RUN")return;const{runId:e,source:t,stdin:s,optimize:r,yieldEvery:a}=n;(async()=>{O=!1,b=e;try{const c=Ie(t,s,r);if(b!==e)return;B({type:"COMPILED",runId:e,compileMs:c.compileMs});const p=await c.executeAsync({yieldEvery:a,shouldContinue:()=>!O&&b===e,onChunk:({vmCyclesExecuted:d})=>{b===e&&B({type:"PROGRESS",runId:e,vmCyclesExecuted:d})},scheduler:()=>new Promise(d=>{globalThis.setTimeout(d,0)})});if(b!==e)return;const l=Be(c,p);B({type:"RESULT",runId:e,result:l})}catch(c){if(b!==e)return;const p=c instanceof Error?c.message:String(c);B({type:"ERROR",runId:e,message:p})}finally{b===e&&(b=null)}})()}})();
