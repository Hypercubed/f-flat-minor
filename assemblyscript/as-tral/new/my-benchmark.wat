(module
 ...
 (table $0 5 5 funcref)
 (elem $0 (i32.const 1) $start:assembly/__benches__/my-benchmark~anonymous|0 $~lib/util/sort/COMPARATOR<f64>~anonymous|0 $~lib/__astral__/Stats.mean~anonymous|0 $start:assembly/__benches__/my-benchmark~anonymous|1)
 ...
 (func $start:assembly/__benches__/my-benchmark~anonymous|1
  (local $0 i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
