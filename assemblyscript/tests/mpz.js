...
t.test('addition', (t) => {
  t.test('positive', (t) => {
    ...
    t.same(
      exports.add('0x00000000deadbeef', '0xdeadbeef00000000'),
      0xdeadbeefdeadbeefn,
    );

    t.same(
      exports.add('2950793089775236', '2160715205785584'),
      0x1228e3c4392e74n,
    );
    t.same(
      exports.add('403105631078710', '3402969886132728'),
      3806075517211438n,
    );
    t.end();
  });
...
t.test('subtraction', (t) => {
  t.test('lhs>rhs>0', (t) => {
    ...
    t.same(
      exports.sub('0xdeadbeefdeadbeef', '0xdeadbeef00000000'),
      0xdeadbeefn,
    );
    t.end();
  });
  ...
  t.test('rhs<0, |lhs|>|rhs|', (t) => {
    ...
    t.same(
      exports.sub('2779068574725052', '-2776491312893844'),
      0x13bcc095a14350n,
    );
    t.end();
  });
...
t.test('division', (t) => {
  ...
  t.test('n>m>0xFFFFFFFF', (t) => {
    ...
    t.same(
      exports.div('0xFFFFFFFFFFFFFFFFFFFF', '0xFFFFFFFFFFFFFFFFFFF'),
      0x10,
    );
    t.same(
      exports.div('0xFFFFFFFFFFFFFFFFFFFF', '0xFFFFFFFFFFFFFFFFF'),
      0x1000,
    );
