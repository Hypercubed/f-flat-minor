...
describe('shift', () => {
  it('left shift', () => {
    ...
    assertSame(
      ...
      '0x1234567890ABCDEF00000000',
    );
    assertSame(
      MpZ.from('0x1234567890ABCDEF') << 64,
      '0x1234567890ABCDEF0000000000000000',
    );
    assertSame(
      MpZ.from('0x1234567890ABCDEF') << 128,
      '0x1234567890ABCDEF00000000000000000000000000000000',
    );
  });
  ...
  it('right shift', () => {
    ...
    assertSame(
      ...
      '0x1234567890ABCDEF0000000000000000000000000000000',
    );
    assertSame(
      MpZ.from('0x1234567890ABCDEF00000000000000000000000000000000') >> 8,
      '0x1234567890ABCDEF000000000000000000000000000000',
    );
    assertSame(
