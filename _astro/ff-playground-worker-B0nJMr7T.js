(function(){"use strict";function J(){return!!(globalThis.Deno?.stdout?.isTerminal?.()??globalThis.process?.stdout?.isTTY??!1)}function D(i,n){return J()?`\x1B[${i}m${n}\x1B[0m`:n}function nn(i){return D(34,i)}function en(i){return D(32,i)}function v(i){return D(36,i)}const a={NOP:0,CALL:1,PUTC:2,GETC:3,PUTN:5,CLOCK:6,DROP:8,PUSHR:14,PULLR:15,SHIFTL:16,SHIFTR:17,CLR:24,RAND:26,EXIT:27,DUP:33,DEPTH:35,SWAP:36,MOD:37,AND:38,STASH:40,FETCH:41,MUL:42,ADD:43,CONS:44,SUB:45,PRN:46,DIV:47,MARK:58,DEF:59,LT:60,EQ:61,GT:62,IF:63,BRA:91,KET:93,POW:94,OR:124,NOT:126},y={nop:a.NOP,eval:a.CALL,";":a.DEF,":":a.MARK,clr:a.CLR,rand:a.RAND,exit:a.EXIT,".":a.PRN,putc:a.PUTC,getc:a.GETC,putn:a.PUTN,clock:a.CLOCK,drop:a.DROP,swap:a.SWAP,dup:a.DUP,"<<":a.SHIFTL,">>":a.SHIFTR,"+":a.ADD,"-":a.SUB,cons:a.CONS,"*":a.MUL,"/":a.DIV,"<":a.LT,"=":a.EQ,">":a.GT,"?":a.IF,"%":a.MOD,"&":a.AND,"(":a.STASH,")":a.FETCH,"q<":a.PUSHR,"q>":a.PULLR,depth:a.DEPTH,"^":a.POW,"[":a.BRA,"]":a.KET,"|":a.OR,"~":a.NOT},x=255,tn=i=>i,sn=i=>i,u={call:"call",push:"push"},rn=6,z=10,an=new Map([[BigInt(a.MARK),":"],[BigInt(a.DEF),";"],[BigInt(a.BRA),"["],[BigInt(a.KET),"]"]]);function on(i){return(""+i.value).padEnd(z," ")}function pn(i,n){return n?n.padEnd(z," "):i.op===u.push&&i.meta?.pointer?`[${i.value}]`.padEnd(z," "):on(i)}function cn(i){return i.trim()?`/* ${i} */`:""}function ln(i){const n=un(i)?.toUpperCase()||"",e=i.op===u.call?an.get(i.value):void 0,t=e!==void 0,s=pn(i,e),r=i.meta?.comment?.trim()||(i.op===u.call&&!t?n:""),o=(i.op===u.call&&!e?"EVAL":"").padEnd(rn," ");return[sn(s),tn(o),cn(r)].join(" ")}function dn(i){for(const n in y)if(y[n]===i)return n;return""}function un(i){if(i.op===u.call||i.op===u.push&&i.meta?.pointer)return i.meta?.name||dn(Number(i.value))||""}function hn(i){return i.map(ln).join(`
`)}function _n(i){return i=i.replace(/\\U([A-Fa-f0-9]{8})/g,(n,e)=>N(e)),i=i.replace(/\\u([A-Fa-f0-9]{4})/g,(n,e)=>N(e)),i.replace(/\\0/g,"\0").replace(/\\b/g,"\b").replace(/\\t/g,"	").replace(/\\n/g,`
`).replace(/\\v/g,"\v").replace(/\\f/g,"\f").replace(/\\r/g,"\r").replace(/\\'/g,"'").replace(/\\"/g,'"').replace(/\\s/g," ").replace(/\\\\/g,"\\")}function N(i){let n="",e=parseInt(i,16);return e<=65535?n+=String.fromCharCode(e):e<=1114111?(e-=65536,n+=String.fromCharCode(55296|e>>10)+String.fromCharCode(56320|e&1023)):n+=`hex2Char error: Code point out of range: ${fn(e)}`,n}function fn(i){return(i+0).toString(16).toUpperCase()}const L="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",F=new Map;L.split("").forEach(function(i,n){F.set(i,n)});const U=1n<<5n,$=Number(U),j=U-1n;function mn(i){return i.map(wn).map(yn).join("")}function gn(i){return qn(xn(i)).map(kn)}function bn(i){return i>=0n?i<<1n:(-i<<1n)+1n}function vn(i){return i&1n?-(i>>1n):i>>1n}function wn(i){if(i===0n)return[0];i=bn(i);const n=[];for(;i>0;){let e=Number(i&j);i>>=5n,i>0&&(e|=$),n.push(e)}return n}function yn(i){return i.map(n=>L[n]).join("")}function xn(i){return i.split("").map(n=>{const e=F.get(n);if(e===void 0)throw new Error(`${i} is not a valid base64 encoded VLQ`);return e})}function qn(i){const n=[];let e=[];if(i.forEach(t=>{e.push(t),(t&$)===0&&(n.push(e),e=[])}),e.length>0)throw new Error("Malformed VLQ sequence: The last VLQ never ended.");return n}function kn(i){const n=i.reverse().reduce((e,t)=>(e<<=5n,e|=BigInt(t)&j,e),0n);return vn(n)}const Sn="/*",En="*/";function O(i){if(!(i==="-"||i==="+"))try{let n=1n;return i=i.replaceAll("_",""),i.startsWith("-0")&&(n=-1n,i=i.replace("-","")),i.includes("e")||i.includes("E")?n*BigInt(+i):n*BigInt(i)}catch{return}}class g{constructor(n={}){this.symbols=new Map,this._nextCode=-1,this.host=n;let e;for(e in y)this.symbols.set(e,BigInt(y[e]))}static tokenize(n){return n.split(/\s+/).filter(Boolean).map(e=>{const t=O(e);return t!==void 0?t:e})}static tokenizeWithSpans(n){const e=[],t=/\S+/g;let s=0,r=0,o=0;const p=c=>{for(;o<c;){const d=n[o];d==="\r"?(n[o+1]===`
`&&o++,s++,r=0):d===`
`?(s++,r=0):r++,o++}};let l;for(;(l=t.exec(n))!==null;){const c=l.index;p(c);const d=l[0]??"",_=O(d);e.push({raw:d,value:_!==void 0?_:d,line:s,character:r,length:d.length,offset:c}),p(c+d.length)}return e}static compileToBase64(n){const e=n.flatMap(t=>{if(t.op===u.call&&t.value===0n)return[];const s=t.value<<1n;return[t.op===u.push?s:s|1n]});return mn(e)}nextCode(){return BigInt(this._nextCode--)}getSymbol(n){n=n.toLowerCase();let e=this.symbols.get(n);return e===void 0&&(e=this.nextCode(),this.symbols.set(n,e)),e}compileToIR(n,e=""){let t=0;const s=n.length;let r="";const o=[];let p;for(;t<s;)if(p=n[t++],r=this.unwrapTokenValue(p),typeof r=="bigint")l(r);else if(r.length>1&&r.startsWith(".")){const[d]=r.split(" ");switch(d){case".push":o[o.length-1].op=u.push;break;case".call":o[o.length-1].op=u.call;break;case".inline":o[o.length-1].meta||={},o[o.length-1].meta.inline=!0;break;case".unsafe":o[o.length-1].meta||={},o[o.length-1].meta.unsafe=!0;break;case".pointer":o[o.length-1].meta||={},o[o.length-1].meta.pointer=!0;break;case".exit":if(this.host.exit){this.host.exit();break}throw new Error("Compiler: .exit requires a host exit handler");case".symbols":this.symbols.forEach((_,f)=>{(this.host.log||console.log)(f,_)});break;case".words":{const _=Array.from(this.symbols,([f])=>f).join(" ");(this.host.log||console.log)(_);break}}}else if(r[0]==="'"&&r.length>1)_n(r).replace(/^'/,"").replace(/'$/,"").split("").forEach(d=>{l(d.charCodeAt(0),{comment:d})});else if(r.endsWith(":")&&r.length>1){const d=r.replace(/:$/,"");l(this.getSymbol(d),{name:`${d}`,pointer:!0}),c(a.MARK,{name:":"})}else if(r===Sn){const d=p,_=[];for(;t<n.length&&(p=n[t++],r=this.unwrapTokenValue(p),r!==En);)_.push(r);c(0n,{comment:_.join(" ")},d)}else if(r.startsWith("[")&&r.endsWith("]")){const d=r.replace(/^\[/,"").replace(/\]$/,""),_=O(d);_!==void 0?l(_,{name:d,pointer:!0}):l(this.getSymbol(d),{name:d,pointer:!0})}else c(this.getSymbol(r),{name:r});return o;function l(d,_={},f=p){o.push({value:BigInt(d),op:u.push,meta:{..._,...g.toInstructionMeta(f,e)}})}function c(d,_={},f=p){o.push({value:BigInt(d),op:u.call,meta:{..._,...g.toInstructionMeta(f,e)}})}}unwrapTokenValue(n){return typeof n=="string"||typeof n=="bigint"?n:n.value}static toInstructionMeta(n,e){return!n||typeof n=="string"||typeof n=="bigint"?{filename:e}:{filename:e,line:n.line,character:n.character,length:n.length,offset:n.offset}}validate(n){const e=n.slice(),t=[];let s=0;for(;s<e.length;){const r=e[s];if(r.op===u.call&&r.value===BigInt(a.DEF)){let o=0;for(o=s;o>0&&!(e[o].op===u.call&&e[o].value===BigInt(a.MARK));o--);const p=e.splice(o-1,s-o+2);p.at(-1)?.meta?.unsafe||t.push(...this.validateDef(p)),s=o-1}s++}return t.push(...this.validateDef(e,"main")),t}validateDef(n,e){const t=[];let s=0,r=0,o=0,p=0;const l=[0];if(!n[0])return[];e=en(e||n[0].meta?.name?.replace(/^&/,"")||"main");const c=nn(n[0].meta?.filename||"-");for(;s<n.length;){const d=n[s];if(d.op===u.call){if(d.op===u.call&&d.value===BigInt(a.MARK)&&r++,d.op===u.call&&d.value===BigInt(a.DEF)&&r--,d.op===u.call&&d.value===BigInt(a.BRA)&&(o++,l.push(0)),d.op===u.call&&d.value===BigInt(a.KET)&&(o--,(l.length>1?l.pop():0)!==0&&t.push(`${c}: Unbalanced queue push ( ${v("q< q>")} ) in quote in ${e}`)),d.op===u.call&&(d.value===BigInt(a.PUSHR)||d.value===BigInt(a.STASH))&&(p++,l[l.length-1]++),d.op===u.call&&(d.value===BigInt(a.PULLR)||d.value===BigInt(a.FETCH))){if(l[l.length-1]===0){const f=d.value===BigInt(a.FETCH)?")":"q>";t.push(`${c}: Queue borrow ( ${v(f)} ) requires ${v(".unsafe")} in ${e} (including quotes)`)}p--,l[l.length-1]--}o<0&&t.push(`${c}: Bracket ( ${v("[ ]")} ) mismatch in ${e}`),r<0&&t.push(`${c}: Definition ( ${v(": ;")} ) mismatch in ${e}`)}s++}return o!==0&&t.push(`${c}: Unbalanced brackets ( ${v("[ ]")} ) in ${e}`),p!==0&&t.push(`${c}: Unbalanced queue push ( ${v("q< q> ( )")} ) in ${e}`),r!==0&&t.push(`${c}: Unbalanced definition ( ${v(": ;")} ) in ${e}`),t}}const Tn="FbAbbCb";var An={words:[{mnemonic:"NOP",syntax:"nop",stackEffect:"… nop == …",description:"No operation; does nothing.",opcode:0},{mnemonic:"EVAL",syntax:"eval",stackEffect:"[A] eval == a*",description:"Evaluates a quotation, executing its contents.",opcode:1},{mnemonic:"PUTC",syntax:"putc",stackEffect:"n putc == {prints char(n)}",description:"Prints a character given by its numeric code.",opcode:2},{mnemonic:"GETC",syntax:"getc",stackEffect:"getc == n {reads char}",description:"Reads a single character from input and pushes its code.",opcode:3},{mnemonic:"PUTN",syntax:"putn",stackEffect:"n putn == {prints n}",description:"Prints a number to output.",opcode:5},{mnemonic:"CLOCK",syntax:"clock",stackEffect:"clock == n {reads clock}",description:"Returns the current time as a Unix timestamp.",opcode:6},{mnemonic:"DROP",syntax:"drop",stackEffect:"a drop ==",description:"Removes the top value from the stack.",opcode:8},{mnemonic:"PUSHR",syntax:"q<",stackEffect:"a q< == | …a",description:"Pushes a value onto the return stack.",opcode:14},{mnemonic:"PULLR",syntax:"q>",stackEffect:"q> == a | a…",description:"Pops a value from the return stack onto the main stack.",opcode:15},{mnemonic:"SHIFTL",syntax:"<<",stackEffect:"a b << == n",description:"Left-shifts a by b bits.",opcode:16},{mnemonic:"SHIFTR",syntax:">>",stackEffect:"a b >> == n",description:"Right-shifts a by b bits.",opcode:17},{mnemonic:"CLR",syntax:"clr",stackEffect:"… clr ==",description:"Clears the entire stack.",opcode:24},{mnemonic:"RAND",syntax:"rand",stackEffect:"n rand == r {0 <= r < n}",description:"Generates a random number between 0 and n-1.",opcode:26},{mnemonic:"EXIT",syntax:"exit",stackEffect:"n exit == {exits with code n}",description:"Exits the program with the given exit code.",opcode:27},{mnemonic:"DUP",syntax:"dup",stackEffect:"a dup == a a",description:"Duplicates the top value on the stack.",opcode:33},{mnemonic:"DEPTH",syntax:"depth",stackEffect:"… depth == … n",description:"Pushes the current stack depth.",opcode:35},{mnemonic:"SWAP",syntax:"swap",stackEffect:"a b swap == b a",description:"Swaps the top two values on the stack.",opcode:36},{mnemonic:"MOD",syntax:"%",stackEffect:"a b % == n",description:"Computes the remainder of a divided by b.",opcode:37},{mnemonic:"AND",syntax:"&",stackEffect:"a b & == n",description:"Bitwise AND of a and b.",opcode:38},{mnemonic:"STASH",syntax:"(",stackEffect:"… ( == {moves stack to queue}",description:"Moves values from the stack to the queue.",opcode:40},{mnemonic:"FETCH",syntax:")",stackEffect:") == … {restores stack from queue}",description:"Moves values from the queue back to the stack.",opcode:41},{mnemonic:"MUL",syntax:"*",stackEffect:"a b * == n",description:"Multiplies a by b.",opcode:42},{mnemonic:"ADD",syntax:"+",stackEffect:"a b + == n",description:"Adds a and b together.",opcode:43},{mnemonic:"CONS",syntax:"cons",stackEffect:"x y cons == q",description:"Builds an anonymous quotation from two stack values (opcode also maps to `,`).",opcode:44},{mnemonic:"SUB",syntax:"-",stackEffect:"a b - == n",description:"Subtracts b from a.",opcode:45},{mnemonic:"DUMP",syntax:".",stackEffect:"… . == … {prints stack}",description:"Prints the entire stack to output.",opcode:46},{mnemonic:"DIV",syntax:"/",stackEffect:"a b / == n",description:"Divides a by b (integer division).",opcode:47},{mnemonic:"MARK",syntax:":",stackEffect:"n : == {begin definition(n)}",description:"Begins a new word definition with name n.",opcode:58},{mnemonic:"DEF",syntax:";",stackEffect:"; == {end definition}",description:"Ends the current word definition.",opcode:59},{mnemonic:"LT",syntax:"<",stackEffect:"a b < == flag",description:"Pushes true if a is less than b.",opcode:60},{mnemonic:"EQ",syntax:"=",stackEffect:"a b = == flag",description:"Pushes true if a equals b.",opcode:61},{mnemonic:"GT",syntax:">",stackEffect:"a b > == flag",description:"Pushes true if a is greater than b.",opcode:62},{mnemonic:"WHEN",syntax:"?",stackEffect:"flag [A] ? == a*",description:"Executes the quotation if flag is true.",opcode:63},{mnemonic:"BRA",syntax:"[",stackEffect:"[ == {begin quotation}",description:"Begins a quotation (anonymous code block).",opcode:91},{mnemonic:"KET",syntax:"]",stackEffect:"] == [A] {end quotation}",description:"Ends a quotation and pushes it to the stack.",opcode:93},{mnemonic:"POW",syntax:"^",stackEffect:"a b ^ == n",description:"Computes a raised to the power of b.",opcode:94},{mnemonic:"OR",syntax:"|",stackEffect:"a b | == n",description:"Bitwise OR of a and b.",opcode:124},{mnemonic:"NOT",syntax:"~",stackEffect:"a ~ == n'",description:"Bitwise NOT of a.",opcode:126}]};const W=new Map;for(const i of An.words)W.set(i.opcode,i);function Pn(i){return W.get(i)}const In=[BigInt(a.DEF),BigInt(a.KET),BigInt(a.MARK),BigInt(a.BRA)],q=0n,k=1n;class H{constructor(n){this.stack=[],this.queue=[],this.defs=new Map,this.symbols=new Map,this.depth=0,this.nextAnonOp=x+1,this.traceOn=!1,this.traceFormat="human",this.traceVerbose=!1,this.traceQueueMax=8,this.traceStackMax=32,this.base=10,this.statsOn=!1,this.profileOn=!1,this.stats={system_instructions_called:0,user_instructions_called:0,max_stack_depth:0,max_queue_depth:0},this.profile={},this.platform=n,this.setup()}static fromBase64(n){return gn(n).flatMap(e=>{const t=e&1n,s=e>>1n;return[t,s]})}getStack(){return this.stack.slice()}peek(){const n=this.stack.length;if(n>0)return this.stack[n-1];throw new Error("Peek: stack underflow")}pop(){if(this.stack.length>0)return this.stack.pop();throw new Error("Pop: stack underflow")}push(n){this.stack.push(n)}poke(n){const e=this.stack.length;if(e>0){this.stack[e-1]=n;return}throw new Error("Poke: stack underflow")}clear(){this.stack.splice(0,this.stack.length)}queuePush(n,e){this.queue.push(n,e)}queueUnshift(n,e){this.queue.unshift(n,e)}queueShift(){return[this.queue.shift()??0n,this.queue.shift()??0n]}queuePop(){const n=this.queue.pop()??0n;return[this.queue.pop()??0n,n]}defineSystem(n,e){const t=BigInt(e),s=this.getName(t);if(this.defs.has(t))throw new Error(`Define: cannot redefine system word "${s}"`);this.defs.set(t,n)}defineUser(n,e){const t=this.getName(e);if(e>-1&&e<x)throw new Error(`Define: cannot define system op "${t}"`);if(this.defs.has(e))throw e>x?new Error(`Define: cannot redefine anon op "${t}"`):new Error(`Define: cannot redefine user op "${t}"`);this.defs.set(e,n)}callSystem(n){const e=this.defs.get(n);if(typeof e=="function"){if(this.statsOn&&this.stats.system_instructions_called++,this.profileOn){const s=performance.now();e();const r=performance.now(),o=this.getName(n)||Number(n);this.profile[o]||=[0,0],this.profile[o][0]++,this.profile[o][1]!=0,this.profile[o][1]+=r-s;return}return e()}const t=this.getName(n)||n;throw new Error(`Call: undefined system op "${t}"`)}callUser(n){const e=this.defs.get(n);if(Array.isArray(e)){if(this.statsOn&&this.stats.user_instructions_called++,this.queue.unshift(...e),this.profileOn){const s=this.getName(n,`&${n}`);this.profile[s]||=[0,void 0],this.profile[s][0]++}return}const t=this.getName(n)||n;throw new Error(`Call: undefined user op "${t}"`)}callOp(n){return n>-1n&&n<x?this.callSystem(n):this.callUser(n)}loadBigIntCode(n){this.queue.push(...n)}loadIR(n){let e=0;for(;e<n.length;){const t=n[e++];if(t.op===u.call){if(t.value===0n)continue;t.meta?.name&&!this.symbols.has(t.value)&&this.symbols.set(t.value,t.meta?.name),this.queuePush(k,t.value)}else this.queuePush(q,t.value)}return this.stack}runChunk(n,e){const t=this.queue;let s=!1,r=e,o=0;for(;t.length>0&&o<n;){const[p,l]=this.queueShift(),c=p===k,d=this.stack.slice();s=!this.depth||c&&In.includes(l),c?s?this.callOp(l):(this.push(p),this.push(l)):(s||this.push(p),this.push(l)),this.statsOn&&(this.stats.max_stack_depth=Math.max(this.stats.max_stack_depth,this.stack.length),this.stats.max_queue_depth=Math.max(this.stats.max_queue_depth,t.length/2));const _=r++;this.traceOn&&this.trace({step:_,immediate:s,tag:p,value:l,stackBefore:d,stackAfter:this.traceVerbose||this.traceFormat==="jsonl"?this.stack.slice():void 0}),o++}return r}run(){return this.runChunk(Number.POSITIVE_INFINITY,0),this.stack}async runAsync(n={}){const e=n.yieldIntervalMs??160,t=n.yieldSliceMax??n.yieldEvery??655360;if(!Number.isFinite(e)||e<0)throw new Error(`runAsync: yieldIntervalMs must be a non-negative finite number (received ${e})`);if(!Number.isFinite(t)||t<1)throw new Error(`runAsync: yieldSliceMax / yieldEvery must be a positive finite number (received ${t})`);const s=n.scheduler??(()=>new Promise(c=>{globalThis.setTimeout(c,0)})),r=typeof globalThis.performance<"u"&&typeof globalThis.performance.now=="function"?()=>globalThis.performance.now():()=>globalThis.Date.now();let o=0,p=0,l=!1;for(;this.queue.length>0&&!l;){const c=r(),d=e>0?c+e:c;for(;this.queue.length>0&&!l&&!(e>0&&r()>=d);){const _=o;if(o=this.runChunk(t,o),p+=o-_,n.onChunk?.({vmCyclesExecuted:p}),n.shouldContinue&&!n.shouldContinue()){l=!0;break}if(e===0)break}this.queue.length>0&&!l&&await s()}return{stack:this.stack.slice(),cancelled:l,vmCyclesExecuted:p}}trace({step:n,immediate:e,tag:t,value:s,stackBefore:r,stackAfter:o}){const p=this.createTraceEvent(n,e,t,s,r,o);if(this.traceFormat==="jsonl"){this.writeTraceLine(JSON.stringify(p));return}this.writeTraceLine(this.formatHumanTrace(p))}createTraceEvent(n,e,t,s,r,o){const p=t===k,l=p?this.getName(s,String(s)):String(s),c=this.getQueuePreview();return{step:n,immediate:e,tag:p?"call":"literal",value:String(s),action:l,stack_before:this.limitStack(r).map(String),stack_after:o?this.limitStack(o).map(String):void 0,queue_preview:c,queue_depth:this.queue.length/2}}limitStack(n){return n.length>this.traceStackMax?n.slice(-this.traceStackMax):n}getQueuePreview(){const n=[],e=Math.max(this.traceQueueMax,0);for(let t=0;t<this.queue.length&&n.length<e;t+=2){const s=this.queue[t]??0n,r=this.queue[t+1]??0n,o=s===k;n.push({tag:o?"call":"literal",value:String(r),action:o?this.getName(r,String(r)):String(r)})}return n}formatHumanTrace(n){const e=this.padHumanAction(n.action),t=this.formatHumanStack(n.stack_before),s=this.formatHumanQueue(n.queue_preview,n.queue_depth),r=this.layoutHumanTraceLine(n.step,t,e,s);if(this.traceVerbose){const o=this.formatHumanStack(n.stack_after??[]);return`${r}
${" ".repeat(String(n.step).length+1)}${o} | immediate=${n.immediate} tag=${n.tag} value=${n.value} stack_depth=${this.stack.length} queue_depth=${n.queue_depth}`}return r}padHumanAction(n){return n.length>=7?n:n.padStart(Math.floor((7+n.length)/2)," ").padEnd(7," ")}layoutHumanTraceLine(n,e,t,s){const r=this.getTraceTerminalWidth(),o=`${n} `;if(o.length>=r)return o.slice(0,r);const p=1,l=Math.min(t.length,Math.max(r-o.length-p*2,1)),c=Math.max(o.length+p,Math.floor((r-l)/2)),d=Math.min(c,Math.max(o.length+p,r-l-p)),_=d+l,f=o.length,T=Math.max(f,d-p),A=Math.min(r,_+p),tt=r,Y=Math.max(T-f,0),Z=Math.max(tt-A,0),I=Array.from({length:r},()=>" ");if(this.writeSegment(I,0,o,o.length),this.writeSegment(I,d,t,l),Y>0){const P=this.truncateLeft(e,Y);this.writeSegment(I,T-P.length,P,P.length)}if(Z>0){const P=this.truncateRight(s,Z);this.writeSegment(I,A,P,P.length)}return I.join("").replace(/\s+$/,"")}formatHumanStack(n){return n.length===0?"[ ]":`[ ${n.join(" ")} ]`}formatHumanQueue(n,e){const t=n.map(r=>r.tag==="call"?`&${r.action}`:r.value),s=Math.max(e-n.length,0);return s>0&&t.push(`…(+${s})`),t.length===0?"[ ]":`[ ${t.join(" ")} ]`}getTraceTerminalWidth(){const e=globalThis.Deno,t=e?.stderr?.isTerminal?.()&&typeof e.stderr.rid=="number"?e.stderr.rid:e?.stdout?.isTerminal?.()&&typeof e.stdout.rid=="number"?e.stdout.rid:void 0;if(typeof t=="number")try{const o=e?.consoleSize?.(t).columns;if(typeof o=="number"&&o>0)return o}catch{}const s=globalThis.process,r=s?.stderr?.isTTY&&typeof s.stderr.columns=="number"?s.stderr.columns:s?.stdout?.isTTY&&typeof s.stdout.columns=="number"?s.stdout.columns:void 0;return typeof r=="number"&&r>0?r:120}truncateLeft(n,e){return e<=0?"":n.length<=e?n:e===1?"…":`…${n.slice(-(e-1))}`}truncateRight(n,e){return e<=0?"":n.length<=e?n:e===1?"…":`${n.slice(0,e-1)}…`}writeSegment(n,e,t,s){if(!(s<=0))for(let r=0;r<s&&r<t.length&&e+r<n.length;r++)n[e+r]=t[r]}writeTraceLine(n){const e=new TextEncoder().encode(`${n}
`);if(this.platform.io.writeError){this.platform.io.writeError(e);return}this.platform.io.write(e)}getName(n,e=String(n)){return this.symbols.has(n)?this.symbols.get(n):String(e)}inspectValue(n){const e=this.symbols.get(n),t=n>=0n&&n<=BigInt(x),s=this.defs.get(n),r=s!==void 0;let o;Array.isArray(s)&&(o=this.parseDefinitionTokens(s));let p,l;if(t){const c=Pn(Number(n));c&&(p=c.stackEffect,l=c.description)}return{value:n,name:e,isSystem:t,isDefined:r,definition:o,stackEffect:p,description:l}}parseDefinitionTokens(n){const e=[];for(let t=0;t<n.length;t+=2){const s=n[t]??0n,r=n[t+1]??0n,o=s===k,p=o?this.symbols.get(r):void 0,l=this.defs.has(r);e.push({value:r,tag:s,name:p,isCall:o,isDefined:l})}return e}print(){const n=this.stack.map(e=>e.toString(this.base)).join(" ");this.platform.io.write(new TextEncoder().encode(`[ ${n} ]
`))}loadSourceMap(n){Object.keys(n.symbols).forEach(e=>{this.symbols.set(BigInt(e),n.symbols[e])})}getNextAnonOp(){let n=this.nextAnonOp++;for(;this.defs.has(BigInt(n));)n=this.nextAnonOp++;return BigInt(n)}setup(){const n=new TextEncoder;let e;for(e in y)this.symbols.set(BigInt(y[e]),e);this.defineSystem(()=>{},a.NOP),this.defineSystem(()=>{const t=this.pop();this.callOp(t)},a.CALL),this.defineSystem(()=>{this.depth--;const[,t]=this.queuePop(),s=this.stack.splice(Number(t||0))||[];this.defineUser(s,this.pop())},a.DEF),this.defineSystem(()=>{this.depth--;const[,t]=this.queuePop(),s=this.stack.splice(Number(t||0))||[],r=this.getNextAnonOp();this.defineUser(s,r),this.depth>0&&this.push(0n),this.push(r)},a.KET),this.defineSystem(()=>{this.depth++;const t=this.stack.length;this.queuePush(q,BigInt(t))},a.BRA),this.defineSystem(()=>{this.depth++;const t=this.stack.length;this.queuePush(q,BigInt(t))},a.MARK),this.defineSystem(()=>this.clear(),a.CLR),this.defineSystem(()=>{const t=this.pop();this.platform.exit(Number(t))},a.EXIT),this.defineSystem(()=>{const t=this.pop();this.push(Cn(t))},a.RAND),this.defineSystem(()=>{this.print()},a.PRN),this.defineSystem(()=>{this.push(BigInt(this.platform.now()))},a.CLOCK),this.defineSystem(()=>{const t=n.encode(String.fromCharCode(Number(this.pop())));this.platform.io.write(t)},a.PUTC),this.defineSystem(()=>{this.platform.io.setRaw&&this.platform.io.setRaw(!0);const t=this.platform.io.readByte();this.platform.io.setRaw&&this.platform.io.setRaw(!1),this.push(BigInt(t??0))},a.GETC),this.defineSystem(()=>{const t=n.encode(this.pop().toString(this.base));this.platform.io.write(t)},a.PUTN),this.defineSystem(()=>{this.pop()},a.DROP),this.defineSystem(()=>{const t=this.peek(),s=this.stack[this.stack.length-2];this.stack[this.stack.length-2]=t,this.poke(s)},a.SWAP),this.defineSystem(()=>{this.push(this.peek())},a.DUP),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]+=t},a.ADD),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]-=t},a.SUB),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]*=t},a.MUL),this.defineSystem(()=>{const t=this.pop();if(t===0n)throw new Error("DIV: Division by zero");this.stack[this.stack.length-1]/=t},a.DIV),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]%=t},a.MOD),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]<<=t},a.SHIFTL),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]>>=t},a.SHIFTR),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]&=t},a.AND),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]**=t},a.POW),this.defineSystem(()=>{this.push(this.pop()>this.pop()?1n:0n)},a.LT),this.defineSystem(()=>{this.push(this.pop()===this.pop()?1n:0n)},a.EQ),this.defineSystem(()=>{this.push(this.pop()<this.pop()?1n:0n)},a.GT),this.defineSystem(()=>{const t=this.pop();this.pop()!==0n&&this.queueUnshift(k,t)},a.IF),this.defineSystem(()=>{this.queuePush(q,this.pop())},a.PUSHR),this.defineSystem(()=>{const[,t]=this.queuePop();this.push(t)},a.PULLR),this.defineSystem(()=>{this.push(BigInt(this.stack.length))},a.DEPTH),this.defineSystem(()=>{const t=this.stack.length;this.stack.splice(0,t).forEach(r=>this.queuePush(q,r)),this.queuePush(q,BigInt(t))},a.STASH),this.defineSystem(()=>{const[,t]=this.queuePop(),s=Number(t),r=[];for(let o=0;o<s;o++){const[,p]=this.queuePop();r.unshift(p)}this.stack.unshift(...r)},a.FETCH),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]|=t},a.OR),this.defineSystem(()=>{const t=this.pop();this.push(~t)},a.NOT),this.defineSystem(()=>{const t=this.pop(),r=[0n,this.pop(),1n,t],o=this.getNextAnonOp();this.defineUser(r,o),this.depth>0&&this.push(0n),this.push(o)},a.CONS)}printProfile(){console.log(),console.log("Profile:");const n=Object.keys(this.profile).map(s=>{const r=this.profile[s][0],o=this.profile[s][1];return{name:s,calls:r,time:o,system:typeof o<"u","ops/ms":o?Math.round(r/o):""}}).sort((s,r)=>r.calls-s.calls),e=n.filter(s=>s.system),t=n.filter(s=>!s.system);console.table(e,["name","calls","ops/ms"]),console.table(t,["name","calls"]),console.log()}printStats(){console.log(),console.log("Interpreter stats:"),console.log(this.stats),console.log()}}function Cn(i){const n=i,e=n.toString().length;let t="";for(;t.length<e;)t+=Math.random().toString().split(".")[1];t=t.slice(0,e);const s="1"+"0".repeat(e);return n*BigInt(t)/BigInt(s)}const C=BigInt(a.DEF),V=BigInt(a.KET),R=BigInt(a.MARK),K=BigInt(a.BRA),h=i=>(i=BigInt(i),n=>n.op===u.call&&n.value===i),S=i=>(i=BigInt(i),n=>n.op===u.push&&n.value===i),m=i=>i.op===u.push,Q=i=>i.op===u.push&&i.value!==0n,Rn=[{name:"No operation",pattern:[h(a.NOP)],replacement:()=>[]},{name:"Null Sequence - SWAP SWAP",pattern:[h(a.SWAP),h(a.SWAP)],replacement:()=>[]},{name:"Null Sequence - DUP DROP",pattern:[h(a.DUP),h(a.DROP)],replacement:()=>[]},{name:"Null Sequence - PUSHR PULLR",pattern:[h(a.PUSHR),h(a.PULLR)],replacement:()=>[]},{name:"Null Sequence - CLOCK DROP",pattern:[h(a.CLOCK),h(a.DROP)],replacement:()=>[]},{name:"Null Sequence - RAND DROP",pattern:[h(a.RAND),h(a.DROP)],replacement:()=>[]},{name:"Null Sequence - DEPTH DROP",pattern:[h(a.DEPTH),h(a.DROP)],replacement:()=>[]},{name:"Null Sequence - NOT NOT",pattern:[h(a.NOT),h(a.NOT)],replacement:()=>[]},{name:"Indirect calls - n EVAL",pattern:[m,h(a.CALL)],replacement:i=>[{op:u.call,value:i.value,meta:{name:i.meta?.name?.replace(/^&/,"")}}]},{name:"Null Sequence - n DROP",pattern:[m,h(a.DROP)],replacement:()=>[]},{name:"Constant Folding - a b ADD",pattern:[m,m,h(a.ADD)],replacement:(i,n)=>[{op:u.push,value:i.value+n.value}]},{name:"Algebraic Simplification - 0 ADD",pattern:[S(0),h(a.ADD)],replacement:()=>[]},{name:"Algebraic Simplification - swap ADD",pattern:[h(a.SWAP),h(a.ADD)],replacement:(i,n)=>[n]},{name:"Constant Folding - a b SUB",pattern:[m,m,h(a.SUB)],replacement:(i,n)=>[{op:u.push,value:i.value-n.value}]},{name:"Algebraic Simplification - 0 SUB",pattern:[S(0),h(a.SUB)],replacement:()=>[]},{name:"Constant Folding - a b MUL",pattern:[m,m,h(a.MUL)],replacement:(i,n)=>[{op:u.push,value:i.value*n.value}]},{name:"Algebraic Simplification - 1 MUL",pattern:[S(1),h(a.MUL)],replacement:()=>[]},{name:"Algebraic Simplification - swap MUL",pattern:[h(a.SWAP),h(a.MUL)],replacement:(i,n)=>[n]},{name:"Constant Folding - a b DIV",pattern:[m,Q,h(a.DIV)],replacement:(i,n)=>[{op:u.push,value:i.value/n.value}]},{name:"Algebraic Simplification - 1 DIV",pattern:[S(1),h(a.DIV)],replacement:()=>[]},{name:"Constant propagation - a DUP",pattern:[m,h(a.DUP)],replacement:i=>[i,i]},{name:"Unreachable Code - 0 &b IF",pattern:[S(0),m,h(a.IF)],replacement:()=>[]},{name:"Flows-Of-Control Optimizations - !0 &b IF",pattern:[Q,m,h(a.IF)],replacement:(i,n,e)=>[{op:u.call,value:n.value,meta:{name:n.meta?.name?.replace(/^&/,"")}}]},{name:"Null Sequence - 0 eval",pattern:[S(0),h(a.CALL)],replacement:()=>[]},{name:"Empty List - [ ]",pattern:[h(a.BRA),h(a.KET)],replacement:()=>[{op:u.push,value:0n,meta:{pointer:!0,name:"0"}}]},{name:"a q< b a> - b a",pattern:[m,h(a.PUSHR),m,h(a.PULLR)],replacement:(i,n,e)=>[e,i]}];class Bn{constructor(){this.stats={pre_optimization_ir_size:0,post_optimization_ir_size:0,user_defined_anon_defs:0,user_defined_named_defs:0,post_optimization_user_defs:0,inlined_calls:0,peephole_optimizations:0,optimization_passes:0},this.minOptPasses=2,this.maxOptPasses=20,this.defs=new Map,this.calledWords=new Set,this.optimized=[],this.nextAnonOp=x+1}optimize(n){this.reset(),this.stats.pre_optimization_ir_size=n.length,this.optimized=n;let e;do e=this.optimized.length,this.optLoop();while((this.optimized.length<e||this.stats.optimization_passes<this.minOptPasses)&&this.stats.optimization_passes<this.maxOptPasses);return this.optimized=this.pullDefs(this.optimized),this.optimized=this.addReferencedWords(this.optimized),this.stats.post_optimization_ir_size=this.optimized.length,this.optimized}optLoop(){this.optimized=this.peepholeOptimization(this.optimized),this.optimized=this.getDefs(this.optimized),this.optimized=this.inlineWords(this.optimized,4),this.stats.optimization_passes++}reset(){this.optimized=[],this.defs=new Map,this.calledWords=new Set,this.stats={pre_optimization_ir_size:0,post_optimization_ir_size:0,user_defined_anon_defs:0,user_defined_named_defs:0,post_optimization_user_defs:0,inlined_calls:0,peephole_optimizations:0,optimization_passes:0}}getDefs(n){let e=0;for(;e<n.length;){const t=n[e];if(t.op===u.call){if(t.value===V){this.stats.optimization_passes===0&&this.stats.user_defined_anon_defs++,t.meta??={},t.meta.uid??=this.nextAnonOp++;let s=e;for(;s-- >0;){const l=n[s];if(l.op===u.call&&l.value===K)break}const r=BigInt(t.meta.uid),o={op:u.push,value:r,meta:{pointer:!0}},p=n.slice(s,e+1);p.unshift(o),p[1]={...p[1],value:R,meta:{...p[1].meta,name:":"}},p[p.length-1]={...p[p.length-1],value:C,meta:{...p[p.length-1].meta,name:";"}},this.defs.set(r,p)}else if(t.value===C){this.stats.optimization_passes===0&&this.stats.user_defined_named_defs++;let s=e;for(;s-- >0;){const p=n[s];if(p.op===u.call&&p.value===R)break}const r=n[s-1];r.meta||={},r.meta.pointer=!0;const o=n.slice(s-1,e+1);this.defs.set(r.value,o)}}e++}return n}pullDefs(n,e=!1){const t=n.slice();let s=0;for(;s<t.length;){const r=t[s];if(r.op===u.call){if(r.value===V){r.meta??={},r.meta.uid??=this.nextAnonOp++;const o=s;for(;s-- >0;){const d=t[s];if(d.op===u.call&&d.value===K)break}const p=BigInt(r.meta.uid),l={op:u.push,value:p,meta:{pointer:!0}},c=t.splice(s,o-s+1,l);c.unshift(l),c[1]={...c[1],value:R,meta:{...c[1].meta,name:":"}},c[c.length-1]={...c[c.length-1],value:C,meta:{...c[c.length-1].meta,name:";"}},this.defs.set(p,c)}else if(r.value===C&&!e){const o=s;for(;s-- >0;){const c=t[s];if(c.op===u.call&&c.value===R)break}const p=t[s-1];p.meta||={},p.meta.pointer=!0;const l=t.splice(s-1,o-s+2);s=s-2,this.defs.set(l[0].value,l)}}s++}return t}peepholeOptimization(n){const e=n.slice();for(;;){const t=this.stats.peephole_optimizations;let s=0;for(;s<e.length;){for(const r of Rn){const{pattern:o,replacement:p}=r;if(s+o.length>e.length)continue;if(o.every((c,d)=>c(e[s+d]))){this.stats.peephole_optimizations++;const c=e.slice(s,s+o.length);e.splice(s,o.length,...p(...c)),s=Math.max(0,s-o.length-1);break}}s++}if(this.stats.peephole_optimizations===t)break}return e}inlineWords(n,e=1,t=[]){return n.flatMap(s=>{if(s.meta?.unsafe)return s;if(s.op===u.call&&this.defs.has(s.value)){if(t.includes(s.value))return s;const r=this.defs.get(s.value);if(!r)return s;const o=r[r.length-1];if(o.meta?.unsafe)return s;if(o.meta?.inline||s.meta?.inline)return this.stats.inlined_calls++,this.inlineWords(r.slice(2,-1),1/0,t.concat(s.value));if(r.length<=e+3)return this.stats.inlined_calls++,this.inlineWords(r.slice(2,-1),e,t.concat(s.value))}return s})}addReferencedWords(n){return n.slice().forEach(e=>{e.op===u.push&&e.meta?.pointer?this.addDef(e.value):e.op===u.call&&this.addDef(e.value)}),n}addDef(n){if(!this.calledWords.has(n)){const e=this.defs.get(n);if(e)return this.stats.post_optimization_user_defs++,this.calledWords.add(n),this.optimized.unshift(...e),this.addReferencedWords(e)}}}class w{constructor(n,e,t){this.imported=new Set,this.importPrefixes=new Map,this.macroPreludeReady=!1,this.rootFilename=null,this.host=n,this.engine=e.engine,this.compiler=e.compiler||new g,t?.macroEngineBootstrapFile&&this.bootstrapMacroEngine(t.macroEngineBootstrapFile)}static tokenize(n){return n.split(/[\r\n]+/)}preprocess(n,e="-"){const t=this.rootFilename===null;t&&e!=="-"&&(this.rootFilename=e);try{return this.preprocessLines(n,e)}finally{t&&(this.rootFilename=null)}}preprocessLines(n,e,t){return n.map(s=>{if(s.length>1&&s[0]==="."){const[r,...o]=s.split(" ");if(r[0]==="."&&r.length>1){switch(r){case".exit":if(this.host.exit){this.host.exit();break}throw new Error("Preprocessor: .exit requires a host exit handler");case".load":{const p=this.findFile(o.join(" "),e),l=this.host.readTextFile(p);return this.preprocessLines(w.tokenize(l),p)}case".import":{const p=this.findFile(o.join(" "),e);if(!this.imported.has(p)){this.imported.add(p);const l=this.host.readTextFile(p);return this.preprocessLines(w.tokenize(l),p,p)}return""}case".m":return this.runMacro(o.join(" "),s);case".ff":return this.runMacro(o.join(" "),s);case".ffp":{if(!this.macroPreludeReady)throw new Error("Preprocessor: .ffp requires prelude-enabled macro context");return this.runMacro(o.join(" "),s)}}return""}}return t?this.mangleImportedLine(s,t):s}).join(`
`)}findFile(n,e="-"){if(e&&e!=="-"&&!this.host.path.isAbsolute(n)){const t=this.host.path.dirname(e),s=this.host.path.resolve(t,n);if(this.host.fileExists(s))return s}if(this.host.fileExists(n))return n;throw'File not found: "'+n+'"'}bootstrapMacroEngine(n){const e=this.findFile(n),t=this.host.readTextFile(e),r=new w(this.host,{engine:this.engine,compiler:this.compiler}).preprocess(w.tokenize(t),e),o=this.compiler.compileToIR(g.tokenize(r),e);this.engine.loadIR(o),this.engine.run(),this.engine.clear(),this.macroPreludeReady=!0}runMacro(n,e){const t=this.compiler.compileToIR(g.tokenize(n));this.engine.loadIR(t),this.engine.run();const s=this.engine.getStack();return this.engine.clear(),s.map(String).join(" ")+` /* ${e} */`}mangleImportedLine(n,e){const t=this.getImportPrefix(e);return n.split(/(\s+)/).map(s=>!s||/\s+/.test(s)?s:this.mangleImportedToken(s,t)).join("")}mangleImportedToken(n,e){return n.startsWith("[__")?`[${e}${n.slice(3)}`:n.startsWith("__")?`${e}${n.slice(2)}`:n}getImportPrefix(n){const e=this.importPrefixes.get(n);if(e)return e;const s=this.getNormalizedImportPath(n).replace(/[^A-Za-z0-9]+/g,"_").replace(/^_+|_+$/g,"").replace(/_+/g,"_")||"module",r=this.hashPath(n),o=`__${s}_${r}__`;return this.importPrefixes.set(n,o),o}getNormalizedImportPath(n){if(this.rootFilename&&this.rootFilename!=="-"){const e=this.host.path.dirname(this.rootFilename),t=this.host.path.relative(e,n);if(t)return t.replace(/\\/g,"/")}return n.replace(/\\/g,"/")}hashPath(n){let e=2166136261;for(let t=0;t<n.length;t++)e^=n.charCodeAt(t),e=Math.imul(e,16777619)>>>0;return e.toString(36)}}var Dn=`.import ../lib/prelude.ffp
...
/* 5537376230 */`,Mn=`.import ../lib/prelude.ffp
...
over ++
step
drop drop . /* 837799 */`,Nn=`.import ../lib/prelude.ffp

/* http://projecteuler.net/index.php?section=problems&id=16 */

digits: dup [ 10 [ % ] [ / ] bi2 digits ] ? ;

2 1000 ^ digits sum! . /* 1366 */`,Ln=`!: dup 1 > [ dup 1 - ! * ] ? trim ;
...
/* Omitted: 1_000_000_000_000 ! … (expected [ 16576 ]) — factorial(10^12) is not practical here. */`,Fn=`.import ../lib/prelude.ffp
...
0 1 1 r drop drop ++ . /* 4782 */`,jn=`.import ../lib/prelude.ffp
...
600851475143 factors last! . /* 6857 */`,Wn=`.import ../lib/prelude.ffp
...
/* 9110846700 */`,Kn=`.import ../lib/prelude.ffp
...
half_pi:
  npi 1 >>
; /* n half_pi == floor(10ⁿ*π/2) */`,he=`.import ../core/core.ff
.import ./arith.ffp
...
nfrac: [ abs ] dip n->S % ; /* x n nfrac == (x - floor(x/10^n))*10^n */`,_e=`.import ../core/core.ff
...
.import ./string/string.ffp
.import ./seq/seq.ffp
.import ./time/time.ffp`,we=`.import ../core/core.ff
...
`,qe=`.import char.ffp
.import str.ffp`,ke=`.import ./core/core.ff
.import ./string/string.ffp
...
/* 93326215443944152681699238856266700490715968264381621468592963895217599993229915608941463976156518286253697920827223758251185210916864000000000000000000000000 */`,Pe=`.import ./lib/math/cbrt.ffp
...
50 pi-digits .
`;const De=new Set(["../../../ff/euler/euler4.ffp","../../../ff/euler/euler10.ffp","../../../ff/euler/euler14.ffp","../../../ff/euler/euler46.ffp"]);function ze(i){const n="/ff/lib/",e=i.indexOf(n);if(e===-1)throw new Error(`Unexpected library source path: ${i}`);return`/lib/${i.slice(e+n.length)}`}const Oe=Object.assign({"../../../ff/euler/euler1.ffp":Dn,"../../../ff/euler/euler10.ffp":zn,"../../../ff/euler/euler13.ffp":On,"../../../ff/euler/euler14.ffp":Mn,"../../../ff/euler/euler16.ffp":Nn,"../../../ff/euler/euler160.ffp":Ln,"../../../ff/euler/euler2.ffp":Fn,"../../../ff/euler/euler20.ffp":Un,"../../../ff/euler/euler25.ffp":$n,"../../../ff/euler/euler3.ffp":jn,"../../../ff/euler/euler4.ffp":Wn,"../../../ff/euler/euler46.ffp":Hn,"../../../ff/euler/euler48.ffp":Vn,"../../../ff/euler/euler5.ffp":Kn,"../../../ff/euler/euler6.ffp":Qn,"../../../ff/euler/euler7.ffp":Gn,"../../../ff/euler/euler8.ffp":Xn,"../../../ff/euler/euler9.ffp":Yn});function G(i){const n=i.split("/").pop()??i,e=/^euler(\d+)\.ffp$/.exec(n);return e?[Number(e[1]),n]:[Number.POSITIVE_INFINITY,n]}const Me=Object.entries(Oe).filter(([i])=>!De.has(i)).sort((i,n)=>{const e=G(i[0]),t=G(n[0]);return e[0]!==t[0]?e[0]-t[0]:e[1].localeCompare(t[1])}).map(([i,n])=>({path:Ne(i),label:Le(i),source:n}));function Ne(i){const n=i.lastIndexOf("/");return`/examples/${n>=0?i.slice(n+1):i}`}function Le(i){const n="/ff/",e=i.indexOf(n);return e>=0?i.slice(e+n.length):i}const Fe=[{path:"/examples/fact.ffp",label:"fact.ffp",source:Ae},{path:"/examples/cbrt.ffp",label:"cbrt.ffp",source:Pe},{path:"/examples/sqrt.ffp",label:"sqrt.ffp",source:Ie},{path:"/examples/gcd.ffp",label:"gcd.ffp",source:Ce},{path:"/examples/ack.ffp",label:"ack.ffp",source:Re},{path:"/examples/pi.ffp",label:"pi.ffp",source:Be},...Me],Ue=Object.fromEntries(Object.entries(Object.assign({"../../../ff/lib/core/core.ff":Zn,"../../../ff/lib/math/ack.ffp":Jn,"../../../ff/lib/math/arith.ffp":ne,"../../../ff/lib/math/atan-core.ffp":ee,"../../../ff/lib/math/atan-shared.ffp":te,"../../../ff/lib/math/atan.ffp":se,"../../../ff/lib/math/atanh-core.ffp":ie,"../../../ff/lib/math/atanh.ffp":re,"../../../ff/lib/math/cbrt.ffp":ae,"../../../ff/lib/math/exp.ffp":oe,"../../../ff/lib/math/gcd.ffp":pe,"../../../ff/lib/math/log.ffp":ce,"../../../ff/lib/math/math.ffp":le,"../../../ff/lib/math/num.ffp":de,"../../../ff/lib/math/pi.ffp":ue,"../../../ff/lib/math/precision.ffp":he,"../../../ff/lib/math/pred.ffp":_e,"../../../ff/lib/math/primes.ffp":fe,"../../../ff/lib/math/prn.ffp":me,"../../../ff/lib/math/sqrt.ffp":ge,"../../../ff/lib/math/trig.ffp":be,"../../../ff/lib/prelude.ffp":ve,"../../../ff/lib/seq/seq.ffp":we,"../../../ff/lib/string/char.ffp":ye,"../../../ff/lib/string/str.ffp":xe,"../../../ff/lib/string/string.ffp":qe,"../../../ff/lib/tap.ffp":ke,"../../../ff/lib/testing.ffp":Se,"../../../ff/lib/time/time.ffp":Ee,"../../../ff/lib/time/utc.ffp":Te})).map(([i,n])=>[ze(i),n])),$e=Object.fromEntries(Fe.map(({path:i,source:n})=>[i,n]));function je(i,n="/main.ffp"){return{[n]:i,...Ue,...$e}}function E(i){const n=i.startsWith("/"),e=i.split("/").filter(Boolean),t=[];for(const s of e)if(s!=="."){if(s===".."){t.pop();continue}t.push(s)}return`${n?"/":""}${t.join("/")}`||(n?"/":".")}function We(i){const n=E(i),e=n.lastIndexOf("/");return e<=0?n.startsWith("/")?"/":".":n.slice(0,e)}function He(...i){const n=i.filter(Boolean).join("/").replaceAll(/\/+/g,"/");return E(n)}function Ve(i,n){const e=E(i).split("/").filter(Boolean),t=E(n).split("/").filter(Boolean);let s=0;for(;s<e.length&&s<t.length&&e[s]===t[s];)s++;const r=e.length-s,o=t.slice(s);return Array(r).fill("..").concat(o).join("/")||"."}function Ke(i){return{readTextFile(n){const e=E(n),t=i[e];if(typeof t!="string")throw new Error(`Virtual file not found: ${e}`);return t},fileExists(n){return typeof i[E(n)]=="string"},path:{isAbsolute(n){return n.startsWith("/")},dirname:We,relative:Ve,resolve:He}}}function Qe(i={}){const n=new TextDecoder,e=new TextEncoder,t=Array.from(e.encode(i.stdin??""));return{io:{write(s){i.onWrite?.(n.decode(s))},readByte(){return t.shift()??null}},exit(s){i.onExit?.(s)},now(){return Date.now()}}}const Ge="/lib/prelude.ffp",Xe="/main.ffp";function Ye(i){return Tn.length+i.length}function X(i,n){const e=console.log;console.log=(...t)=>{i(t.map(String).join(" "))};try{return n()}finally{console.log=e}}async function Ze(i,n){const e=console.log;console.log=(...t)=>{i(t.map(String).join(" "))};try{return await n()}finally{console.log=e}}function Je(i,n,e={}){let t="";const s=[];let r=0;const o=e.filename??Xe,p=Qe({stdin:n,onWrite(A){t+=A},onExit(A){r=A}}),l=new g,c=new H(p),d=new g,_=new H(p),f=je(i,o),T=new w(Ke(f),{engine:_,compiler:d},{macroEngineBootstrapFile:Ge});return{compiler:l,engine:c,preprocessor:T,filename:o,logs:s,getOutput(){return t},getExitCode(){return r}}}function nt(i,n,e,t={}){const s=Je(i,n,t),r=performance.now(),o=X(l=>s.logs.push(l),()=>{const l=s.preprocessor.preprocess(w.tokenize(i),s.filename);let c=s.compiler.compileToIR(g.tokenize(l),s.filename);const d=s.compiler.validate(c);e&&(c=new Bn().optimize(c));const _=hn(c),f=g.compileToBase64(c),T=Ye(f);return s.engine.loadIR(c),{preprocessed:l,formattedIr:_,bytecode:f,compiledBytes:T,issues:d}}),p=performance.now();return{preprocessed:o.preprocessed,ir:o.formattedIr,bytecode:o.bytecode,compiledBytes:o.compiledBytes,issues:o.issues,compileMs:p-r,execute(){const l=performance.now();X(d=>s.logs.push(d),()=>{s.engine.run()});const c=performance.now();return{output:s.getOutput(),stack:s.engine.getStack().map(String),logs:[...s.logs],exitCode:s.getExitCode(),executeMs:c-l,cancelled:!1,vmCyclesExecuted:0}},async executeAsync(l={}){const c=performance.now(),d=await Ze(f=>s.logs.push(f),async()=>await s.engine.runAsync(l)),_=performance.now();return{output:s.getOutput(),stack:s.engine.getStack().map(String),logs:[...s.logs],exitCode:s.getExitCode(),executeMs:_-c,cancelled:d.cancelled,vmCyclesExecuted:d.vmCyclesExecuted}}}}function B(i){self.postMessage(i)}let M=!1,b=null;function et(i,n){const e=n.cancelled?"cancelled":"done";return{output:n.output,preprocessed:i.preprocessed,ir:i.ir,bytecode:i.bytecode,compiledBytes:i.compiledBytes,issues:i.issues,stack:n.stack,logs:n.logs,exitCode:n.exitCode,compileMs:i.compileMs,executeMs:n.executeMs,terminal:e,vmCyclesExecuted:n.vmCyclesExecuted}}self.onmessage=i=>{const n=i.data;if(n.type==="CANCEL"){b===n.runId&&(M=!0);return}if(n.type!=="RUN")return;const{runId:e,source:t,stdin:s,optimize:r,filename:o,yieldIntervalMs:p,yieldSliceMax:l}=n;(async()=>{M=!1,b=e;try{const c=nt(t,s,r,{filename:o});if(b!==e)return;B({type:"COMPILED",runId:e,compileMs:c.compileMs,preprocessed:c.preprocessed,ir:c.ir,bytecode:c.bytecode,compiledBytes:c.compiledBytes});const d=performance.now(),_=await c.executeAsync({yieldIntervalMs:p,yieldSliceMax:l,shouldContinue:()=>!M&&b===e,onChunk:({vmCyclesExecuted:f})=>{b===e&&B({type:"PROGRESS",runId:e,vmCyclesExecuted:f,executeElapsedMs:performance.now()-d})},scheduler:()=>new Promise(f=>{globalThis.setTimeout(f,0)})});if(b!==e)return;B({type:"RESULT",runId:e,result:et(c,_)})}catch(c){if(b!==e)return;const d=c instanceof Error?c.message:String(c);B({type:"ERROR",runId:e,message:d})}finally{b===e&&(b=null)}})()}})();
