import{R as P}from"./run-feedback.Ug3xFfrM.js";const rt=globalThis,ht=i=>i,G=rt.trustedTypes,ut=G?G.createPolicy("lit-html",{createHTML:i=>i}):void 0,wt="$lit$",x=`lit$${Math.random().toFixed(9).slice(2)}$`,At="?"+x,Dt=`<${At}>`,$=document,H=()=>$.createComment(""),U=i=>i===null||typeof i!="object"&&typeof i!="function",ot=Array.isArray,Rt=i=>ot(i)||typeof i?.[Symbol.iterator]=="function",Z=`[ 	
\f\r]`,F=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,dt=/-->/g,_t=/>/g,T=RegExp(`>|${Z}(?:([^\\s"'>=/]+)(${Z}*=${Z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ft=/'/g,mt=/"/g,xt=/^(?:script|style|textarea|title)$/i,Nt=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),ze=Nt(1),W=Symbol.for("lit-noChange"),v=Symbol.for("lit-nothing"),gt=new WeakMap,E=$.createTreeWalker($,129);function St(i,t){if(!ot(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return ut!==void 0?ut.createHTML(t):t}const Ot=(i,t)=>{const e=i.length-1,n=[];let s,a=t===2?"<svg>":t===3?"<math>":"",r=F;for(let p=0;p<e;p++){const c=i[p];let l,h,_=-1,m=0;for(;m<c.length&&(r.lastIndex=m,h=r.exec(c),h!==null);)m=r.lastIndex,r===F?h[1]==="!--"?r=dt:h[1]!==void 0?r=_t:h[2]!==void 0?(xt.test(h[2])&&(s=RegExp("</"+h[2],"g")),r=T):h[3]!==void 0&&(r=T):r===T?h[0]===">"?(r=s??F,_=-1):h[1]===void 0?_=-2:(_=r.lastIndex-h[2].length,l=h[1],r=h[3]===void 0?T:h[3]==='"'?mt:ft):r===mt||r===ft?r=T:r===dt||r===_t?r=F:(r=T,s=void 0);const g=r===T&&i[p+1].startsWith("/>")?" ":"";a+=r===F?c+Dt:_>=0?(n.push(l),c.slice(0,_)+wt+c.slice(_)+x+g):c+x+(_===-2?p:g)}return[St(i,a+(i[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),n]};class K{constructor({strings:t,_$litType$:e},n){let s;this.parts=[];let a=0,r=0;const p=t.length-1,c=this.parts,[l,h]=Ot(t,e);if(this.el=K.createElement(l,n),E.currentNode=this.el.content,e===2||e===3){const _=this.el.content.firstChild;_.replaceWith(..._.childNodes)}for(;(s=E.nextNode())!==null&&c.length<p;){if(s.nodeType===1){if(s.hasAttributes())for(const _ of s.getAttributeNames())if(_.endsWith(wt)){const m=h[r++],g=s.getAttribute(_).split(x),b=/([.?@])?(.*)/.exec(m);c.push({type:1,index:a,name:b[2],strings:g,ctor:b[1]==="."?Ft:b[1]==="?"?Mt:b[1]==="@"?Lt:Y}),s.removeAttribute(_)}else _.startsWith(x)&&(c.push({type:6,index:a}),s.removeAttribute(_));if(xt.test(s.tagName)){const _=s.textContent.split(x),m=_.length-1;if(m>0){s.textContent=G?G.emptyScript:"";for(let g=0;g<m;g++)s.append(_[g],H()),E.nextNode(),c.push({type:2,index:++a});s.append(_[m],H())}}}else if(s.nodeType===8)if(s.data===At)c.push({type:2,index:a});else{let _=-1;for(;(_=s.data.indexOf(x,_+1))!==-1;)c.push({type:7,index:a}),_+=x.length-1}a++}}static createElement(t,e){const n=$.createElement("template");return n.innerHTML=t,n}}function N(i,t,e=i,n){if(t===W)return t;let s=n!==void 0?e._$Co?.[n]:e._$Cl;const a=U(t)?void 0:t._$litDirective$;return s?.constructor!==a&&(s?._$AO?.(!1),a===void 0?s=void 0:(s=new a(i),s._$AT(i,e,n)),n!==void 0?(e._$Co??=[])[n]=s:e._$Cl=s),s!==void 0&&(t=N(i,s._$AS(i,t.values),s,n)),t}class Bt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:n}=this._$AD,s=(t?.creationScope??$).importNode(e,!0);E.currentNode=s;let a=E.nextNode(),r=0,p=0,c=n[0];for(;c!==void 0;){if(r===c.index){let l;c.type===2?l=new V(a,a.nextSibling,this,t):c.type===1?l=new c.ctor(a,c.name,c.strings,this,t):c.type===6&&(l=new zt(a,this,t)),this._$AV.push(l),c=n[++p]}r!==c?.index&&(a=E.nextNode(),r++)}return E.currentNode=$,s}p(t){let e=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(t,n,e),e+=n.strings.length-2):n._$AI(t[e])),e++}}class V{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,n,s){this.type=2,this._$AH=v,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=N(this,t,e),U(t)?t===v||t==null||t===""?(this._$AH!==v&&this._$AR(),this._$AH=v):t!==this._$AH&&t!==W&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Rt(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==v&&U(this._$AH)?this._$AA.nextSibling.data=t:this.T($.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:n}=t,s=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=K.createElement(St(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(e);else{const a=new Bt(s,this),r=a.u(this.options);a.p(e),this.T(r),this._$AH=a}}_$AC(t){let e=gt.get(t.strings);return e===void 0&&gt.set(t.strings,e=new K(t)),e}k(t){ot(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let n,s=0;for(const a of t)s===e.length?e.push(n=new V(this.O(H()),this.O(H()),this,this.options)):n=e[s],n._$AI(a),s++;s<e.length&&(this._$AR(n&&n._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const n=ht(t).nextSibling;ht(t).remove(),t=n}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class Y{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,n,s,a){this.type=1,this._$AH=v,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=a,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=v}_$AI(t,e=this,n,s){const a=this.strings;let r=!1;if(a===void 0)t=N(this,t,e,0),r=!U(t)||t!==this._$AH&&t!==W,r&&(this._$AH=t);else{const p=t;let c,l;for(t=a[0],c=0;c<a.length-1;c++)l=N(this,p[n+c],e,c),l===W&&(l=this._$AH[c]),r||=!U(l)||l!==this._$AH[c],l===v?t=v:t!==v&&(t+=(l??"")+a[c+1]),this._$AH[c]=l}r&&!s&&this.j(t)}j(t){t===v?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Ft extends Y{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===v?void 0:t}}class Mt extends Y{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==v)}}class Lt extends Y{constructor(t,e,n,s,a){super(t,e,n,s,a),this.type=5}_$AI(t,e=this){if((t=N(this,t,e,0)??v)===W)return;const n=this._$AH,s=t===v&&n!==v||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,a=t!==v&&(n===v||s);s&&this.element.removeEventListener(this.name,this,n),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class zt{constructor(t,e,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){N(this,t)}}const Ht=rt.litHtmlPolyfillSupport;Ht?.(K,V),(rt.litHtmlVersions??=[]).push("3.3.2");const He=(i,t,e)=>{const n=t;let s=n._$litPart$;return s===void 0&&(n._$litPart$=s=new V(t.insertBefore(H(),null),null,void 0,{})),s._$AI(i),s};let vt=null;function Ut(){return vt??=new AudioContext,vt}const bt=[329.6275569128699,391.99543598174927,493.8833013781249],Wt=10,Kt=420,Vt=3;let j=null,Q=null,et=!1;function nt(){j!==null&&(clearInterval(j),j=null),Q=null}function Ue(i){if(nt(),!P.enabled||(et=!0,window.matchMedia("(prefers-reduced-motion: reduce)").matches))return;Q=i;const t=()=>{if(!P.enabled){nt();return}Q&&Qt(Q,Vt)};t(),j=setInterval(t,Kt)}function We(){const i=et;et=!1,nt(),i&&kt()}function kt(){if(P.enabled)try{const i=Ut();i.resume().then(()=>{const t=i.currentTime,e=.42,n=.09;for(let s=0;s<bt.length;s++){const a=bt[s],r=i.createOscillator(),p=i.createGain();r.type="triangle",r.frequency.setValueAtTime(a,t),p.gain.setValueAtTime(0,t),p.gain.linearRampToValueAtTime(n,t+.018+s*.012),p.gain.exponentialRampToValueAtTime(8e-4,t+e),r.connect(p),p.connect(i.destination),r.start(t),r.stop(t+e+.06)}})}catch{}}function Tt(i){return!(i.isComposing||i.metaKey||i.ctrlKey||i.altKey||i.key==="Tab"||i.key==="Escape"||i.key==="ArrowUp"||i.key==="ArrowDown"||i.repeat)}function Ke(i,t){if(!P.enabled||i.disabled||!Tt(t))return;const{x:e,y:n}=jt(i);pt(e,n,{centerOnPoint:!0}),t.key==="Enter"&&kt()}function Ve(i,t){if(!P.enabled||!Tt(t))return;const e=i.state.selection.main.head,n=i.coordsAtPos(e);if(!n)return;const s=n.left,a=(n.top+n.bottom)/2;pt(s,a,{centerOnPoint:!0})}function jt(i){const t=i.getBoundingClientRect(),e=window.getComputedStyle(i),n=parseFloat(e.borderLeftWidth)||0,s=parseFloat(e.paddingLeft)||0,a=i.selectionStart??0,r=document.createElement("span");r.setAttribute("aria-hidden","true"),r.style.visibility="hidden",r.style.position="absolute",r.style.whiteSpace="pre",r.style.top="0",r.style.left="0",r.style.font=e.font,r.style.fontSize=e.fontSize,r.style.fontFamily=e.fontFamily,r.style.fontWeight=e.fontWeight,r.style.letterSpacing=e.letterSpacing,r.style.fontVariant=e.fontVariant,r.style.textTransform=e.textTransform,r.textContent=i.value.slice(0,a),document.body.appendChild(r);const p=r.offsetWidth;r.remove();const c=t.left+n+s+p-i.scrollLeft,l=t.top+t.height/2;return{x:c,y:l}}function pt(i,t,e){if(!P.enabled||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const n=document.createElement("span");n.className="run-flat-anchor",n.style.left=`${i}px`,n.style.top=`${t}px`,e?.centerOnPoint&&(n.style.transform="translate(-50%, -50%)");const s=document.createElement("span");s.className="run-flat-particle",s.setAttribute("aria-hidden","true"),s.textContent="♭",e?.animationDelay&&(s.style.animationDelay=e.animationDelay);const a=(Math.random()-.5)*2.25,r=-6+Math.random()*12,p=r+8+Math.random()*10;s.style.setProperty("--drift-x",`${a}rem`),s.style.setProperty("--rot-0",`${r}deg`),s.style.setProperty("--rot-1",`${p}deg`),n.appendChild(s),document.body.appendChild(n),s.addEventListener("animationend",()=>{n.remove()},{once:!0})}function Qt(i,t=Wt){if(!P.enabled||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const e=i.getBoundingClientRect();if(!(e.width<=0||e.height<=0))for(let n=0;n<t;n++){const s=e.left+Math.random()*e.width,a=e.top+e.height*(.35+Math.random()*.35);pt(s,a,{animationDelay:`${n*.045}s`})}}function Gt(){return!!(globalThis.Deno?.stdout?.isTerminal?.()??globalThis.process?.stdout?.isTTY??!1)}function ct(i,t){return Gt()?`\x1B[${i}m${t}\x1B[0m`:t}function Yt(i){return ct(34,i)}function Xt(i){return ct(32,i)}function A(i){return ct(36,i)}const o={NOP:0,CALL:1,PUTC:2,GETC:3,PUTN:5,CLOCK:6,DROP:8,PUSHR:14,PULLR:15,SHIFTL:16,SHIFTR:17,CLR:24,RAND:26,EXIT:27,DUP:33,DEPTH:35,SWAP:36,MOD:37,AND:38,STASH:40,FETCH:41,MUL:42,ADD:43,CONS:44,SUB:45,PRN:46,DIV:47,MARK:58,DEF:59,LT:60,EQ:61,GT:62,IF:63,BRA:91,KET:93,POW:94,OR:124,NOT:126},O={nop:o.NOP,eval:o.CALL,";":o.DEF,":":o.MARK,clr:o.CLR,rand:o.RAND,exit:o.EXIT,".":o.PRN,putc:o.PUTC,getc:o.GETC,putn:o.PUTN,clock:o.CLOCK,drop:o.DROP,swap:o.SWAP,dup:o.DUP,"<<":o.SHIFTL,">>":o.SHIFTR,"+":o.ADD,"-":o.SUB,cons:o.CONS,"*":o.MUL,"/":o.DIV,"<":o.LT,"=":o.EQ,">":o.GT,"?":o.IF,"%":o.MOD,"&":o.AND,"(":o.STASH,")":o.FETCH,"q<":o.PUSHR,"q>":o.PULLR,depth:o.DEPTH,"^":o.POW,"[":o.BRA,"]":o.KET,"|":o.OR,"~":o.NOT},w=255,q=w+1,Zt=i=>i,Jt=i=>i,u={call:"call",push:"push"},te=6,st=10,ee=new Map([[BigInt(o.MARK),":"],[BigInt(o.DEF),";"],[BigInt(o.BRA),"["],[BigInt(o.KET),"]"]]);function ne(i){return(""+i.value).padEnd(st," ")}function se(i,t){return t?t.padEnd(st," "):i.op===u.push&&i.meta?.pointer?`[${i.value}]`.padEnd(st," "):ne(i)}function ie(i){return i.trim()?`/* ${i} */`:""}function ae(i){const t=oe(i)?.toUpperCase()||"",e=i.op===u.call?ee.get(i.value):void 0,n=e!==void 0,s=se(i,e),a=i.meta?.comment?.trim()||(i.op===u.call&&!n?t:""),r=(i.op===u.call&&!e?"EVAL":"").padEnd(te," ");return[Jt(s),Zt(r),ie(a)].join(" ")}function re(i){for(const t in O)if(O[t]===i)return t;return""}function oe(i){if(i.op===u.call||i.op===u.push&&i.meta?.pointer)return i.meta?.name||re(Number(i.value))||""}function je(i){return i.map(ae).join(`
`)}function pe(i){return i=i.replace(/\\U([A-Fa-f0-9]{8})/g,(t,e)=>yt(e)),i=i.replace(/\\u([A-Fa-f0-9]{4})/g,(t,e)=>yt(e)),i.replace(/\\0/g,"\0").replace(/\\b/g,"\b").replace(/\\t/g,"	").replace(/\\n/g,`
`).replace(/\\v/g,"\v").replace(/\\f/g,"\f").replace(/\\r/g,"\r").replace(/\\'/g,"'").replace(/\\"/g,'"').replace(/\\s/g," ").replace(/\\\\/g,"\\")}function yt(i){let t="",e=parseInt(i,16);return e<=65535?t+=String.fromCharCode(e):e<=1114111?(e-=65536,t+=String.fromCharCode(55296|e>>10)+String.fromCharCode(56320|e&1023)):t+=`hex2Char error: Code point out of range: ${ce(e)}`,t}function ce(i){return(i+0).toString(16).toUpperCase()}const qt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",Et=new Map;qt.split("").forEach(function(i,t){Et.set(i,t)});const le=5n,Pt=1n<<le,$t=Number(Pt),Ct=Pt-1n;function he(i){return i.map(fe).map(me).join("")}function ue(i){return ve(ge(i)).map(be)}function de(i){return i>=0n?i<<1n:(-i<<1n)+1n}function _e(i){return i&1n?-(i>>1n):i>>1n}function fe(i){if(i===0n)return[0];i=de(i);const t=[];for(;i>0;){let e=Number(i&Ct);i>>=5n,i>0&&(e|=$t),t.push(e)}return t}function me(i){return i.map(t=>qt[t]).join("")}function ge(i){return i.split("").map(t=>{const e=Et.get(t);if(e===void 0)throw new Error(`${i} is not a valid base64 encoded VLQ`);return e})}function ve(i){const t=[];let e=[];if(i.forEach(n=>{e.push(n),(n&$t)===0&&(t.push(e),e=[])}),e.length>0)throw new Error("Malformed VLQ sequence: The last VLQ never ended.");return t}function be(i){const t=i.reverse().reduce((e,n)=>(e<<=5n,e|=BigInt(n)&Ct,e),0n);return _e(t)}const ye="/*",we="*/";function J(i){if(!(i==="-"||i==="+"))try{let t=1n;return i=i.replaceAll("_",""),i.startsWith("-0")&&(t=-1n,i=i.replace("-","")),i.includes("e")||i.includes("E")?t*BigInt(+i):t*BigInt(i)}catch{return}}class R{constructor(t={}){this.symbols=new Map,this._nextCode=-1,this.host=t;let e;for(e in O)this.symbols.set(e,BigInt(O[e]))}static tokenize(t){return t.split(/\s+/).filter(Boolean).map(e=>{const n=J(e);return n!==void 0?n:e})}static tokenizeWithSpans(t){const e=[],n=/\S+/g;let s=0,a=0,r=0;const p=l=>{for(;r<l;){const h=t[r];h==="\r"?(t[r+1]===`
`&&r++,s++,a=0):h===`
`?(s++,a=0):a++,r++}};let c;for(;(c=n.exec(t))!==null;){const l=c.index;p(l);const h=c[0]??"",_=J(h);e.push({raw:h,value:_!==void 0?_:h,line:s,character:a,length:h.length,offset:l}),p(l+h.length)}return e}static compileToBase64(t){const e=t.flatMap(n=>{if(n.op===u.call&&n.value===0n)return[];const s=n.value<<1n;return[n.op===u.push?s:s|1n]});return he(e)}nextCode(){return BigInt(this._nextCode--)}getSymbol(t){t=t.toLowerCase();let e=this.symbols.get(t);return e===void 0&&(e=this.nextCode(),this.symbols.set(t,e)),e}compileToIR(t,e=""){let n=0;const s=t.length;let a="";const r=[];let p;for(;n<s;)if(p=t[n++],a=this.unwrapTokenValue(p),typeof a=="bigint")c(a);else if(a.length>1&&a.startsWith(".")){const[h]=a.split(" ");switch(h){case".push":r[r.length-1].op=u.push;break;case".call":r[r.length-1].op=u.call;break;case".inline":r[r.length-1].meta||={},r[r.length-1].meta.inline=!0;break;case".unsafe":r[r.length-1].meta||={},r[r.length-1].meta.unsafe=!0;break;case".pointer":r[r.length-1].meta||={},r[r.length-1].meta.pointer=!0;break;case".exit":if(this.host.exit){this.host.exit();break}throw new Error("Compiler: .exit requires a host exit handler");case".symbols":this.symbols.forEach((_,m)=>{(this.host.log||console.log)(m,_)});break;case".words":{const _=Array.from(this.symbols,([m])=>m).join(" ");(this.host.log||console.log)(_);break}}}else if(a[0]==="'"&&a.length>1)pe(a).replace(/^'/,"").replace(/'$/,"").split("").forEach(h=>{c(h.charCodeAt(0),{comment:h})});else if(a.endsWith(":")&&a.length>1){const h=a.replace(/:$/,"");c(this.getSymbol(h),{name:`${h}`,pointer:!0}),l(o.MARK,{name:":"})}else if(a===ye){const h=p,_=[];for(;n<t.length&&(p=t[n++],a=this.unwrapTokenValue(p),a!==we);)_.push(a);l(0n,{comment:_.join(" ")},h)}else if(a.startsWith("[")&&a.endsWith("]")){const h=a.replace(/^\[/,"").replace(/\]$/,""),_=J(h);_!==void 0?c(_,{name:h,pointer:!0}):c(this.getSymbol(h),{name:h,pointer:!0})}else l(this.getSymbol(a),{name:a});return r;function c(h,_={},m=p){r.push({value:BigInt(h),op:u.push,meta:{..._,...R.toInstructionMeta(m,e)}})}function l(h,_={},m=p){r.push({value:BigInt(h),op:u.call,meta:{..._,...R.toInstructionMeta(m,e)}})}}unwrapTokenValue(t){return typeof t=="string"||typeof t=="bigint"?t:t.value}static toInstructionMeta(t,e){return!t||typeof t=="string"||typeof t=="bigint"?{filename:e}:{filename:e,line:t.line,character:t.character,length:t.length,offset:t.offset}}validate(t){const e=t.slice(),n=[];let s=0;for(;s<e.length;){const a=e[s];if(a.op===u.call&&a.value===BigInt(o.DEF)){let r=0;for(r=s;r>0&&!(e[r].op===u.call&&e[r].value===BigInt(o.MARK));r--);const p=e.splice(r-1,s-r+2);p.at(-1)?.meta?.unsafe||n.push(...this.validateDef(p)),s=r-1}s++}return n.push(...this.validateDef(e,"main")),n}validateDef(t,e){const n=[];let s=0,a=0,r=0,p=0;const c=[0];if(!t[0])return[];e=Xt(e||t[0].meta?.name?.replace(/^&/,"")||"main");const l=Yt(t[0].meta?.filename||"-");for(;s<t.length;){const h=t[s];if(h.op===u.call){if(h.op===u.call&&h.value===BigInt(o.MARK)&&a++,h.op===u.call&&h.value===BigInt(o.DEF)&&a--,h.op===u.call&&h.value===BigInt(o.BRA)&&(r++,c.push(0)),h.op===u.call&&h.value===BigInt(o.KET)&&(r--,(c.length>1?c.pop():0)!==0&&n.push(`${l}: Unbalanced queue push ( ${A("q< q>")} ) in quote in ${e}`)),h.op===u.call&&(h.value===BigInt(o.PUSHR)||h.value===BigInt(o.STASH))&&(p++,c[c.length-1]++),h.op===u.call&&(h.value===BigInt(o.PULLR)||h.value===BigInt(o.FETCH))){if(c[c.length-1]===0){const m=h.value===BigInt(o.FETCH)?")":"q>";n.push(`${l}: Queue borrow ( ${A(m)} ) requires ${A(".unsafe")} in ${e} (including quotes)`)}p--,c[c.length-1]--}r<0&&n.push(`${l}: Bracket ( ${A("[ ]")} ) mismatch in ${e}`),a<0&&n.push(`${l}: Definition ( ${A(": ;")} ) mismatch in ${e}`)}s++}return r!==0&&n.push(`${l}: Unbalanced brackets ( ${A("[ ]")} ) in ${e}`),p!==0&&n.push(`${l}: Unbalanced queue push ( ${A("q< q> ( )")} ) in ${e}`),a!==0&&n.push(`${l}: Unbalanced definition ( ${A(": ;")} ) in ${e}`),n}}const Ae=[{mnemonic:"NOP",syntax:"nop",stackEffect:"… nop == …",description:"No operation; does nothing.",opcode:0},{mnemonic:"EVAL",syntax:"eval",stackEffect:"[A] eval == a*",description:"Evaluates a quotation, executing its contents.",opcode:1},{mnemonic:"PUTC",syntax:"putc",stackEffect:"n putc == {prints char(n)}",description:"Prints a character given by its numeric code.",opcode:2},{mnemonic:"GETC",syntax:"getc",stackEffect:"getc == n {reads char}",description:"Reads a single character from input and pushes its code.",opcode:3},{mnemonic:"PUTN",syntax:"putn",stackEffect:"n putn == {prints n}",description:"Prints a number to output.",opcode:5},{mnemonic:"CLOCK",syntax:"clock",stackEffect:"clock == n {reads clock}",description:"Returns the current time as a Unix timestamp.",opcode:6},{mnemonic:"DROP",syntax:"drop",stackEffect:"a drop ==",description:"Removes the top value from the stack.",opcode:8},{mnemonic:"PUSHR",syntax:"q<",stackEffect:"a q< == | …a",description:"Pushes a value onto the return stack.",opcode:14},{mnemonic:"PULLR",syntax:"q>",stackEffect:"q> == a | a…",description:"Pops a value from the return stack onto the main stack.",opcode:15},{mnemonic:"SHIFTL",syntax:"<<",stackEffect:"a b << == n",description:"Left-shifts a by b bits.",opcode:16},{mnemonic:"SHIFTR",syntax:">>",stackEffect:"a b >> == n",description:"Right-shifts a by b bits.",opcode:17},{mnemonic:"CLR",syntax:"clr",stackEffect:"… clr ==",description:"Clears the entire stack.",opcode:24},{mnemonic:"RAND",syntax:"rand",stackEffect:"n rand == r {0 <= r < n}",description:"Generates a random number between 0 and n-1.",opcode:26},{mnemonic:"EXIT",syntax:"exit",stackEffect:"n exit == {exits with code n}",description:"Exits the program with the given exit code.",opcode:27},{mnemonic:"DUP",syntax:"dup",stackEffect:"a dup == a a",description:"Duplicates the top value on the stack.",opcode:33},{mnemonic:"DEPTH",syntax:"depth",stackEffect:"… depth == … n",description:"Pushes the current stack depth.",opcode:35},{mnemonic:"SWAP",syntax:"swap",stackEffect:"a b swap == b a",description:"Swaps the top two values on the stack.",opcode:36},{mnemonic:"MOD",syntax:"%",stackEffect:"a b % == n",description:"Computes the remainder of a divided by b.",opcode:37},{mnemonic:"AND",syntax:"&",stackEffect:"a b & == n",description:"Bitwise AND of a and b.",opcode:38},{mnemonic:"STASH",syntax:"(",stackEffect:"… ( == {moves stack to queue}",description:"Moves values from the stack to the queue.",opcode:40},{mnemonic:"FETCH",syntax:")",stackEffect:") == … {restores stack from queue}",description:"Moves values from the queue back to the stack.",opcode:41},{mnemonic:"MUL",syntax:"*",stackEffect:"a b * == n",description:"Multiplies a by b.",opcode:42},{mnemonic:"ADD",syntax:"+",stackEffect:"a b + == n",description:"Adds a and b together.",opcode:43},{mnemonic:"CONS",syntax:"cons",stackEffect:"x y cons == q",description:"Builds an anonymous quotation from two stack values (opcode also maps to `,`).",opcode:44},{mnemonic:"SUB",syntax:"-",stackEffect:"a b - == n",description:"Subtracts b from a.",opcode:45},{mnemonic:"DUMP",syntax:".",stackEffect:"… . == … {prints stack}",description:"Prints the entire stack to output.",opcode:46},{mnemonic:"DIV",syntax:"/",stackEffect:"a b / == n",description:"Divides a by b (integer division).",opcode:47},{mnemonic:"MARK",syntax:":",stackEffect:"n : == {begin definition(n)}",description:"Begins a new word definition with name n.",opcode:58},{mnemonic:"DEF",syntax:";",stackEffect:"; == {end definition}",description:"Ends the current word definition.",opcode:59},{mnemonic:"LT",syntax:"<",stackEffect:"a b < == flag",description:"Pushes true if a is less than b.",opcode:60},{mnemonic:"EQ",syntax:"=",stackEffect:"a b = == flag",description:"Pushes true if a equals b.",opcode:61},{mnemonic:"GT",syntax:">",stackEffect:"a b > == flag",description:"Pushes true if a is greater than b.",opcode:62},{mnemonic:"WHEN",syntax:"?",stackEffect:"flag [A] ? == a*",description:"Executes the quotation if flag is true.",opcode:63},{mnemonic:"BRA",syntax:"[",stackEffect:"[ == {begin quotation}",description:"Begins a quotation (anonymous code block).",opcode:91},{mnemonic:"KET",syntax:"]",stackEffect:"] == [A] {end quotation}",description:"Ends a quotation and pushes it to the stack.",opcode:93},{mnemonic:"POW",syntax:"^",stackEffect:"a b ^ == n",description:"Computes a raised to the power of b.",opcode:94},{mnemonic:"OR",syntax:"|",stackEffect:"a b | == n",description:"Bitwise OR of a and b.",opcode:124},{mnemonic:"NOT",syntax:"~",stackEffect:"a ~ == n'",description:"Bitwise NOT of a.",opcode:126}],xe={words:Ae},It=new Map;for(const i of xe.words)It.set(i.opcode,i);function Se(i){return It.get(i)}class ke{constructor(t=16){this.buffer=new Array(t),this.head=0,this.tail=0,this._length=0}get length(){return this._length}expand(){const t=this.buffer.length*2,e=new Array(t);if(this._length>0)if(this.head<this.tail)for(let n=0;n<this._length;n++)e[n]=this.buffer[this.head+n];else{const n=this.buffer.length-this.head;for(let s=0;s<n;s++)e[s]=this.buffer[this.head+s];for(let s=0;s<this.tail;s++)e[n+s]=this.buffer[s]}this.buffer=e,this.head=0,this.tail=this._length}push(...t){this.pushArray(t)}pushArray(t){for(let e=0;e<t.length;e++)this._length===this.buffer.length&&this.expand(),this.buffer[this.tail]=t[e],this.tail=(this.tail+1)%this.buffer.length,this._length++}unshift(...t){this.unshiftArray(t)}unshiftArray(t){for(;this._length+t.length>this.buffer.length;)this.expand();this.head=(this.head-t.length+this.buffer.length)%this.buffer.length;for(let e=0;e<t.length;e++)this.buffer[(this.head+e)%this.buffer.length]=t[e];this._length+=t.length}shift(){if(this._length===0)return;const t=this.buffer[this.head];return this.head=(this.head+1)%this.buffer.length,this._length--,t}pop(){if(this._length===0)return;this.tail=(this.tail-1+this.buffer.length)%this.buffer.length;const t=this.buffer[this.tail];return this._length--,t}get(t){if(!(t<0||t>=this._length))return this.buffer[(this.head+t)%this.buffer.length]}}const Te=BigInt(o.DEF),qe=BigInt(o.KET),Ee=BigInt(o.MARK),Pe=BigInt(o.BRA),I=0n,D=1n;class Qe{constructor(t){this.stack=[],this.queue=new ke,this.userDefs=[],this.sysDefs=new Array(w+1),this.symbols=new Map,this.depth=0,this.nextAnonOp=q,this.traceOn=!1,this.traceFormat="human",this.traceVerbose=!1,this.traceQueueMax=8,this.traceStackMax=32,this.traceStdoutMax=4096,this.base=10,this.statsOn=!1,this.profileOn=!1,this.stats={system_instructions_called:0,user_instructions_called:0,max_stack_depth:0,max_queue_depth:0},this.profile={},this.stdoutSinceLastTrace="",this.platform=t,this.setup()}static fromBase64(t){return ue(t).flatMap(e=>{const n=e&1n,s=e>>1n;return[n,s]})}getStack(){return this.stack.slice()}peek(){const t=this.stack.length;if(t>0)return this.stack[t-1];throw new Error("Peek: stack underflow")}pop(){if(this.stack.length>0)return this.stack.pop();throw new Error("Pop: stack underflow")}push(t){this.stack.push(t)}poke(t){const e=this.stack.length;if(e>0){this.stack[e-1]=t;return}throw new Error("Poke: stack underflow")}clear(){this.stack.splice(0,this.stack.length)}queuePush(t,e){this.queue.push(t,e)}queueUnshift(t,e){this.queue.unshift(t,e)}queuePop(){const t=this.queue.pop()??0n;return[this.queue.pop()??0n,t]}defineSystem(t,e){const n=BigInt(e),s=this.getName(n);if(this.sysDefs[e]!==void 0)throw new Error(`Define: cannot redefine system word "${s}"`);this.sysDefs[e]=t}defineUser(t,e){const n=this.getName(e);if(e>-1&&e<w)throw new Error(`Define: cannot define system op "${n}"`);const s=Number(e)-q;if(this.userDefs[s]!==void 0)throw e>w?new Error(`Define: cannot redefine anon op "${n}"`):new Error(`Define: cannot redefine user op "${n}"`);this.userDefs[s]=t}callSystem(t){const e=this.sysDefs[Number(t)];if(typeof e=="function"){if(this.statsOn&&this.stats.system_instructions_called++,this.profileOn){const s=performance.now();e();const a=performance.now(),r=this.getName(t)||Number(t);this.profile[r]||=[0,0],this.profile[r][0]++,this.profile[r][1]!=0,this.profile[r][1]+=a-s;return}return e()}const n=this.getName(t)||t;throw new Error(`Call: undefined system op "${n}"`)}callUser(t){const e=this.userDefs[Number(t)-q];if(e){if(this.statsOn&&this.stats.user_instructions_called++,this.queue.unshiftArray(e),this.profileOn){const s=this.getName(t,`&${t}`);this.profile[s]||=[0,void 0],this.profile[s][0]++}return}const n=this.getName(t)||t;throw new Error(`Call: undefined user op "${n}"`)}callOp(t){return t>-1n&&t<w?this.callSystem(t):this.callUser(t)}loadBigIntCode(t){this.queue.pushArray(t)}loadIR(t){let e=0;for(;e<t.length;){const n=t[e++];if(n.op===u.call){if(n.value===0n)continue;n.meta?.name&&!this.symbols.has(n.value)&&this.symbols.set(n.value,n.meta?.name),this.queuePush(D,n.value)}else this.queuePush(I,n.value)}return this.stack}runChunk(t,e){const n=this.queue;let s=!1,a=e,r=0;const p=BigInt(w);for(;n.length>0&&r<t;){const c=n.shift()??0n,l=n.shift()??0n,h=c===D,_=this.traceOn?this.stack.slice():void 0;if(s=!this.depth||h&&(l===Te||l===qe||l===Ee||l===Pe),h)if(!s)this.push(c),this.push(l);else if(l>-1n&&l<=p){const g=this.sysDefs[Number(l)];if(typeof g=="function")if(this.statsOn&&this.stats.system_instructions_called++,this.profileOn){const b=globalThis.performance?.now?.()??Date.now();g();const X=globalThis.performance?.now?.()??Date.now(),k=this.getName(l)||Number(l);this.profile[k]||=[0,0],this.profile[k][0]++,this.profile[k][1]!=0,this.profile[k][1]+=X-b}else g();else{const b=this.getName(l)||l;throw new Error(`Call: undefined system op "${b}"`)}}else{const g=this.userDefs[Number(l)-q];if(g){if(this.statsOn&&this.stats.user_instructions_called++,this.queue.unshiftArray(g),this.profileOn){const b=this.getName(l,`&${l}`);this.profile[b]||=[0,void 0],this.profile[b][0]++}}else{const b=this.getName(l)||l;throw new Error(`Call: undefined user op "${b}"`)}}else s||this.push(c),this.push(l);this.statsOn&&(this.stats.max_stack_depth=Math.max(this.stats.max_stack_depth,this.stack.length),this.stats.max_queue_depth=Math.max(this.stats.max_queue_depth,n.length/2));const m=a++;this.traceOn&&this.trace({step:m,immediate:s,tag:c,value:l,stackBefore:_??[],stackAfter:this.traceVerbose||this.traceFormat==="jsonl"?this.stack.slice():void 0}),r++}return a}run(){return this.runChunk(Number.POSITIVE_INFINITY,0),this.stack}async runAsync(t={}){const e=t.yieldIntervalMs??160,n=t.yieldSliceMax??t.yieldEvery??655360;if(!Number.isFinite(e)||e<0)throw new Error(`runAsync: yieldIntervalMs must be a non-negative finite number (received ${e})`);if(!Number.isFinite(n)||n<1)throw new Error(`runAsync: yieldSliceMax / yieldEvery must be a positive finite number (received ${n})`);const s=t.scheduler??(()=>new Promise(l=>{globalThis.setTimeout(l,0)})),a=typeof globalThis.performance<"u"&&typeof globalThis.performance.now=="function"?()=>globalThis.performance.now():()=>globalThis.Date.now();let r=0,p=0,c=!1;for(;this.queue.length>0&&!c;){const l=a(),h=e>0?l+e:l;for(;this.queue.length>0&&!c&&!(e>0&&a()>=h);){const _=r;if(r=this.runChunk(n,r),p+=r-_,t.onChunk?.({vmCyclesExecuted:p}),t.shouldContinue&&!t.shouldContinue()){c=!0;break}if(e===0)break}this.queue.length>0&&!c&&await s()}return{stack:this.stack.slice(),cancelled:c,vmCyclesExecuted:p}}trace({step:t,immediate:e,tag:n,value:s,stackBefore:a,stackAfter:r}){const p=this.takeStdoutSinceLastTraceForTraceEvent(),c=this.createTraceEvent(t,e,n,s,a,r,p);if(this.traceFormat==="jsonl"){this.writeTraceLine(JSON.stringify(c));return}this.writeTraceLine(this.formatHumanTrace(c))}createTraceEvent(t,e,n,s,a,r,p){const c=n===D,l=c?this.getName(s,String(s)):String(s),h=this.getQueuePreview(),_={step:t,immediate:e,tag:c?"call":"literal",value:String(s),action:l,stack_before:this.limitStack(a).map(String),stack_after:r?this.limitStack(r).map(String):void 0,queue_preview:h,queue_depth:this.queue.length/2};return p!==void 0&&p.length>0&&(_.stdout_since_last=p),_}limitStack(t){return t.length>this.traceStackMax?t.slice(-this.traceStackMax):t}getQueuePreview(){const t=[],e=Math.max(this.traceQueueMax,0);for(let n=0;n<this.queue.length&&t.length<e;n+=2){const s=this.queue.get(n)??0n,a=this.queue.get(n+1)??0n,r=s===D;t.push({tag:r?"call":"literal",value:String(a),action:r?this.getName(a,String(a)):String(a)})}return t}formatHumanTrace(t){const e=this.padHumanAction(t.action),n=this.formatHumanStack(t.stack_before),s=this.formatHumanQueue(t.queue_preview,t.queue_depth),a=this.layoutHumanTraceLine(t.step,n,e,s);if(this.traceVerbose){const r=this.formatHumanStack(t.stack_after??[]);return`${a}
${" ".repeat(String(t.step).length+1)}${r} | immediate=${t.immediate} tag=${t.tag} value=${t.value} stack_depth=${this.stack.length} queue_depth=${t.queue_depth}`}return a}padHumanAction(t){return t.length>=7?t:t.padStart(Math.floor((7+t.length)/2)," ").padEnd(7," ")}layoutHumanTraceLine(t,e,n,s){const a=this.getTraceTerminalWidth(),r=`${t} `;if(r.length>=a)return r.slice(0,a);const p=1,c=Math.min(n.length,Math.max(a-r.length-p*2,1)),l=Math.max(r.length+p,Math.floor((a-c)/2)),h=Math.min(l,Math.max(r.length+p,a-c-p)),_=h+c,m=r.length,g=Math.max(m,h-p),b=Math.min(a,_+p),X=a,k=Math.max(g-m,0),lt=Math.max(X-b,0),B=Array.from({length:a},()=>" ");if(this.writeSegment(B,0,r,r.length),this.writeSegment(B,h,n,c),k>0){const C=this.truncateLeft(e,k);this.writeSegment(B,g-C.length,C,C.length)}if(lt>0){const C=this.truncateRight(s,lt);this.writeSegment(B,b,C,C.length)}return B.join("").replace(/\s+$/,"")}formatHumanStack(t){return t.length===0?"[ ]":`[ ${t.join(" ")} ]`}formatHumanQueue(t,e){const n=t.map(a=>a.tag==="call"?`&${a.action}`:a.value),s=Math.max(e-t.length,0);return s>0&&n.push(`…(+${s})`),n.length===0?"[ ]":`[ ${n.join(" ")} ]`}getTraceTerminalWidth(){const e=globalThis.Deno,n=e?.stderr?.isTerminal?.()&&typeof e.stderr.rid=="number"?e.stderr.rid:e?.stdout?.isTerminal?.()&&typeof e.stdout.rid=="number"?e.stdout.rid:void 0;if(typeof n=="number")try{const r=e?.consoleSize?.(n).columns;if(typeof r=="number"&&r>0)return r}catch{}const s=globalThis.process,a=s?.stderr?.isTTY&&typeof s.stderr.columns=="number"?s.stderr.columns:s?.stdout?.isTTY&&typeof s.stdout.columns=="number"?s.stdout.columns:void 0;return typeof a=="number"&&a>0?a:120}truncateLeft(t,e){return e<=0?"":t.length<=e?t:e===1?"…":`…${t.slice(-(e-1))}`}truncateRight(t,e){return e<=0?"":t.length<=e?t:e===1?"…":`${t.slice(0,e-1)}…`}writeSegment(t,e,n,s){if(!(s<=0))for(let a=0;a<s&&a<n.length&&e+a<t.length;a++)t[e+a]=n[a]}writeTraceLine(t){const e=new TextEncoder().encode(`${t}
...
`;function S(i){const t=i.startsWith("/"),e=i.split("/").filter(Boolean),n=[];for(const s of e)if(s!=="."){if(s===".."){n.pop();continue}n.push(s)}return`${t?"/":""}${n.join("/")}`||(t?"/":".")}function Be(i){const t=S(i),e=t.lastIndexOf("/");return e<=0?t.startsWith("/")?"/":".":t.slice(0,e)}function Fe(...i){const t=i.filter(Boolean).join("/").replaceAll(/\/+/g,"/");return S(t)}function Me(i,t){const e=S(i).split("/").filter(Boolean),n=S(t).split("/").filter(Boolean);let s=0;for(;s<e.length&&s<n.length&&e[s]===n[s];)s++;const a=e.length-s,r=n.slice(s);return Array(a).fill("..").concat(r).join("/")||"."}function qn(i){return{readTextFile(t){const e=S(t),n=i[e];if(typeof n!="string")throw new Error(`Virtual file not found: ${e}`);return n},fileExists(t){return typeof i[S(t)]=="string"},directoryExists(t){const e=S(t).replace(/\/+$/,""),n=e==="/"?"/":`${e}/`;return Object.keys(i).some(s=>s.startsWith(n))},realpath(t){return S(t)},path:{isAbsolute(t){return t.startsWith("/")},dirname:Be,relative:Me,resolve:Fe}}}function En(i={}){const t=new TextDecoder,e=new TextEncoder,n=Array.from(e.encode(i.stdin??""));return{io:{write(s){i.onWrite?.(t.decode(s))},readByte(){return n.shift()??null}},exit(s){i.onExit?.(s)},now(){return Date.now()}}}export{v as A,en as B,tn as C,He as D,W as E,Je as F,Ze as G,Xe as H,Ye as I,En as J,R as K,Qe as L,qn as M,Ke as N,Ve as O,z as P,Ge as Q,je as R,Tn as _,We as a,ze as b,kn as c,Sn as d,xn as e,An as f,wn as g,yn as h,bn as i,vn as j,gn as k,mn as l,fn as m,_n as n,dn as o,un as p,hn as q,ln as r,Ue as s,cn as t,pn as u,on as v,rn as w,an as x,sn as y,nn as z};
