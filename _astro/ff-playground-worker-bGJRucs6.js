(function(){"use strict";function nn(){return!!(globalThis.Deno?.stdout?.isTerminal?.()??globalThis.process?.stdout?.isTTY??!1)}function D(s,n){return nn()?`\x1B[${s}m${n}\x1B[0m`:n}function en(s){return D(34,s)}function tn(s){return D(32,s)}function v(s){return D(36,s)}const o={NOP:0,CALL:1,PUTC:2,GETC:3,PUTN:5,CLOCK:6,DROP:8,PUSHR:14,PULLR:15,SHIFTL:16,SHIFTR:17,CLR:24,RAND:26,EXIT:27,DUP:33,DEPTH:35,SWAP:36,MOD:37,AND:38,STASH:40,FETCH:41,MUL:42,ADD:43,CONS:44,SUB:45,PRN:46,DIV:47,MARK:58,DEF:59,LT:60,EQ:61,GT:62,IF:63,BRA:91,KET:93,POW:94,OR:124,NOT:126},y={nop:o.NOP,eval:o.CALL,";":o.DEF,":":o.MARK,clr:o.CLR,rand:o.RAND,exit:o.EXIT,".":o.PRN,putc:o.PUTC,getc:o.GETC,putn:o.PUTN,clock:o.CLOCK,drop:o.DROP,swap:o.SWAP,dup:o.DUP,"<<":o.SHIFTL,">>":o.SHIFTR,"+":o.ADD,"-":o.SUB,cons:o.CONS,"*":o.MUL,"/":o.DIV,"<":o.LT,"=":o.EQ,">":o.GT,"?":o.IF,"%":o.MOD,"&":o.AND,"(":o.STASH,")":o.FETCH,"q<":o.PUSHR,"q>":o.PULLR,depth:o.DEPTH,"^":o.POW,"[":o.BRA,"]":o.KET,"|":o.OR,"~":o.NOT},x=255,sn=s=>s,rn=s=>s,u={call:"call",push:"push"},on=6,O=10,an=new Map([[BigInt(o.MARK),":"],[BigInt(o.DEF),";"],[BigInt(o.BRA),"["],[BigInt(o.KET),"]"]]);function pn(s){return(""+s.value).padEnd(O," ")}function cn(s,n){return n?n.padEnd(O," "):s.op===u.push&&s.meta?.pointer?`[${s.value}]`.padEnd(O," "):pn(s)}function ln(s){return s.trim()?`/* ${s} */`:""}function dn(s){const n=_n(s)?.toUpperCase()||"",e=s.op===u.call?an.get(s.value):void 0,t=e!==void 0,i=cn(s,e),r=s.meta?.comment?.trim()||(s.op===u.call&&!t?n:""),a=(s.op===u.call&&!e?"EVAL":"").padEnd(on," ");return[rn(i),sn(a),ln(r)].join(" ")}function un(s){for(const n in y)if(y[n]===s)return n;return""}function _n(s){if(s.op===u.call||s.op===u.push&&s.meta?.pointer)return s.meta?.name||un(Number(s.value))||""}function hn(s){return s.map(dn).join(`
`)}function fn(s){return s=s.replace(/\\U([A-Fa-f0-9]{8})/g,(n,e)=>M(e)),s=s.replace(/\\u([A-Fa-f0-9]{4})/g,(n,e)=>M(e)),s.replace(/\\0/g,"\0").replace(/\\b/g,"\b").replace(/\\t/g,"	").replace(/\\n/g,`
`).replace(/\\v/g,"\v").replace(/\\f/g,"\f").replace(/\\r/g,"\r").replace(/\\'/g,"'").replace(/\\"/g,'"').replace(/\\s/g," ").replace(/\\\\/g,"\\")}function M(s){let n="",e=parseInt(s,16);return e<=65535?n+=String.fromCharCode(e):e<=1114111?(e-=65536,n+=String.fromCharCode(55296|e>>10)+String.fromCharCode(56320|e&1023)):n+=`hex2Char error: Code point out of range: ${mn(e)}`,n}function mn(s){return(s+0).toString(16).toUpperCase()}const L="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",F=new Map;L.split("").forEach(function(s,n){F.set(s,n)});const U=1n<<5n,$=Number(U),j=U-1n;function gn(s){return s.map(yn).map(xn).join("")}function bn(s){return kn(qn(s)).map(Sn)}function vn(s){return s>=0n?s<<1n:(-s<<1n)+1n}function wn(s){return s&1n?-(s>>1n):s>>1n}function yn(s){if(s===0n)return[0];s=vn(s);const n=[];for(;s>0;){let e=Number(s&j);s>>=5n,s>0&&(e|=$),n.push(e)}return n}function xn(s){return s.map(n=>L[n]).join("")}function qn(s){return s.split("").map(n=>{const e=F.get(n);if(e===void 0)throw new Error(`${s} is not a valid base64 encoded VLQ`);return e})}function kn(s){const n=[];let e=[];if(s.forEach(t=>{e.push(t),(t&$)===0&&(n.push(e),e=[])}),e.length>0)throw new Error("Malformed VLQ sequence: The last VLQ never ended.");return n}function Sn(s){const n=s.reverse().reduce((e,t)=>(e<<=5n,e|=BigInt(t)&j,e),0n);return wn(n)}const En="/*",Tn="*/";function z(s){if(!(s==="-"||s==="+"))try{let n=1n;return s=s.replaceAll("_",""),s.startsWith("-0")&&(n=-1n,s=s.replace("-","")),s.includes("e")||s.includes("E")?n*BigInt(+s):n*BigInt(s)}catch{return}}class g{constructor(n={}){this.symbols=new Map,this._nextCode=-1,this.host=n;let e;for(e in y)this.symbols.set(e,BigInt(y[e]))}static tokenize(n){return n.split(/\s+/).filter(Boolean).map(e=>{const t=z(e);return t!==void 0?t:e})}static tokenizeWithSpans(n){const e=[],t=/\S+/g;let i=0,r=0,a=0;const p=c=>{for(;a<c;){const d=n[a];d==="\r"?(n[a+1]===`
`&&a++,i++,r=0):d===`
`?(i++,r=0):r++,a++}};let l;for(;(l=t.exec(n))!==null;){const c=l.index;p(c);const d=l[0]??"",h=z(d);e.push({raw:d,value:h!==void 0?h:d,line:i,character:r,length:d.length,offset:c}),p(c+d.length)}return e}static compileToBase64(n){const e=n.flatMap(t=>{if(t.op===u.call&&t.value===0n)return[];const i=t.value<<1n;return[t.op===u.push?i:i|1n]});return gn(e)}nextCode(){return BigInt(this._nextCode--)}getSymbol(n){n=n.toLowerCase();let e=this.symbols.get(n);return e===void 0&&(e=this.nextCode(),this.symbols.set(n,e)),e}compileToIR(n,e=""){let t=0;const i=n.length;let r="";const a=[];let p;for(;t<i;)if(p=n[t++],r=this.unwrapTokenValue(p),typeof r=="bigint")l(r);else if(r.length>1&&r.startsWith(".")){const[d]=r.split(" ");switch(d){case".push":a[a.length-1].op=u.push;break;case".call":a[a.length-1].op=u.call;break;case".inline":a[a.length-1].meta||={},a[a.length-1].meta.inline=!0;break;case".unsafe":a[a.length-1].meta||={},a[a.length-1].meta.unsafe=!0;break;case".pointer":a[a.length-1].meta||={},a[a.length-1].meta.pointer=!0;break;case".exit":if(this.host.exit){this.host.exit();break}throw new Error("Compiler: .exit requires a host exit handler");case".symbols":this.symbols.forEach((h,f)=>{(this.host.log||console.log)(f,h)});break;case".words":{const h=Array.from(this.symbols,([f])=>f).join(" ");(this.host.log||console.log)(h);break}}}else if(r[0]==="'"&&r.length>1)fn(r).replace(/^'/,"").replace(/'$/,"").split("").forEach(d=>{l(d.charCodeAt(0),{comment:d})});else if(r.endsWith(":")&&r.length>1){const d=r.replace(/:$/,"");l(this.getSymbol(d),{name:`${d}`,pointer:!0}),c(o.MARK,{name:":"})}else if(r===En){const d=p,h=[];for(;t<n.length&&(p=n[t++],r=this.unwrapTokenValue(p),r!==Tn);)h.push(r);c(0n,{comment:h.join(" ")},d)}else if(r.startsWith("[")&&r.endsWith("]")){const d=r.replace(/^\[/,"").replace(/\]$/,""),h=z(d);h!==void 0?l(h,{name:d,pointer:!0}):l(this.getSymbol(d),{name:d,pointer:!0})}else c(this.getSymbol(r),{name:r});return a;function l(d,h={},f=p){a.push({value:BigInt(d),op:u.push,meta:{...h,...g.toInstructionMeta(f,e)}})}function c(d,h={},f=p){a.push({value:BigInt(d),op:u.call,meta:{...h,...g.toInstructionMeta(f,e)}})}}unwrapTokenValue(n){return typeof n=="string"||typeof n=="bigint"?n:n.value}static toInstructionMeta(n,e){return!n||typeof n=="string"||typeof n=="bigint"?{filename:e}:{filename:e,line:n.line,character:n.character,length:n.length,offset:n.offset}}validate(n){const e=n.slice(),t=[];let i=0;for(;i<e.length;){const r=e[i];if(r.op===u.call&&r.value===BigInt(o.DEF)){let a=0;for(a=i;a>0&&!(e[a].op===u.call&&e[a].value===BigInt(o.MARK));a--);const p=e.splice(a-1,i-a+2);p.at(-1)?.meta?.unsafe||t.push(...this.validateDef(p)),i=a-1}i++}return t.push(...this.validateDef(e,"main")),t}validateDef(n,e){const t=[];let i=0,r=0,a=0,p=0;const l=[0];if(!n[0])return[];e=tn(e||n[0].meta?.name?.replace(/^&/,"")||"main");const c=en(n[0].meta?.filename||"-");for(;i<n.length;){const d=n[i];if(d.op===u.call){if(d.op===u.call&&d.value===BigInt(o.MARK)&&r++,d.op===u.call&&d.value===BigInt(o.DEF)&&r--,d.op===u.call&&d.value===BigInt(o.BRA)&&(a++,l.push(0)),d.op===u.call&&d.value===BigInt(o.KET)&&(a--,(l.length>1?l.pop():0)!==0&&t.push(`${c}: Unbalanced queue push ( ${v("q< q>")} ) in quote in ${e}`)),d.op===u.call&&(d.value===BigInt(o.PUSHR)||d.value===BigInt(o.STASH))&&(p++,l[l.length-1]++),d.op===u.call&&(d.value===BigInt(o.PULLR)||d.value===BigInt(o.FETCH))){if(l[l.length-1]===0){const f=d.value===BigInt(o.FETCH)?")":"q>";t.push(`${c}: Queue borrow ( ${v(f)} ) requires ${v(".unsafe")} in ${e} (including quotes)`)}p--,l[l.length-1]--}a<0&&t.push(`${c}: Bracket ( ${v("[ ]")} ) mismatch in ${e}`),r<0&&t.push(`${c}: Definition ( ${v(": ;")} ) mismatch in ${e}`)}i++}return a!==0&&t.push(`${c}: Unbalanced brackets ( ${v("[ ]")} ) in ${e}`),p!==0&&t.push(`${c}: Unbalanced queue push ( ${v("q< q> ( )")} ) in ${e}`),r!==0&&t.push(`${c}: Unbalanced definition ( ${v(": ;")} ) in ${e}`),t}}const An="FbAbbCb";var Pn={words:[{mnemonic:"NOP",syntax:"nop",stackEffect:"… nop == …",description:"No operation; does nothing.",opcode:0},{mnemonic:"EVAL",syntax:"eval",stackEffect:"[A] eval == a*",description:"Evaluates a quotation, executing its contents.",opcode:1},{mnemonic:"PUTC",syntax:"putc",stackEffect:"n putc == {prints char(n)}",description:"Prints a character given by its numeric code.",opcode:2},{mnemonic:"GETC",syntax:"getc",stackEffect:"getc == n {reads char}",description:"Reads a single character from input and pushes its code.",opcode:3},{mnemonic:"PUTN",syntax:"putn",stackEffect:"n putn == {prints n}",description:"Prints a number to output.",opcode:5},{mnemonic:"CLOCK",syntax:"clock",stackEffect:"clock == n {reads clock}",description:"Returns the current time as a Unix timestamp.",opcode:6},{mnemonic:"DROP",syntax:"drop",stackEffect:"a drop ==",description:"Removes the top value from the stack.",opcode:8},{mnemonic:"PUSHR",syntax:"q<",stackEffect:"a q< == | …a",description:"Pushes a value onto the return stack.",opcode:14},{mnemonic:"PULLR",syntax:"q>",stackEffect:"q> == a | a…",description:"Pops a value from the return stack onto the main stack.",opcode:15},{mnemonic:"SHIFTL",syntax:"<<",stackEffect:"a b << == n",description:"Left-shifts a by b bits.",opcode:16},{mnemonic:"SHIFTR",syntax:">>",stackEffect:"a b >> == n",description:"Right-shifts a by b bits.",opcode:17},{mnemonic:"CLR",syntax:"clr",stackEffect:"… clr ==",description:"Clears the entire stack.",opcode:24},{mnemonic:"RAND",syntax:"rand",stackEffect:"n rand == r {0 <= r < n}",description:"Generates a random number between 0 and n-1.",opcode:26},{mnemonic:"EXIT",syntax:"exit",stackEffect:"n exit == {exits with code n}",description:"Exits the program with the given exit code.",opcode:27},{mnemonic:"DUP",syntax:"dup",stackEffect:"a dup == a a",description:"Duplicates the top value on the stack.",opcode:33},{mnemonic:"DEPTH",syntax:"depth",stackEffect:"… depth == … n",description:"Pushes the current stack depth.",opcode:35},{mnemonic:"SWAP",syntax:"swap",stackEffect:"a b swap == b a",description:"Swaps the top two values on the stack.",opcode:36},{mnemonic:"MOD",syntax:"%",stackEffect:"a b % == n",description:"Computes the remainder of a divided by b.",opcode:37},{mnemonic:"AND",syntax:"&",stackEffect:"a b & == n",description:"Bitwise AND of a and b.",opcode:38},{mnemonic:"STASH",syntax:"(",stackEffect:"… ( == {moves stack to queue}",description:"Moves values from the stack to the queue.",opcode:40},{mnemonic:"FETCH",syntax:")",stackEffect:") == … {restores stack from queue}",description:"Moves values from the queue back to the stack.",opcode:41},{mnemonic:"MUL",syntax:"*",stackEffect:"a b * == n",description:"Multiplies a by b.",opcode:42},{mnemonic:"ADD",syntax:"+",stackEffect:"a b + == n",description:"Adds a and b together.",opcode:43},{mnemonic:"CONS",syntax:"cons",stackEffect:"x y cons == q",description:"Builds an anonymous quotation from two stack values (opcode also maps to `,`).",opcode:44},{mnemonic:"SUB",syntax:"-",stackEffect:"a b - == n",description:"Subtracts b from a.",opcode:45},{mnemonic:"DUMP",syntax:".",stackEffect:"… . == … {prints stack}",description:"Prints the entire stack to output.",opcode:46},{mnemonic:"DIV",syntax:"/",stackEffect:"a b / == n",description:"Divides a by b (integer division).",opcode:47},{mnemonic:"MARK",syntax:":",stackEffect:"n : == {begin definition(n)}",description:"Begins a new word definition with name n.",opcode:58},{mnemonic:"DEF",syntax:";",stackEffect:"; == {end definition}",description:"Ends the current word definition.",opcode:59},{mnemonic:"LT",syntax:"<",stackEffect:"a b < == flag",description:"Pushes true if a is less than b.",opcode:60},{mnemonic:"EQ",syntax:"=",stackEffect:"a b = == flag",description:"Pushes true if a equals b.",opcode:61},{mnemonic:"GT",syntax:">",stackEffect:"a b > == flag",description:"Pushes true if a is greater than b.",opcode:62},{mnemonic:"WHEN",syntax:"?",stackEffect:"flag [A] ? == a*",description:"Executes the quotation if flag is true.",opcode:63},{mnemonic:"BRA",syntax:"[",stackEffect:"[ == {begin quotation}",description:"Begins a quotation (anonymous code block).",opcode:91},{mnemonic:"KET",syntax:"]",stackEffect:"] == [A] {end quotation}",description:"Ends a quotation and pushes it to the stack.",opcode:93},{mnemonic:"POW",syntax:"^",stackEffect:"a b ^ == n",description:"Computes a raised to the power of b.",opcode:94},{mnemonic:"OR",syntax:"|",stackEffect:"a b | == n",description:"Bitwise OR of a and b.",opcode:124},{mnemonic:"NOT",syntax:"~",stackEffect:"a ~ == n'",description:"Bitwise NOT of a.",opcode:126}]};const W=new Map;for(const s of Pn.words)W.set(s.opcode,s);function In(s){return W.get(s)}const Cn=[BigInt(o.DEF),BigInt(o.KET),BigInt(o.MARK),BigInt(o.BRA)],q=0n,k=1n;class H{constructor(n){this.stack=[],this.queue=[],this.defs=new Map,this.symbols=new Map,this.depth=0,this.nextAnonOp=x+1,this.traceOn=!1,this.traceFormat="human",this.traceVerbose=!1,this.traceQueueMax=8,this.traceStackMax=32,this.base=10,this.statsOn=!1,this.profileOn=!1,this.stats={system_instructions_called:0,user_instructions_called:0,max_stack_depth:0,max_queue_depth:0},this.profile={},this.platform=n,this.setup()}static fromBase64(n){return bn(n).flatMap(e=>{const t=e&1n,i=e>>1n;return[t,i]})}getStack(){return this.stack.slice()}peek(){const n=this.stack.length;if(n>0)return this.stack[n-1];throw new Error("Peek: stack underflow")}pop(){if(this.stack.length>0)return this.stack.pop();throw new Error("Pop: stack underflow")}push(n){this.stack.push(n)}poke(n){const e=this.stack.length;if(e>0){this.stack[e-1]=n;return}throw new Error("Poke: stack underflow")}clear(){this.stack.splice(0,this.stack.length)}queuePush(n,e){this.queue.push(n,e)}queueUnshift(n,e){this.queue.unshift(n,e)}queueShift(){return[this.queue.shift()??0n,this.queue.shift()??0n]}queuePop(){const n=this.queue.pop()??0n;return[this.queue.pop()??0n,n]}defineSystem(n,e){const t=BigInt(e),i=this.getName(t);if(this.defs.has(t))throw new Error(`Define: cannot redefine system word "${i}"`);this.defs.set(t,n)}defineUser(n,e){const t=this.getName(e);if(e>-1&&e<x)throw new Error(`Define: cannot define system op "${t}"`);if(this.defs.has(e))throw e>x?new Error(`Define: cannot redefine anon op "${t}"`):new Error(`Define: cannot redefine user op "${t}"`);this.defs.set(e,n)}callSystem(n){const e=this.defs.get(n);if(typeof e=="function"){if(this.statsOn&&this.stats.system_instructions_called++,this.profileOn){const i=performance.now();e();const r=performance.now(),a=this.getName(n)||Number(n);this.profile[a]||=[0,0],this.profile[a][0]++,this.profile[a][1]!=0,this.profile[a][1]+=r-i;return}return e()}const t=this.getName(n)||n;throw new Error(`Call: undefined system op "${t}"`)}callUser(n){const e=this.defs.get(n);if(Array.isArray(e)){if(this.statsOn&&this.stats.user_instructions_called++,this.queue.unshift(...e),this.profileOn){const i=this.getName(n,`&${n}`);this.profile[i]||=[0,void 0],this.profile[i][0]++}return}const t=this.getName(n)||n;throw new Error(`Call: undefined user op "${t}"`)}callOp(n){return n>-1n&&n<x?this.callSystem(n):this.callUser(n)}loadBigIntCode(n){this.queue.push(...n)}loadIR(n){let e=0;for(;e<n.length;){const t=n[e++];if(t.op===u.call){if(t.value===0n)continue;t.meta?.name&&!this.symbols.has(t.value)&&this.symbols.set(t.value,t.meta?.name),this.queuePush(k,t.value)}else this.queuePush(q,t.value)}return this.stack}runChunk(n,e){const t=this.queue;let i=!1,r=e,a=0;for(;t.length>0&&a<n;){const[p,l]=this.queueShift(),c=p===k,d=this.stack.slice();i=!this.depth||c&&Cn.includes(l),c?i?this.callOp(l):(this.push(p),this.push(l)):(i||this.push(p),this.push(l)),this.statsOn&&(this.stats.max_stack_depth=Math.max(this.stats.max_stack_depth,this.stack.length),this.stats.max_queue_depth=Math.max(this.stats.max_queue_depth,t.length/2));const h=r++;this.traceOn&&this.trace({step:h,immediate:i,tag:p,value:l,stackBefore:d,stackAfter:this.traceVerbose||this.traceFormat==="jsonl"?this.stack.slice():void 0}),a++}return r}run(){return this.runChunk(Number.POSITIVE_INFINITY,0),this.stack}async runAsync(n={}){const e=n.yieldIntervalMs??160,t=n.yieldSliceMax??n.yieldEvery??655360;if(!Number.isFinite(e)||e<0)throw new Error(`runAsync: yieldIntervalMs must be a non-negative finite number (received ${e})`);if(!Number.isFinite(t)||t<1)throw new Error(`runAsync: yieldSliceMax / yieldEvery must be a positive finite number (received ${t})`);const i=n.scheduler??(()=>new Promise(c=>{globalThis.setTimeout(c,0)})),r=typeof globalThis.performance<"u"&&typeof globalThis.performance.now=="function"?()=>globalThis.performance.now():()=>globalThis.Date.now();let a=0,p=0,l=!1;for(;this.queue.length>0&&!l;){const c=r(),d=e>0?c+e:c;for(;this.queue.length>0&&!l&&!(e>0&&r()>=d);){const h=a;if(a=this.runChunk(t,a),p+=a-h,n.onChunk?.({vmCyclesExecuted:p}),n.shouldContinue&&!n.shouldContinue()){l=!0;break}if(e===0)break}this.queue.length>0&&!l&&await i()}return{stack:this.stack.slice(),cancelled:l,vmCyclesExecuted:p}}trace({step:n,immediate:e,tag:t,value:i,stackBefore:r,stackAfter:a}){const p=this.createTraceEvent(n,e,t,i,r,a);if(this.traceFormat==="jsonl"){this.writeTraceLine(JSON.stringify(p));return}this.writeTraceLine(this.formatHumanTrace(p))}createTraceEvent(n,e,t,i,r,a){const p=t===k,l=p?this.getName(i,String(i)):String(i),c=this.getQueuePreview();return{step:n,immediate:e,tag:p?"call":"literal",value:String(i),action:l,stack_before:this.limitStack(r).map(String),stack_after:a?this.limitStack(a).map(String):void 0,queue_preview:c,queue_depth:this.queue.length/2}}limitStack(n){return n.length>this.traceStackMax?n.slice(-this.traceStackMax):n}getQueuePreview(){const n=[],e=Math.max(this.traceQueueMax,0);for(let t=0;t<this.queue.length&&n.length<e;t+=2){const i=this.queue[t]??0n,r=this.queue[t+1]??0n,a=i===k;n.push({tag:a?"call":"literal",value:String(r),action:a?this.getName(r,String(r)):String(r)})}return n}formatHumanTrace(n){const e=this.padHumanAction(n.action),t=this.formatHumanStack(n.stack_before),i=this.formatHumanQueue(n.queue_preview,n.queue_depth),r=this.layoutHumanTraceLine(n.step,t,e,i);if(this.traceVerbose){const a=this.formatHumanStack(n.stack_after??[]);return`${r}
${" ".repeat(String(n.step).length+1)}${a} | immediate=${n.immediate} tag=${n.tag} value=${n.value} stack_depth=${this.stack.length} queue_depth=${n.queue_depth}`}return r}padHumanAction(n){return n.length>=7?n:n.padStart(Math.floor((7+n.length)/2)," ").padEnd(7," ")}layoutHumanTraceLine(n,e,t,i){const r=this.getTraceTerminalWidth(),a=`${n} `;if(a.length>=r)return a.slice(0,r);const p=1,l=Math.min(t.length,Math.max(r-a.length-p*2,1)),c=Math.max(a.length+p,Math.floor((r-l)/2)),d=Math.min(c,Math.max(a.length+p,r-l-p)),h=d+l,f=a.length,T=Math.max(f,d-p),A=Math.min(r,h+p),rt=r,Z=Math.max(T-f,0),J=Math.max(rt-A,0),I=Array.from({length:r},()=>" ");if(this.writeSegment(I,0,a,a.length),this.writeSegment(I,d,t,l),Z>0){const P=this.truncateLeft(e,Z);this.writeSegment(I,T-P.length,P,P.length)}if(J>0){const P=this.truncateRight(i,J);this.writeSegment(I,A,P,P.length)}return I.join("").replace(/\s+$/,"")}formatHumanStack(n){return n.length===0?"[ ]":`[ ${n.join(" ")} ]`}formatHumanQueue(n,e){const t=n.map(r=>r.tag==="call"?`&${r.action}`:r.value),i=Math.max(e-n.length,0);return i>0&&t.push(`…(+${i})`),t.length===0?"[ ]":`[ ${t.join(" ")} ]`}getTraceTerminalWidth(){const e=globalThis.Deno,t=e?.stderr?.isTerminal?.()&&typeof e.stderr.rid=="number"?e.stderr.rid:e?.stdout?.isTerminal?.()&&typeof e.stdout.rid=="number"?e.stdout.rid:void 0;if(typeof t=="number")try{const a=e?.consoleSize?.(t).columns;if(typeof a=="number"&&a>0)return a}catch{}const i=globalThis.process,r=i?.stderr?.isTTY&&typeof i.stderr.columns=="number"?i.stderr.columns:i?.stdout?.isTTY&&typeof i.stdout.columns=="number"?i.stdout.columns:void 0;return typeof r=="number"&&r>0?r:120}truncateLeft(n,e){return e<=0?"":n.length<=e?n:e===1?"…":`…${n.slice(-(e-1))}`}truncateRight(n,e){return e<=0?"":n.length<=e?n:e===1?"…":`${n.slice(0,e-1)}…`}writeSegment(n,e,t,i){if(!(i<=0))for(let r=0;r<i&&r<t.length&&e+r<n.length;r++)n[e+r]=t[r]}writeTraceLine(n){const e=new TextEncoder().encode(`${n}
`);if(this.platform.io.writeError){this.platform.io.writeError(e);return}this.platform.io.write(e)}getName(n,e=String(n)){return this.symbols.has(n)?this.symbols.get(n):String(e)}inspectValue(n){const e=this.symbols.get(n),t=n>=0n&&n<=BigInt(x),i=this.defs.get(n),r=i!==void 0;let a;Array.isArray(i)&&(a=this.parseDefinitionTokens(i));let p,l;if(t){const c=In(Number(n));c&&(p=c.stackEffect,l=c.description)}return{value:n,name:e,isSystem:t,isDefined:r,definition:a,stackEffect:p,description:l}}parseDefinitionTokens(n){const e=[];for(let t=0;t<n.length;t+=2){const i=n[t]??0n,r=n[t+1]??0n,a=i===k,p=a?this.symbols.get(r):void 0,l=this.defs.has(r);e.push({value:r,tag:i,name:p,isCall:a,isDefined:l})}return e}print(){const n=this.stack.map(e=>e.toString(this.base)).join(" ");this.platform.io.write(new TextEncoder().encode(`[ ${n} ]
`))}loadSourceMap(n){Object.keys(n.symbols).forEach(e=>{this.symbols.set(BigInt(e),n.symbols[e])})}getNextAnonOp(){let n=this.nextAnonOp++;for(;this.defs.has(BigInt(n));)n=this.nextAnonOp++;return BigInt(n)}setup(){const n=new TextEncoder;let e;for(e in y)this.symbols.set(BigInt(y[e]),e);this.defineSystem(()=>{},o.NOP),this.defineSystem(()=>{const t=this.pop();this.callOp(t)},o.CALL),this.defineSystem(()=>{this.depth--;const[,t]=this.queuePop(),i=this.stack.splice(Number(t||0))||[];this.defineUser(i,this.pop())},o.DEF),this.defineSystem(()=>{this.depth--;const[,t]=this.queuePop(),i=this.stack.splice(Number(t||0))||[],r=this.getNextAnonOp();this.defineUser(i,r),this.depth>0&&this.push(0n),this.push(r)},o.KET),this.defineSystem(()=>{this.depth++;const t=this.stack.length;this.queuePush(q,BigInt(t))},o.BRA),this.defineSystem(()=>{this.depth++;const t=this.stack.length;this.queuePush(q,BigInt(t))},o.MARK),this.defineSystem(()=>this.clear(),o.CLR),this.defineSystem(()=>{const t=this.pop();this.platform.exit(Number(t))},o.EXIT),this.defineSystem(()=>{const t=this.pop();this.push(Rn(t))},o.RAND),this.defineSystem(()=>{this.print()},o.PRN),this.defineSystem(()=>{this.push(BigInt(this.platform.now()))},o.CLOCK),this.defineSystem(()=>{const t=n.encode(String.fromCharCode(Number(this.pop())));this.platform.io.write(t)},o.PUTC),this.defineSystem(()=>{this.platform.io.setRaw&&this.platform.io.setRaw(!0);const t=this.platform.io.readByte();this.platform.io.setRaw&&this.platform.io.setRaw(!1),this.push(BigInt(t??0))},o.GETC),this.defineSystem(()=>{const t=n.encode(this.pop().toString(this.base));this.platform.io.write(t)},o.PUTN),this.defineSystem(()=>{this.pop()},o.DROP),this.defineSystem(()=>{const t=this.peek(),i=this.stack[this.stack.length-2];this.stack[this.stack.length-2]=t,this.poke(i)},o.SWAP),this.defineSystem(()=>{this.push(this.peek())},o.DUP),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]+=t},o.ADD),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]-=t},o.SUB),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]*=t},o.MUL),this.defineSystem(()=>{const t=this.pop();if(t===0n)throw new Error("DIV: Division by zero");this.stack[this.stack.length-1]/=t},o.DIV),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]%=t},o.MOD),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]<<=t},o.SHIFTL),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]>>=t},o.SHIFTR),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]&=t},o.AND),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]**=t},o.POW),this.defineSystem(()=>{this.push(this.pop()>this.pop()?1n:0n)},o.LT),this.defineSystem(()=>{this.push(this.pop()===this.pop()?1n:0n)},o.EQ),this.defineSystem(()=>{this.push(this.pop()<this.pop()?1n:0n)},o.GT),this.defineSystem(()=>{const t=this.pop();this.pop()!==0n&&this.queueUnshift(k,t)},o.IF),this.defineSystem(()=>{this.queuePush(q,this.pop())},o.PUSHR),this.defineSystem(()=>{const[,t]=this.queuePop();this.push(t)},o.PULLR),this.defineSystem(()=>{this.push(BigInt(this.stack.length))},o.DEPTH),this.defineSystem(()=>{const t=this.stack.length;this.stack.splice(0,t).forEach(r=>this.queuePush(q,r)),this.queuePush(q,BigInt(t))},o.STASH),this.defineSystem(()=>{const[,t]=this.queuePop(),i=Number(t),r=[];for(let a=0;a<i;a++){const[,p]=this.queuePop();r.unshift(p)}this.stack.unshift(...r)},o.FETCH),this.defineSystem(()=>{const t=this.pop();this.stack[this.stack.length-1]|=t},o.OR),this.defineSystem(()=>{const t=this.pop();this.push(~t)},o.NOT),this.defineSystem(()=>{const t=this.pop(),r=[0n,this.pop(),1n,t],a=this.getNextAnonOp();this.defineUser(r,a),this.depth>0&&this.push(0n),this.push(a)},o.CONS)}printProfile(){console.log(),console.log("Profile:");const n=Object.keys(this.profile).map(i=>{const r=this.profile[i][0],a=this.profile[i][1];return{name:i,calls:r,time:a,system:typeof a<"u","ops/ms":a?Math.round(r/a):""}}).sort((i,r)=>r.calls-i.calls),e=n.filter(i=>i.system),t=n.filter(i=>!i.system);console.table(e,["name","calls","ops/ms"]),console.table(t,["name","calls"]),console.log()}printStats(){console.log(),console.log("Interpreter stats:"),console.log(this.stats),console.log()}}function Rn(s){const n=s,e=n.toString().length;let t="";for(;t.length<e;)t+=Math.random().toString().split(".")[1];t=t.slice(0,e);const i="1"+"0".repeat(e);return n*BigInt(t)/BigInt(i)}const C=BigInt(o.DEF),V=BigInt(o.KET),R=BigInt(o.MARK),K=BigInt(o.BRA),_=s=>(s=BigInt(s),n=>n.op===u.call&&n.value===s),S=s=>(s=BigInt(s),n=>n.op===u.push&&n.value===s),m=s=>s.op===u.push,Q=s=>s.op===u.push&&s.value!==0n,Bn=[{name:"No operation",pattern:[_(o.NOP)],replacement:()=>[]},{name:"Null Sequence - SWAP SWAP",pattern:[_(o.SWAP),_(o.SWAP)],replacement:()=>[]},{name:"Null Sequence - DUP DROP",pattern:[_(o.DUP),_(o.DROP)],replacement:()=>[]},{name:"Null Sequence - PUSHR PULLR",pattern:[_(o.PUSHR),_(o.PULLR)],replacement:()=>[]},{name:"Null Sequence - CLOCK DROP",pattern:[_(o.CLOCK),_(o.DROP)],replacement:()=>[]},{name:"Null Sequence - RAND DROP",pattern:[_(o.RAND),_(o.DROP)],replacement:()=>[]},{name:"Null Sequence - DEPTH DROP",pattern:[_(o.DEPTH),_(o.DROP)],replacement:()=>[]},{name:"Null Sequence - NOT NOT",pattern:[_(o.NOT),_(o.NOT)],replacement:()=>[]},{name:"Indirect calls - n EVAL",pattern:[m,_(o.CALL)],replacement:s=>[{op:u.call,value:s.value,meta:{name:s.meta?.name?.replace(/^&/,"")}}]},{name:"Null Sequence - n DROP",pattern:[m,_(o.DROP)],replacement:()=>[]},{name:"Constant Folding - a b ADD",pattern:[m,m,_(o.ADD)],replacement:(s,n)=>[{op:u.push,value:s.value+n.value}]},{name:"Algebraic Simplification - 0 ADD",pattern:[S(0),_(o.ADD)],replacement:()=>[]},{name:"Algebraic Simplification - swap ADD",pattern:[_(o.SWAP),_(o.ADD)],replacement:(s,n)=>[n]},{name:"Constant Folding - a b SUB",pattern:[m,m,_(o.SUB)],replacement:(s,n)=>[{op:u.push,value:s.value-n.value}]},{name:"Algebraic Simplification - 0 SUB",pattern:[S(0),_(o.SUB)],replacement:()=>[]},{name:"Constant Folding - a b MUL",pattern:[m,m,_(o.MUL)],replacement:(s,n)=>[{op:u.push,value:s.value*n.value}]},{name:"Algebraic Simplification - 1 MUL",pattern:[S(1),_(o.MUL)],replacement:()=>[]},{name:"Algebraic Simplification - swap MUL",pattern:[_(o.SWAP),_(o.MUL)],replacement:(s,n)=>[n]},{name:"Constant Folding - a b DIV",pattern:[m,Q,_(o.DIV)],replacement:(s,n)=>[{op:u.push,value:s.value/n.value}]},{name:"Algebraic Simplification - 1 DIV",pattern:[S(1),_(o.DIV)],replacement:()=>[]},{name:"Constant propagation - a DUP",pattern:[m,_(o.DUP)],replacement:s=>[s,s]},{name:"Unreachable Code - 0 &b IF",pattern:[S(0),m,_(o.IF)],replacement:()=>[]},{name:"Flows-Of-Control Optimizations - !0 &b IF",pattern:[Q,m,_(o.IF)],replacement:(s,n,e)=>[{op:u.call,value:n.value,meta:{name:n.meta?.name?.replace(/^&/,"")}}]},{name:"Null Sequence - 0 eval",pattern:[S(0),_(o.CALL)],replacement:()=>[]},{name:"Empty List - [ ]",pattern:[_(o.BRA),_(o.KET)],replacement:()=>[{op:u.push,value:0n,meta:{pointer:!0,name:"0"}}]},{name:"a q< b a> - b a",pattern:[m,_(o.PUSHR),m,_(o.PULLR)],replacement:(s,n,e)=>[e,s]}];class Dn{constructor(){this.stats={pre_optimization_ir_size:0,post_optimization_ir_size:0,user_defined_anon_defs:0,user_defined_named_defs:0,post_optimization_user_defs:0,inlined_calls:0,peephole_optimizations:0,optimization_passes:0},this.minOptPasses=2,this.maxOptPasses=20,this.defs=new Map,this.calledWords=new Set,this.optimized=[],this.nextAnonOp=x+1}optimize(n){this.reset(),this.stats.pre_optimization_ir_size=n.length,this.optimized=n;let e;do e=this.optimized.length,this.optLoop();while((this.optimized.length<e||this.stats.optimization_passes<this.minOptPasses)&&this.stats.optimization_passes<this.maxOptPasses);return this.optimized=this.pullDefs(this.optimized),this.optimized=this.addReferencedWords(this.optimized),this.stats.post_optimization_ir_size=this.optimized.length,this.optimized}optLoop(){this.optimized=this.peepholeOptimization(this.optimized),this.optimized=this.getDefs(this.optimized),this.optimized=this.inlineWords(this.optimized,4),this.stats.optimization_passes++}reset(){this.optimized=[],this.defs=new Map,this.calledWords=new Set,this.stats={pre_optimization_ir_size:0,post_optimization_ir_size:0,user_defined_anon_defs:0,user_defined_named_defs:0,post_optimization_user_defs:0,inlined_calls:0,peephole_optimizations:0,optimization_passes:0}}getDefs(n){let e=0;for(;e<n.length;){const t=n[e];if(t.op===u.call){if(t.value===V){this.stats.optimization_passes===0&&this.stats.user_defined_anon_defs++,t.meta??={},t.meta.uid??=this.nextAnonOp++;let i=e;for(;i-- >0;){const l=n[i];if(l.op===u.call&&l.value===K)break}const r=BigInt(t.meta.uid),a={op:u.push,value:r,meta:{pointer:!0}},p=n.slice(i,e+1);p.unshift(a),p[1]={...p[1],value:R,meta:{...p[1].meta,name:":"}},p[p.length-1]={...p[p.length-1],value:C,meta:{...p[p.length-1].meta,name:";"}},this.defs.set(r,p)}else if(t.value===C){this.stats.optimization_passes===0&&this.stats.user_defined_named_defs++;let i=e;for(;i-- >0;){const p=n[i];if(p.op===u.call&&p.value===R)break}const r=n[i-1];r.meta||={},r.meta.pointer=!0;const a=n.slice(i-1,e+1);this.defs.set(r.value,a)}}e++}return n}pullDefs(n,e=!1){const t=n.slice();let i=0;for(;i<t.length;){const r=t[i];if(r.op===u.call){if(r.value===V){r.meta??={},r.meta.uid??=this.nextAnonOp++;const a=i;for(;i-- >0;){const d=t[i];if(d.op===u.call&&d.value===K)break}const p=BigInt(r.meta.uid),l={op:u.push,value:p,meta:{pointer:!0}},c=t.splice(i,a-i+1,l);c.unshift(l),c[1]={...c[1],value:R,meta:{...c[1].meta,name:":"}},c[c.length-1]={...c[c.length-1],value:C,meta:{...c[c.length-1].meta,name:";"}},this.defs.set(p,c)}else if(r.value===C&&!e){const a=i;for(;i-- >0;){const c=t[i];if(c.op===u.call&&c.value===R)break}const p=t[i-1];p.meta||={},p.meta.pointer=!0;const l=t.splice(i-1,a-i+2);i=i-2,this.defs.set(l[0].value,l)}}i++}return t}peepholeOptimization(n){const e=n.slice();for(;;){const t=this.stats.peephole_optimizations;let i=0;for(;i<e.length;){for(const r of Bn){const{pattern:a,replacement:p}=r;if(i+a.length>e.length)continue;if(a.every((c,d)=>c(e[i+d]))){this.stats.peephole_optimizations++;const c=e.slice(i,i+a.length);e.splice(i,a.length,...p(...c)),i=Math.max(0,i-a.length-1);break}}i++}if(this.stats.peephole_optimizations===t)break}return e}inlineWords(n,e=1,t=[]){return n.flatMap(i=>{if(i.meta?.unsafe)return i;if(i.op===u.call&&this.defs.has(i.value)){if(t.includes(i.value))return i;const r=this.defs.get(i.value);if(!r)return i;const a=r[r.length-1];if(a.meta?.unsafe)return i;if(a.meta?.inline||i.meta?.inline)return this.stats.inlined_calls++,this.inlineWords(r.slice(2,-1),1/0,t.concat(i.value));if(r.length<=e+3)return this.stats.inlined_calls++,this.inlineWords(r.slice(2,-1),e,t.concat(i.value))}return i})}addReferencedWords(n){return n.slice().forEach(e=>{e.op===u.push&&e.meta?.pointer?this.addDef(e.value):e.op===u.call&&this.addDef(e.value)}),n}addDef(n){if(!this.calledWords.has(n)){const e=this.defs.get(n);if(e)return this.stats.post_optimization_user_defs++,this.calledWords.add(n),this.optimized.unshift(...e),this.addReferencedWords(e)}}}class w{constructor(n,e,t){this.imported=new Set,this.importPrefixes=new Map,this.macroPreludeReady=!1,this.rootFilename=null,this.host=n,this.engine=e.engine,this.compiler=e.compiler||new g,t?.macroEngineBootstrapFile&&this.bootstrapMacroEngine(t.macroEngineBootstrapFile)}static tokenize(n){return n.split(/[\r\n]+/)}preprocess(n,e="-"){const t=this.rootFilename===null;t&&e!=="-"&&(this.rootFilename=e);try{return this.preprocessLines(n,e)}finally{t&&(this.rootFilename=null)}}preprocessLines(n,e,t){return n.map(i=>{if(i.length>1&&i[0]==="."){const[r,...a]=i.split(" ");if(r[0]==="."&&r.length>1){switch(r){case".exit":if(this.host.exit){this.host.exit();break}throw new Error("Preprocessor: .exit requires a host exit handler");case".load":{const p=this.findFile(a.join(" "),e),l=this.host.readTextFile(p);return this.preprocessLines(w.tokenize(l),p)}case".import":{const p=this.findFile(a.join(" "),e);if(!this.imported.has(p)){this.imported.add(p);const l=this.host.readTextFile(p);return this.preprocessLines(w.tokenize(l),p,p)}return""}case".m":return this.runMacro(a.join(" "),i);case".ff":return this.runMacro(a.join(" "),i);case".ffp":{if(!this.macroPreludeReady)throw new Error("Preprocessor: .ffp requires prelude-enabled macro context");return this.runMacro(a.join(" "),i)}}return""}}return t?this.mangleImportedLine(i,t):i}).join(`
`)}findFile(n,e="-"){if(e&&e!=="-"&&!this.host.path.isAbsolute(n)){const t=this.host.path.dirname(e),i=this.host.path.resolve(t,n);if(this.host.fileExists(i))return i}if(this.host.fileExists(n))return n;throw'File not found: "'+n+'"'}bootstrapMacroEngine(n){const e=this.findFile(n),t=this.host.readTextFile(e),r=new w(this.host,{engine:this.engine,compiler:this.compiler}).preprocess(w.tokenize(t),e),a=this.compiler.compileToIR(g.tokenize(r),e);this.engine.loadIR(a),this.engine.run(),this.engine.clear(),this.macroPreludeReady=!0}runMacro(n,e){const t=this.compiler.compileToIR(g.tokenize(n));this.engine.loadIR(t),this.engine.run();const i=this.engine.getStack();return this.engine.clear(),i.map(String).join(" ")+` /* ${e} */`}mangleImportedLine(n,e){const t=this.getImportPrefix(e);return n.split(/(\s+)/).map(i=>!i||/\s+/.test(i)?i:this.mangleImportedToken(i,t)).join("")}mangleImportedToken(n,e){return n.startsWith("[__")?`[${e}${n.slice(3)}`:n.startsWith("__")?`${e}${n.slice(2)}`:n}getImportPrefix(n){const e=this.importPrefixes.get(n);if(e)return e;const i=this.getNormalizedImportPath(n).replace(/[^A-Za-z0-9]+/g,"_").replace(/^_+|_+$/g,"").replace(/_+/g,"_")||"module",r=this.hashPath(n),a=`__${i}_${r}__`;return this.importPrefixes.set(n,a),a}getNormalizedImportPath(n){if(this.rootFilename&&this.rootFilename!=="-"){const e=this.host.path.dirname(this.rootFilename),t=this.host.path.relative(e,n);if(t)return t.replace(/\\/g,"/")}return n.replace(/\\/g,"/")}hashPath(n){let e=2166136261;for(let t=0;t<n.length;t++)e^=n.charCodeAt(t),e=Math.imul(e,16777619)>>>0;return e.toString(36)}}var On=`.import ../lib/prelude.ffp
...
half_pi:
  npi 1 >>
; /* n half_pi == floor(10ⁿ*π/2) */`,ve=`.import ../core/core.ff
.import ./arith.ffp
...
nfrac: [ abs ] dip n->S % ; /* x n nfrac == (x - floor(x/10^n))*10^n */`,we=`.import ../core/core.ff
...
/* 93326215443944152681699238856266700490715968264381621468592963895217599993229915608941463976156518286253697920827223758251185210916864000000000000000000000000 */`;const Oe=new Set(["../../../ff/euler/euler4.ffp","../../../ff/euler/euler10.ffp","../../../ff/euler/euler14.ffp","../../../ff/euler/euler46.ffp"]);function ze(s){const n="/ff/lib/",e=s.indexOf(n);if(e===-1)throw new Error(`Unexpected library source path: ${s}`);return`/lib/${s.slice(e+n.length)}`}const Ne=Object.assign({"../../../ff/euler/euler1.ffp":On,"../../../ff/euler/euler10.ffp":zn,"../../../ff/euler/euler13.ffp":Nn,"../../../ff/euler/euler14.ffp":Mn,"../../../ff/euler/euler16.ffp":Ln,"../../../ff/euler/euler160.ffp":Fn,"../../../ff/euler/euler2.ffp":Un,"../../../ff/euler/euler20.ffp":$n,"../../../ff/euler/euler25.ffp":jn,"../../../ff/euler/euler3.ffp":Wn,"../../../ff/euler/euler4.ffp":Hn,"../../../ff/euler/euler46.ffp":Vn,"../../../ff/euler/euler48.ffp":Kn,"../../../ff/euler/euler5.ffp":Qn,"../../../ff/euler/euler6.ffp":Gn,"../../../ff/euler/euler7.ffp":Xn,"../../../ff/euler/euler8.ffp":Yn,"../../../ff/euler/euler9.ffp":Zn}),Me=Object.assign({"../../../ff/examples/ack.ffp":Jn,"../../../ff/examples/cbrt.ffp":ne,"../../../ff/examples/gcd.ffp":ee,"../../../ff/examples/pi.ffp":te,"../../../ff/examples/sqrt.ffp":se});function G(s){const n=s.split("/").pop()??s,e=/^euler(\d+)\.ffp$/.exec(n);return e?[Number(e[1]),n]:[Number.POSITIVE_INFINITY,n]}const Le=Object.entries(Ne).filter(([s])=>!Oe.has(s)).sort((s,n)=>{const e=G(s[0]),t=G(n[0]);return e[0]!==t[0]?e[0]-t[0]:e[1].localeCompare(t[1])}).map(([s,n])=>({path:X(s),label:Ue(s),source:n})),Fe=Object.entries(Me).sort((s,n)=>s[0].localeCompare(n[0])).map(([s,n])=>({path:X(s),label:$e(s),source:n}));function X(s){const n=s.lastIndexOf("/");return`/examples/${n>=0?s.slice(n+1):s}`}function Ue(s){const n="/ff/",e=s.indexOf(n);return e>=0?s.slice(e+n.length):s}function $e(s){const n=s.lastIndexOf("/");return n>=0?s.slice(n+1):s}const je=[{path:"/examples/fact.ffp",label:"fact.ffp",source:De},...Fe,...Le],We=Object.fromEntries(Object.entries(Object.assign({"../../../ff/lib/core/core.ff":ie,"../../../ff/lib/math/ack.ffp":re,"../../../ff/lib/math/arith.ffp":oe,"../../../ff/lib/math/atan-core.ffp":ae,"../../../ff/lib/math/atan-shared.ffp":pe,"../../../ff/lib/math/atan.ffp":ce,"../../../ff/lib/math/atanh-core.ffp":le,"../../../ff/lib/math/atanh.ffp":de,"../../../ff/lib/math/cbrt.ffp":ue,"../../../ff/lib/math/exp.ffp":_e,"../../../ff/lib/math/gcd.ffp":he,"../../../ff/lib/math/log.ffp":fe,"../../../ff/lib/math/math.ffp":me,"../../../ff/lib/math/num.ffp":ge,"../../../ff/lib/math/pi.ffp":be,"../../../ff/lib/math/precision.ffp":ve,"../../../ff/lib/math/pred.ffp":we,"../../../ff/lib/math/primes.ffp":ye,"../../../ff/lib/math/prn.ffp":xe,"../../../ff/lib/math/sqrt.ffp":qe,"../../../ff/lib/math/trig.ffp":ke,"../../../ff/lib/prelude.ffp":Se,"../../../ff/lib/seq/seq.ffp":Ee,"../../../ff/lib/string/char.ffp":Te,"../../../ff/lib/string/str.ffp":Ae,"../../../ff/lib/string/string.ffp":Pe,"../../../ff/lib/tap.ffp":Ie,"../../../ff/lib/testing.ffp":Ce,"../../../ff/lib/time/time.ffp":Re,"../../../ff/lib/time/utc.ffp":Be})).map(([s,n])=>[ze(s),n])),He=Object.fromEntries(je.map(({path:s,source:n})=>[s,n]));function Ve(s,n="/main.ffp"){return{[n]:s,...We,...He}}function E(s){const n=s.startsWith("/"),e=s.split("/").filter(Boolean),t=[];for(const i of e)if(i!=="."){if(i===".."){t.pop();continue}t.push(i)}return`${n?"/":""}${t.join("/")}`||(n?"/":".")}function Ke(s){const n=E(s),e=n.lastIndexOf("/");return e<=0?n.startsWith("/")?"/":".":n.slice(0,e)}function Qe(...s){const n=s.filter(Boolean).join("/").replaceAll(/\/+/g,"/");return E(n)}function Ge(s,n){const e=E(s).split("/").filter(Boolean),t=E(n).split("/").filter(Boolean);let i=0;for(;i<e.length&&i<t.length&&e[i]===t[i];)i++;const r=e.length-i,a=t.slice(i);return Array(r).fill("..").concat(a).join("/")||"."}function Xe(s){return{readTextFile(n){const e=E(n),t=s[e];if(typeof t!="string")throw new Error(`Virtual file not found: ${e}`);return t},fileExists(n){return typeof s[E(n)]=="string"},path:{isAbsolute(n){return n.startsWith("/")},dirname:Ke,relative:Ge,resolve:Qe}}}function Ye(s={}){const n=new TextDecoder,e=new TextEncoder,t=Array.from(e.encode(s.stdin??""));return{io:{write(i){s.onWrite?.(n.decode(i))},readByte(){return t.shift()??null}},exit(i){s.onExit?.(i)},now(){return Date.now()}}}const Ze="/lib/prelude.ffp",Je="/main.ffp";function nt(s){return An.length+s.length}function Y(s,n){const e=console.log;console.log=(...t)=>{s(t.map(String).join(" "))};try{return n()}finally{console.log=e}}async function et(s,n){const e=console.log;console.log=(...t)=>{s(t.map(String).join(" "))};try{return await n()}finally{console.log=e}}function tt(s,n,e={}){let t="";const i=[];let r=0;const a=e.filename??Je,p=Ye({stdin:n,onWrite(A){t+=A},onExit(A){r=A}}),l=new g,c=new H(p),d=new g,h=new H(p),f=Ve(s,a),T=new w(Xe(f),{engine:h,compiler:d},{macroEngineBootstrapFile:Ze});return{compiler:l,engine:c,preprocessor:T,filename:a,logs:i,getOutput(){return t},getExitCode(){return r}}}function st(s,n,e,t={}){const i=tt(s,n,t),r=performance.now(),a=Y(l=>i.logs.push(l),()=>{const l=i.preprocessor.preprocess(w.tokenize(s),i.filename);let c=i.compiler.compileToIR(g.tokenize(l),i.filename);const d=i.compiler.validate(c);e&&(c=new Dn().optimize(c));const h=hn(c),f=g.compileToBase64(c),T=nt(f);return i.engine.loadIR(c),{preprocessed:l,formattedIr:h,bytecode:f,compiledBytes:T,issues:d}}),p=performance.now();return{preprocessed:a.preprocessed,ir:a.formattedIr,bytecode:a.bytecode,compiledBytes:a.compiledBytes,issues:a.issues,compileMs:p-r,execute(){const l=performance.now();Y(d=>i.logs.push(d),()=>{i.engine.run()});const c=performance.now();return{output:i.getOutput(),stack:i.engine.getStack().map(String),logs:[...i.logs],exitCode:i.getExitCode(),executeMs:c-l,cancelled:!1,vmCyclesExecuted:0}},async executeAsync(l={}){const c=performance.now(),d=await et(f=>i.logs.push(f),async()=>await i.engine.runAsync(l)),h=performance.now();return{output:i.getOutput(),stack:i.engine.getStack().map(String),logs:[...i.logs],exitCode:i.getExitCode(),executeMs:h-c,cancelled:d.cancelled,vmCyclesExecuted:d.vmCyclesExecuted}}}}function B(s){self.postMessage(s)}let N=!1,b=null;function it(s,n){const e=n.cancelled?"cancelled":"done";return{output:n.output,preprocessed:s.preprocessed,ir:s.ir,bytecode:s.bytecode,compiledBytes:s.compiledBytes,issues:s.issues,stack:n.stack,logs:n.logs,exitCode:n.exitCode,compileMs:s.compileMs,executeMs:n.executeMs,terminal:e,vmCyclesExecuted:n.vmCyclesExecuted}}self.onmessage=s=>{const n=s.data;if(n.type==="CANCEL"){b===n.runId&&(N=!0);return}if(n.type!=="RUN")return;const{runId:e,source:t,stdin:i,optimize:r,filename:a,yieldIntervalMs:p,yieldSliceMax:l}=n;(async()=>{N=!1,b=e;try{const c=st(t,i,r,{filename:a});if(b!==e)return;B({type:"COMPILED",runId:e,compileMs:c.compileMs,preprocessed:c.preprocessed,ir:c.ir,bytecode:c.bytecode,compiledBytes:c.compiledBytes});const d=performance.now(),h=await c.executeAsync({yieldIntervalMs:p,yieldSliceMax:l,shouldContinue:()=>!N&&b===e,onChunk:({vmCyclesExecuted:f})=>{b===e&&B({type:"PROGRESS",runId:e,vmCyclesExecuted:f,executeElapsedMs:performance.now()-d})},scheduler:()=>new Promise(f=>{globalThis.setTimeout(f,0)})});if(b!==e)return;B({type:"RESULT",runId:e,result:it(c,h)})}catch(c){if(b!==e)return;const d=c instanceof Error?c.message:String(c);B({type:"ERROR",runId:e,message:d})}finally{b===e&&(b=null)}})()}})();
