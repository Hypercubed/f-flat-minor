---
id: node-chomp-build-test-bench
title: "Node Chomp Build, Test, and Benchmark Support"
last_updated: 2026-03-21
description: >
  Add first-class chomp support for the existing Node implementation so th
  e repo can run build, test, and bench workflows for Node in the same sty
  le as other runtimes. This plan intentionally scopes Node support to the
   current ff-run source runner and does not expand Node's CLI ...
tags: [plans]
status: active
kind: initiative
author_kind: ai
