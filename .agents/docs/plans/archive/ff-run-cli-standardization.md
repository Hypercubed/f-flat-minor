---
id: ff-run-cli-standardization
title: "Standardize `ff-run` CLI Across Deno, Node, and Bun"
last_updated: 2026-03-29
description: >
  Standardize the three ff-run entrypoints so Deno, Node, and Bun expose t
  he same CLI contract and observable behavior. Use the current Deno imple
  mentation as the canonical reference, while preserving only unavoidable
  runtime-specific differences and updating the runtime READMEs...
tags: [plans]
status: completed
kind: initiative
author_kind: ai
...
- `node/README.md`
- `bun/README.md`
- `node-chomp-build-test-bench.md`
