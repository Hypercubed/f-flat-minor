---
id: tap-depth-aware-assertion-indentation
title: "Depth-Aware TAP Indentation for Assertion and Plan Words"
last_updated: 2026-03-28
description: >
  Implement depth-derived indentation inside OK, PLAN, #SKIP, and #TODO in
   ff/lib/tap.ffp, and remove the @OK, @PLAN, @#SKIP, and @#TODO variants.
   Limit this change to assertion/plan emission only; do not change TEST y
  et because its call-site stack shape is not depth-stable whil...
tags: [plans]
status: completed
kind: initiative
author_kind: ai
