---
id: trace-output-human-llm-format
title: "Improve trace output for humans and LLM agents"
last_updated: 2026-03-25
description: >
  Redesign tracing output to provide a concise default human-readable form
  at and an optional machine-readable JSONL mode for LLM/agent tooling. Ke
  ep backwards compatibility via opt-in flags and preserve existing tracin
  g semantics.
...
- Updated runtime READMEs plus agent guidance (`AGENTS.md` and `.agents/skills/ff-code-authoring/SKILL.md`) to document human vs JSONL trace usage.
