---
id: ffm-math-library
title: "F\u266dm Arbitrary Precision Math Library"
last_updated: 2026-04-10
description: >
  The complete math library rests on: 1. **Two series loop words** — exp-p
  arts (Shape 1) and atanh-parts/atan-parts (Shape 2, sign flag distinguis
  hes them) 2. **Two layers** — internal -parts words return p q; user-fac
  ing words apply p/q*S once at the boundary 3. **Single precis...
tags: [math, plans]
status: draft
kind: initiative
author_kind: ai
