---
id: division-semantics-alignment
title: "Align Division Semantics Across Runtimes"
last_updated: 2026-04-10
description: >
  Make all maintained F♭m runtimes implement the same negative-integer sem
  antics for / and %. The canonical rule is truncate-toward-zero division
  with the matching remainder: q = trunc(a / b), r = a - b*q. This is an e
  xplicit project decision, not just a temporary reading of cur...
tags: [math, plans]
status: active
kind: initiative
author_kind: ai
