---
id: vscode-ers-definition-commands
title: "VSCode ERS Definition Commands"
last_updated: 2026-04-10
description: >
  Add three VSCode commands — Expand Current Definition, Collapse Current
  Definition, and Audit Current Definition — that operate on the definitio
  n under the cursor by delegating analysis and rewrites to the ERS toolch
  ain rather than requiring a full language server.
tags: [plans, vscode]
status: active
kind: initiative
author_kind: ai
...
- `hybrid_ers_implementation_plan.md` — provides the required ERS analyzer/rewrite architecture, safety model, and command surface
- `language-server.md` Phase 0 / `typescript/compile-service` — provides current-file definition discovery and source mapping used to resolve the active definition

## References

- `hybrid_ers_implementation_plan.md`
- `language-server.md`
