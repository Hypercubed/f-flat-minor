---
id: web-playground-optimize-timing-diagnosis
title: "Web Playground Optimize Timing Diagnosis"
last_updated: 2026-03-23
description: >
  Add targeted diagnostics for the web playground so the repo can determin
  e whether optimized runs are being timed incorrectly in the browser or w
  hether optimized IR is genuinely slower for some workloads such as ff/eu
  ler/euler7.ffp.
tags: [plans, web]
status: active
kind: initiative
