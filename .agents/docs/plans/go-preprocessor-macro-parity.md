---
id: go-preprocessor-macro-parity
title: "Go Preprocessor Macro Parity Plan"
last_updated: 2026-04-10
description: >
  ## Overview This plan documents the comparison between the TypeScript an
  d Go preprocessor implementations, identifies missing macro-related func
  tionality in the Go implementation, and provides a step-by-step remediat
  ion plan. ## Files Analy...
tags: [compiler, plans]
status: draft
kind: initiative
author_kind: ai
