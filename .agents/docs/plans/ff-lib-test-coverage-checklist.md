---
id: ff-lib-test-coverage-checklist
title: "`ff/lib` TAP test coverage checklist"
last_updated: 2026-04-01
description: >
  Track **public** words in [ff/lib/](../ff/lib/) (excluding _ / __ prefix
  es) that **do not appear as literal tokens** in any [ff/lib/**/__tests__
  /](../ff/lib/) source (.ffp / .ff). Checking off items means a test file
   names the word in executable code (not only in comments).
tags: [plans]
status: draft
kind: initiative
author_kind: ai
